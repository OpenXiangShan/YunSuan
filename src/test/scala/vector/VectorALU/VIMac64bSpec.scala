    ...
    it should "pass the single-width multiply" in {
      test(new VIMac64bWrapper).withAnnotations(Seq(WriteVcdAnnotation)) { dut =>
        ...
        val inputSeq = Seq(
          ...
          genVIMac64bInput(
            SrcBundle("hdcba90fedcba9000", "hb851e40eb851e310"),
            vmul.copy(u64, u64, u64, highHalf = true)
          ),
          genVIMac64bInput(
            SrcBundle("h12344ef812344df8", "hedcba207edcba108"),
            vmul.copy(u64, u64, u64, highHalf = true)
          ),
          genVIMac64bInput(
            SrcBundle("hdcba90fedcba9000", "hb851e40eb851e310"),
            vmul.copy(s64, s64, u64, highHalf = true)
          ),
          // sew=8,16,32
          ...
          genVIMac64bInput(
            SrcBundle("h51eb7f4051eb7e78", "h2d82d2502d82d188"),
            vmul.copy(s16, s16, s16, highHalf = true)
          ),
          genVIMac64bInput(
            SrcBundle("h6af375626af37480", "h468ac872468ac790"),
            vmul.copy(s32, s32, s32, highHalf = true)
          ),
          genVIMac64bInput(
            SrcBundle("h5d4c33b65d4c32b8", "h38e386c638e385c8"),
            vmul.copy(s64, s64, s64, highHalf = true)
          ),
          genVIMac64bInput(SrcBundle("hb851e666b851e5b8", "h93e9397693e938c8"), vmul.copy(u8, u8, u8, highHalf = true)),
          genVIMac64bInput(
            SrcBundle("h62fc904962fc8f80", "h3e93e3593e93e290"),
            vmul.copy(u16, u16, u16, highHalf = true)
          ),
          genVIMac64bInput(
            SrcBundle("h0eca7f9b0eca7eb8", "hea61d2aaea61d1c8"),
            vmul.copy(u32, u32, u32, highHalf = true)
          ),
          genVIMac64bInput(
            SrcBundle("hd82d7b42d82d7a40", "hb3c4ce52b3c4cd50"),
            vmul.copy(u64, u64, u64, highHalf = true)
          ),
          genVIMac64bInput(SrcBundle("h7e4b12b17e4b1200", "h59e265c159e26510"), vmul.copy(s8, s8, u8, highHalf = true)),
          genVIMac64bInput(
            SrcBundle("h2ea617bf2ea616f8", "h0a3d6acf0a3d6a08"),
            vmul.copy(s16, s16, u16, highHalf = true)
          ),
          genVIMac64bInput(
            SrcBundle("hb60b5a20b60b5940", "h91a2ad3091a2ac50"),
            vmul.copy(s32, s32, u32, highHalf = true)
          ),
          genVIMac64bInput(
            SrcBundle("hea61d1baea61d0b8", "hc5f924cac5f923c8"),
            vmul.copy(s64, s64, u64, highHalf = true)
          )
        )
    ...
    it should "pass the madd (11.13) and widen madd (11.14)." in {
      test(new VIMac64bWrapper).withAnnotations(Seq(WriteVcdAnnotation)) { dut =>
        ...
        val inputSeq = Seq(
          ...
          genVIMac64bInput(
            SrcBundle("hcdf010ebcdf010c0", "ha98763fba98763d0", "h851eb70b851eb6e0"),
            vmacc.copy(s8, s8, s8)
          ),
          genVIMac64bInput(
            SrcBundle("h71c71b2471c71af8", "h4d5e6e344d5e6e08", "h28f5c14428f5c118"),
            vmacc.copy(s8, s8, s8)
          ),
          genVIMac64bInput(
            SrcBundle("ha1907df2a1907dc0", "h7d27d1027d27d0d0", "h58bf241258bf23e0"),
            vmacc.copy(s16, s16, s16)
          ),
          genVIMac64bInput(
            SrcBundle("h06d39eba06d39e80", "he26af1c9e26af190", "hbe0244d9be0244a0"),
            vmacc.copy(s32, s32, s32)
          ),
          genVIMac64bInput(
            SrcBundle("hc962fab7c962fa78", "ha4fa4dc7a4fa4d88", "h8091a0d78091a098"),
            vmacc.copy(s64, s64, s64)
          ),
          genVIMac64bInput(
            SrcBundle("h5f92c4ac5f92c480", "h3b2a17bc3b2a1790", "h16c16acc16c16aa0"),
            vmacc.copy(s8, s8, s8, isSub = true)
          ),
          genVIMac64bInput(
            SrcBundle("he0246763e0246738", "hbbbbba73bbbbba48", "h97530d8397530d58"),
            vmacc.copy(s8, s8, s8, isSub = true)
          ),
          genVIMac64bInput(
            SrcBundle("h333331b333333180", "h0eca84c30eca8490", "hea61d7d2ea61d7a0"),
            vmacc.copy(s16, s16, s16, isSub = true)
          ),
          genVIMac64bInput(
            SrcBundle("h4567882b456787f8", "h20fedb3b20fedb08", "hfc962e4afc962e18"),
            vmacc.copy(s16, s16, s16, isSub = true)
          ),
          genVIMac64bInput(
            SrcBundle("he38e3738e38e3700", "hbf258a48bf258a10", "h9abcdd589abcdd20"),
            vmacc.copy(s32, s32, s32, isSub = true)
          ),
          genVIMac64bInput(
            SrcBundle("hf5c28db0f5c28d78", "hd159e0c0d159e088", "hacf133d0acf13398"),
            vmacc.copy(s32, s32, s32, isSub = true)
          ),
          genVIMac64bInput(
            SrcBundle("h48d1580048d157c0", "h2468ab102468aad0", "hfffffe1ffffffde0"),
            vmacc.copy(s64, s64, s64, isSub = true)
          ),
          genVIMac64bInput(
            SrcBundle("h5b05ae785b05ae38", "h369d0188369d0148", "h1234549812345458"),
            vmacc.copy(s64, s64, s64, isSub = true)
          ),
          genVIMac64bInput(
            SrcBundle("hf37c034af37c0320", "h17e4b03b17e4b010", "h3c4d5d2b3c4d5d00"),
            vmacc.copy(s8, s8, s8)
          ),
          genVIMac64bInput(
            SrcBundle("h58bf241258bf23e0", "h7d27d1027d27d0d0", "ha1907df2a1907dc0"),
            vmacc.copy(s16, s16, s16)
          ),
          genVIMac64bInput(
            SrcBundle("hd0369b51d0369b18", "hf49f4841f49f4808", "h1907f5321907f4f8"),
            vmacc.copy(s32, s32, s32)
          ),
          genVIMac64bInput(
            SrcBundle("hfffffe1ffffffde0", "h2468ab102468aad0", "h48d1580048d157c0"),
            vmacc.copy(s64, s64, s64)
          ),
          genVIMac64bInput(
            SrcBundle("h76b8e5970a0c1c73", "ha32272c77541d581", "hcf8bfff7e0778e8f"),
            vmacc.copy(s8, s8, s8, isSub = true)
          ),
          genVIMac64bInput(
            SrcBundle("h122a53c081482424", "h3e93e0f0ec7ddd32", "h6afd6e2157b39640"),
            vmacc.copy(s8, s8, s8, isSub = true)
          ),
          genVIMac64bInput(
            SrcBundle("h490d30136fc03386", "h1ca3a2e3048a7a78", "hc3d088822e1f085c"),
            vmacc.copy(u16, u8, u8, widen = true, uopIdx = 0)
          ),
          genVIMac64bInput(
            SrcBundle("h490d30136fc03386", "h1ca3a2e3048a7a78", "hda054f1a63b9e4e3"),
            vmacc.copy(u16, u8, u8, widen = true, uopIdx = 1)
          ),
          genVIMac64bInput(
            SrcBundle("h8fda095ea8643014", "h63707c2e3d2e7706", "h0a9d61cd66c304ea"),
            vmacc.copy(s32, s16, s16, widen = true, uopIdx = 0)
          ),
          genVIMac64bInput(
            SrcBundle("h8fda095ea8643014", "h63707c2e3d2e7706", "h20d228659c5de171"),
            vmacc.copy(s32, s16, s16, widen = true, uopIdx = 1)
          ),
          genVIMac64bInput(
            SrcBundle("h271cf20587ccd0cc", "hfab364d51c9717be", "ha1e04a74462ba5a2"),
            vmacc.copy(s16, u8, s8, widen = true, uopIdx = 0)
          ),
          genVIMac64bInput(
            SrcBundle("h271cf20587ccd0cc", "hfab364d51c9717be", "hb815110c7bc68229"),
            vmacc.copy(s16, u8, s8, widen = true, uopIdx = 1)
          ),
          genVIMac64bInput(
            SrcBundle("hb1ca476c905792ce", "h8560ba3c2521d9c0", "h2c8d9fdb4eb667a4"),
            vmacc.copy(s32, u16, s16, widen = true, uopIdx = 0)
          ),
          genVIMac64bInput(
            SrcBundle("hb1ca476c905792ce", "h8560ba3c2521d9c0", "h42c266738451442b"),
            vmacc.copy(s32, u16, s16, widen = true, uopIdx = 1)
          ),
          genVIMac64bInput(
            SrcBundle("h3c779cd398e254d0", "h100e0fa32dac9bc2", "hb73af542574129a6"),
            vmacc.copy(s64, u32, s32, widen = true, uopIdx = 0)
          ),
          genVIMac64bInput(
            SrcBundle("h3c779cd398e254d0", "h100e0fa32dac9bc2", "hcd6fbbda8cdc062d"),
            vmacc.copy(s64, u32, s32, widen = true, uopIdx = 1)
          ),
          genVIMac64bInput(
            SrcBundle("h1634c698359adc99", "h1212121212121212", "h6f07e0f90c064eb5"),
            vmacc.copy(s16, s8, u8, widen = true, uopIdx = 0)
          ),
          genVIMac64bInput(
            SrcBundle("h1634c698359adc99", "h1212121212121212", "h853ca79141a12b3c"),
            vmacc.copy(s16, s8, u8, widen = true, uopIdx = 1)
          ),
          genVIMac64bInput(
            SrcBundle("h2c698d306b35b920", "h0012001200120012", "h9b716e29773c07c3"),
            vmacc.copy(s32, s16, u16, widen = true, uopIdx = 0)
          ),
          genVIMac64bInput(
            SrcBundle("h2c698d306b35b920", "h0012001200120012", "hb1a634c1acd6e44a"),
