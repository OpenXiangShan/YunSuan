...
VecOutput VGMPermutation::get_output_vslide1down(VecInput input) { VecOutput output; return output;}
VecOutputE8 VGMPermutation::vslide1down_calculation_e8(VSlideOneInput *input) { VecOutputE8 output; return output;}
VecOutputE16 VGMPermutation::vslide1down_calculation_e16(VSlideOneInput *input) { VecOutputE16 output; return output;}
VecOutputE32 VGMPermutation::vslide1down_calculation_e32(VSlideOneInput *input) { VecOutputE32 output; return output;}
VecOutput VGMPermutation::vslide1down_calculation_e64(VSlideOneInput *input) { VecOutput output; return output;}
