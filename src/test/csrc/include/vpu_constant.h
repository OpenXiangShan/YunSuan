...
// Opcode encodings are defined once in Opcodes.scala and generated into
// build/opcodes.h (see OpcodeHeaderGen). Do not hardcode encodings here.
#include "opcodes.h"
...
//will be delated
#define FU_NUM 15
#define ALL_FUTYPES {VFloatAdder,VFloatFMA,VFloatDivider,VIntegerALU,VPermutation,IntegerMul,FloatCompare,FloatALU,FloatMul,FloatFMA}
...
#define VFA_NUM 7 // compare ops not yet defined in Scala VFMiscOpcode; only add-family synced
// vfa funcop type (values generated from Opcodes.scala, per format)
#define VFA_ALL_OPTYPES_FP16 {VFMACOPCODE_VFADD_FP16, VFMACOPCODE_VFSUB_FP16, VFMACOPCODE_VFMIN_FP16, VFMACOPCODE_VFMAX_FP16, VFMACOPCODE_VFSGNJ_FP16, VFMACOPCODE_VFSGNJN_FP16, VFMACOPCODE_VFSGNJX_FP16}
#define VFA_ALL_OPTYPES_FP32 {VFMACOPCODE_VFADD_FP32, VFMACOPCODE_VFSUB_FP32, VFMACOPCODE_VFMIN_FP32, VFMACOPCODE_VFMAX_FP32, VFMACOPCODE_VFSGNJ_FP32, VFMACOPCODE_VFSGNJN_FP32, VFMACOPCODE_VFSGNJX_FP32}
#define VFA_ALL_OPTYPES_FP64 {VFMACOPCODE_VFADD_FP64, VFMACOPCODE_VFSUB_FP64, VFMACOPCODE_VFMIN_FP64, VFMACOPCODE_VFMAX_FP64, VFMACOPCODE_VFSGNJ_FP64, VFMACOPCODE_VFSGNJN_FP64, VFMACOPCODE_VFSGNJX_FP64}
#define VFA_NEED_FRS1_OPTYPES_FP16 {VFMACOPCODE_VFADD_FP16, VFMACOPCODE_VFSUB_FP16, VFMACOPCODE_VFMIN_FP16, VFMACOPCODE_VFMAX_FP16, VFMACOPCODE_VFSGNJ_FP16, VFMACOPCODE_VFSGNJN_FP16, VFMACOPCODE_VFSGNJX_FP16}
#define VFA_NEED_FRS1_OPTYPES_FP32 {VFMACOPCODE_VFADD_FP32, VFMACOPCODE_VFSUB_FP32, VFMACOPCODE_VFMIN_FP32, VFMACOPCODE_VFMAX_FP32, VFMACOPCODE_VFSGNJ_FP32, VFMACOPCODE_VFSGNJN_FP32, VFMACOPCODE_VFSGNJX_FP32}
#define VFA_NEED_FRS1_OPTYPES_FP64 {VFMACOPCODE_VFADD_FP64, VFMACOPCODE_VFSUB_FP64, VFMACOPCODE_VFMIN_FP64, VFMACOPCODE_VFMAX_FP64, VFMACOPCODE_VFSGNJ_FP64, VFMACOPCODE_VFSGNJN_FP64, VFMACOPCODE_VFSGNJX_FP64}
#define VFA_WIDEN_OPTYPES_FP16 {VFMACOPCODE_VFADD_FP16, VFMACOPCODE_VFSUB_FP16}
#define VFA_WIDEN_OPTYPES_FP32 {VFMACOPCODE_VFADD_FP32, VFMACOPCODE_VFSUB_FP32}
#define VFA_WIDEN_OPTYPES_FP64 {VFMACOPCODE_VFADD_FP64, VFMACOPCODE_VFSUB_FP64}

#define FCMP_NUM 6
#define FCMP_ALL_OPTYPES_FP16 {FMISCOPCODE_FEQ_FP16, FMISCOPCODE_FLT_FP16, FMISCOPCODE_FLE_FP16, FMISCOPCODE_FLTQ_FP16, FMISCOPCODE_FLEQ_FP16, FMISCOPCODE_FCLASS_FP16}
#define FCMP_ALL_OPTYPES_FP32 {FMISCOPCODE_FEQ_FP32, FMISCOPCODE_FLT_FP32, FMISCOPCODE_FLE_FP32, FMISCOPCODE_FLTQ_FP32, FMISCOPCODE_FLEQ_FP32, FMISCOPCODE_FCLASS_FP32}
#define FCMP_ALL_OPTYPES_FP64 {FMISCOPCODE_FEQ_FP64, FMISCOPCODE_FLT_FP64, FMISCOPCODE_FLE_FP64, FMISCOPCODE_FLTQ_FP64, FMISCOPCODE_FLEQ_FP64, FMISCOPCODE_FCLASS_FP64}

#define FALU_NUM 9
#define FALU_ALL_OPTYPES_FP16 {FMACOPCODE_FADD_FP16, FMACOPCODE_FSUB_FP16, FMACOPCODE_FMIN_FP16, FMACOPCODE_FMAX_FP16, FMACOPCODE_FSGNJ_FP16, FMACOPCODE_FSGNJN_FP16, FMACOPCODE_FSGNJX_FP16, FMACOPCODE_FMINM_FP16, FMACOPCODE_FMAXM_FP16}
#define FALU_ALL_OPTYPES_FP32 {FMACOPCODE_FADD_FP32, FMACOPCODE_FSUB_FP32, FMACOPCODE_FMIN_FP32, FMACOPCODE_FMAX_FP32, FMACOPCODE_FSGNJ_FP32, FMACOPCODE_FSGNJN_FP32, FMACOPCODE_FSGNJX_FP32, FMACOPCODE_FMINM_FP32, FMACOPCODE_FMAXM_FP32}
#define FALU_ALL_OPTYPES_FP64 {FMACOPCODE_FADD_FP64, FMACOPCODE_FSUB_FP64, FMACOPCODE_FMIN_FP64, FMACOPCODE_FMAX_FP64, FMACOPCODE_FSGNJ_FP64, FMACOPCODE_FSGNJN_FP64, FMACOPCODE_FSGNJX_FP64, FMACOPCODE_FMINM_FP64, FMACOPCODE_FMAXM_FP64}
...
#define FMA_NUM 4
#define FMA_ALL_OPTYPES_FP16 {FMACOPCODE_VFMACC_FP16, FMACOPCODE_VFNMACC_FP16, FMACOPCODE_VFMSAC_FP16, FMACOPCODE_VFNMSAC_FP16}
#define FMA_ALL_OPTYPES_FP32 {FMACOPCODE_VFMACC_FP32, FMACOPCODE_VFNMACC_FP32, FMACOPCODE_VFMSAC_FP32, FMACOPCODE_VFNMSAC_FP32}
#define FMA_ALL_OPTYPES_FP64 {FMACOPCODE_VFMACC_FP64, FMACOPCODE_VFNMACC_FP64, FMACOPCODE_VFMSAC_FP64, FMACOPCODE_VFNMSAC_FP64}
// vff funcop type (values generated from Opcodes.scala, per format)
#define VFF_NUM 9
#define VFF_ALL_OPTYPES_FP16 {VFMACOPCODE_VFMUL_FP16, VFMACOPCODE_VFMACC_FP16, VFMACOPCODE_VFNMACC_FP16, VFMACOPCODE_VFMSAC_FP16, VFMACOPCODE_VFNMSAC_FP16, VFMACOPCODE_VFMADD_FP16, VFMACOPCODE_VFNMADD_FP16, VFMACOPCODE_VFMSUB_FP16, VFMACOPCODE_VFNMSUB_FP16}
#define VFF_ALL_OPTYPES_FP32 {VFMACOPCODE_VFMUL_FP32, VFMACOPCODE_VFMACC_FP32, VFMACOPCODE_VFNMACC_FP32, VFMACOPCODE_VFMSAC_FP32, VFMACOPCODE_VFNMSAC_FP32, VFMACOPCODE_VFMADD_FP32, VFMACOPCODE_VFNMADD_FP32, VFMACOPCODE_VFMSUB_FP32, VFMACOPCODE_VFNMSUB_FP32}
#define VFF_ALL_OPTYPES_FP64 {VFMACOPCODE_VFMUL_FP64, VFMACOPCODE_VFMACC_FP64, VFMACOPCODE_VFNMACC_FP64, VFMACOPCODE_VFMSAC_FP64, VFMACOPCODE_VFNMSAC_FP64, VFMACOPCODE_VFMADD_FP64, VFMACOPCODE_VFNMADD_FP64, VFMACOPCODE_VFMSUB_FP64, VFMACOPCODE_VFNMSUB_FP64}
#define VFF_WIDEN_OPTYPES_FP16 {VFMACOPCODE_VFMUL_FP16, VFMACOPCODE_VFMACC_FP16, VFMACOPCODE_VFNMACC_FP16, VFMACOPCODE_VFMSAC_FP16, VFMACOPCODE_VFNMSAC_FP16}
#define VFF_WIDEN_OPTYPES_FP32 {VFMACOPCODE_VFMUL_FP32, VFMACOPCODE_VFMACC_FP32, VFMACOPCODE_VFNMACC_FP32, VFMACOPCODE_VFMSAC_FP32, VFMACOPCODE_VFNMSAC_FP32}
#define VFF_WIDEN_OPTYPES_FP64 {VFMACOPCODE_VFMUL_FP64, VFMACOPCODE_VFMACC_FP64, VFMACOPCODE_VFNMACC_FP64, VFMACOPCODE_VFMSAC_FP64, VFMACOPCODE_VFNMSAC_FP64}
// vff funcop type
#define VFD_NUM 1 // only div tested; RTL does not support sqrt yet
#define VFD_ALL_OPTYPES_FP16 {VFDIVOPCODE_VFDIV_FP16}
#define VFD_ALL_OPTYPES_FP32 {VFDIVOPCODE_VFDIV_FP32}
#define VFD_ALL_OPTYPES_FP64 {VFDIVOPCODE_VFDIV_FP64}
#define VFD_DIV_OPTYPES_FP16 {VFDIVOPCODE_VFDIV_FP16}
#define VFD_DIV_OPTYPES_FP32 {VFDIVOPCODE_VFDIV_FP32}
#define VFD_DIV_OPTYPES_FP64 {VFDIVOPCODE_VFDIV_FP64}
