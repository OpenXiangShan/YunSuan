...
#define VIA_ALL_OPTYPES { \
  VADD, VADC  ,VSUB  ,VSBC  ,VWADDU,VWSUBU,VWADD ,VWSUB ,\
  VWWADD,VWWSUB,VWWADD,VWWSUB,VMAXU ,VMINU ,VMAX  ,VMIN  ,\
  VMSEQ ,VMSNE ,VMSLTU,VMSLT ,VMSLEU,VMSLE ,VMSGTU,VMSGT ,\
  VMSGEU,VMSGE ,VAND  ,VNAND ,VANDN ,VOR   ,VNOR  ,VORN  ,\
  VXOR  ,VXNOR ,VSLL  ,VSRL  ,VSRA  ,VSSRL ,VSSRA ,VRSUB ,VMADC ,VMADC0}\
...
// vconvert type 
  ...
  // only support VFNCVT_XFW VFWCVT_FXV
