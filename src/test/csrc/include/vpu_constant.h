...
// vconvert type 
  #define VFCVT_NUM 25  // for random
  ...
  #define VFEXP2           (binstoi("11100010"))
  #define VFEXP2BF16       (binstoi("11100011"))
  ...
  VFNCVT_XUFW, VFNCVT_XFW, VFNCVT_FXUW, VFNCVT_FXW, VFNCVT_FFW, VFNCVT_ROD_FFW, VFNCVT_RTZ_XUFW ,VFNCVT_RTZ_XFW, \
  VFRSQRT7, VFREC7, VFEXP2, VFEXP2BF16}

  #define VFCVT_8_NUM 6
  #define VFCVT_8_OPTYPES {VFWCVT_FXUV, VFWCVT_FXV, VFNCVT_XUFW, VFNCVT_XFW, VFNCVT_RTZ_XUFW, VFNCVT_RTZ_XFW}

  #define VFCVT_16_NUM 21
  #define VFCVT_16_OPTYPES {VFCVT_XUFV,VFCVT_XFV,VFCVT_FXUV,VFCVT_FXV,VFCVT_RTZ_XUFV,VFCVT_RTZ_XFV,VFWCVT_XUFV,VFWCVT_XFV,VFWCVT_FXUV,VFWCVT_FXV,VFWCVT_FFV,VFWCVT_RTZ_XUFV,VFWCVT_RTZ_XFV,VFNCVT_XUFW,VFNCVT_XFW,VFNCVT_RTZ_XUFW,VFNCVT_RTZ_XFW,VFRSQRT7,VFREC7,VFEXP2,VFEXP2BF16}

  #define VFCVT_32_NUM  24
  #define VFCVT_32_OPTYPES {VFCVT_XUFV, VFCVT_XFV, VFCVT_FXUV, VFCVT_FXV, VFCVT_RTZ_XUFV, VFCVT_RTZ_XFV,VFWCVT_XUFV, VFWCVT_XFV, VFWCVT_FXUV, VFWCVT_FXV, VFWCVT_FFV, VFWCVT_RTZ_XUFV, VFWCVT_RTZ_XFV,VFNCVT_XUFW, VFNCVT_XFW, VFNCVT_FXUW, VFNCVT_FXW, VFNCVT_FFW, VFNCVT_ROD_FFW, VFNCVT_RTZ_XUFW ,VFNCVT_RTZ_XFW, VFRSQRT7, VFREC7, VFEXP2}
