...
//will be delated
#define FU_NUM 15
// TODO: VFloatFMA is out of the list because the vector FMA unit was retired
// with the VFALU/VFMul merge; put it back together with the test of the merged
// vfmac FU (the reference model VGMFloatFMA is kept in gm_common.h for it).
#define ALL_FUTYPES {VFloatAdder,VFloatDivider,VIntegerALU,VPermutation,IntegerMul,FloatCompare,FloatALU,FloatMul,FloatFMA}
...
#define FMA_NUM 4
#define FMA_ALL_OPTYPES_FP16 {VFMACOPCODE_VFMACC_FP16, VFMACOPCODE_VFNMACC_FP16, VFMACOPCODE_VFMSAC_FP16, VFMACOPCODE_VFNMSAC_FP16}
#define FMA_ALL_OPTYPES_FP32 {VFMACOPCODE_VFMACC_FP32, VFMACOPCODE_VFNMACC_FP32, VFMACOPCODE_VFMSAC_FP32, VFMACOPCODE_VFNMSAC_FP32}
#define FMA_ALL_OPTYPES_FP64 {VFMACOPCODE_VFMACC_FP64, VFMACOPCODE_VFNMACC_FP64, VFMACOPCODE_VFMSAC_FP64, VFMACOPCODE_VFNMSAC_FP64}
// TODO: the vff opcode lists (VFF_NUM / VFF_ALL_OPTYPES_* / VFF_WIDEN_OPTYPES_*)
// were removed together with the vector FMA unit; the encodings are generated
// into build/opcodes.h from Opcodes.scala, so restoring them is cheap.
