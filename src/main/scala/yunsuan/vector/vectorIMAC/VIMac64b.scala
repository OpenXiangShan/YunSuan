...
class VIMac64b extends Module {
  ...
  def calcPartProd(i: Int, sew: Int) = {
    ...
    boothDouble := Mux1H(Seq(vs1Booth(i).one -> elementVs2L, vs1Booth(i).double -> (elementVs2L << 1)))
    val boothResult = Mux1H(Seq(vs1Booth(i).positive -> boothDouble, vs1Booth(i).negative -> (~boothDouble)))
  ...
  plus1sew32 := VecInit(
    Seq.tabulate(2)(i =>
      blockPlus1(
        32,
        UIntSplit(booth_neg, 16)(i),
        UIntSplit(vs1, 32)(i)(31),
        !vs1_is_signed,
        UIntSplit(vs2, 32)(i),
        io.isSub
      )
  ...
  plus1sew16 := VecInit(
    Seq.tabulate(4)(i =>
      blockPlus1(
        16,
        UIntSplit(booth_neg, 8)(i),
        UIntSplit(vs1, 16)(i)(15),
        !vs1_is_signed,
        UIntSplit(vs2, 16)(i),
        io.isSub
      )
  ...
  plus1sew8 := VecInit(
    Seq.tabulate(8)(i =>
      blockPlus1(8, UIntSplit(booth_neg, 4)(i), UIntSplit(vs1, 8)(i)(7), !vs1_is_signed, UIntSplit(vs2, 8)(i), io.isSub)
    )
  ).asUInt
