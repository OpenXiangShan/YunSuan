...
class VIMac64bStage1 extends VIMac64b.Module {
  val in  = IO(Input(new VIMac64bStage1.In))
  val out = IO(Output(new VIMac64bStage1.Out))

  private val uopIdx   = in.info.uopIdx
  private val vxrm     = in.info.vxrm

  private val sewIs8    = in.ctrl.sewIs8
  private val sewIs16   = in.ctrl.sewIs16
  private val sewIs32   = in.ctrl.sewIs32
  private val sewIs64   = in.ctrl.sewIs64
  private val vs2Sign = in.ctrl.vs2Sign
  private val vs1Sign = in.ctrl.vs1Sign
  private val vdSign  = in.ctrl.vdSign

  private val isSub    = in.ctrl.isSub
  private val highHalf = in.ctrl.highHalf
  private val isMacc   = in.ctrl.isMacc
  private val widen    = in.ctrl.widen
  private val isFixP   = in.ctrl.isFixP
  ...
  val vs1BoothEncode = Module(new VIMac64bStage1.vs1Booth())
  ...
  val vs2SignGen = Module(new VIMac64bStage1.vs2SgnGenerator())
  ...
  val ppSgnAndCBGen = Module(new VIMac64bStage1.partProdSgnAndCarryBitGen())
  ...
  val partProdGen = Module(new VIMac64bStage1.partProdGenerator())
  ...
  val wallaceTreeGen = Module(new VIMac64bStage1.wallaceTreeGenerator())
  ...
  val wallace3to2CompStage1 = Module(new VIMac64bStage1.wallace3to2CompressorStage1())
  wallace3to2CompStage1.io.wallaceTree := wallaceTree
  compStage1Results := wallace3to2CompStage1.io.compStage1Results

  out.info.uopIdx                 := uopIdx
  out.info.vxrm                   := vxrm
  out.ctrl.highHalfS1             := highHalf
  out.ctrl.widenS1                := widen
  out.ctrl.isFixPS1               := isFixP
  out.ctrl.sewIs8S1               := sewIs8
  out.ctrl.sewIs16S1              := sewIs16
  out.ctrl.sewIs32S1              := sewIs32
  out.ctrl.sewIs64S1              := sewIs64
  out.data.compStage1ResultsS1    := compStage1Results
  out.data.wallaceLine34NonFixPS1 := wallaceLine34NonFixP
  out.data.wallaceLine34FixPS1    := wallaceLine34FixP
}

object VIMac64bStage1 {
  ...
  class InData extends VIMac64b.Bundle {
  ...
  class wallace3to2CompressorStage1 extends Module with VIMac64bStage2.wallace3to2Compressor {
    val io = IO(new Bundle {
