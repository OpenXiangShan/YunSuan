...
class SlideUpLookup(n: Int) extends VPermModule {
  ...
  for (i <- 0 until n) {
    ...
    res_keep_old_vd(i) := RegNext(
      (!io.vm && !io.mask(i).asBool && !io.ma) || (elements_idx < io.vstart) || ((elements_idx >= io.vl) && !io.ta)
    )
...
class SlideUpLookupModule extends VPermModule {
  ...
  when(io.uop_idx === 28.U) {
    ...
    io.uop_idx === 6.U || io.uop_idx === 11.U || io.uop_idx === 17.U || io.uop_idx === 24.U || io.uop_idx === 32.U
  ) {
    slide_base := 3.U << elem_num_pow
  }.elsewhen(
    io.uop_idx === 3.U || io.uop_idx === 7.U || io.uop_idx === 12.U || io.uop_idx === 18.U || io.uop_idx === 25.U || io.uop_idx === 33.U
  ) {
    slide_base := 2.U << elem_num_pow
  }.elsewhen(
    io.uop_idx === 1.U || io.uop_idx === 4.U || io.uop_idx === 8.U || io.uop_idx === 13.U || io.uop_idx === 19.U || io.uop_idx === 26.U || io.uop_idx === 34.U
  ) {
  ...
  val elem_vld = LookupTreeDefault(
    io.vlmul,
    elem_num,
    List(
  ...
  val slide_up_module = VecInit(
    Seq(slide_up_module_0.io, slide_up_module_1.io, slide_up_module_2.io, slide_up_module_3.io)
  )
  for (i <- 0 until 4) {
...
class Slide1UpModule extends VPermModule {
  ...
  val slide_1_up_module = VecInit(
    Seq(slide_1_up_module_0.io, slide_1_up_module_1.io, slide_1_up_module_2.io, slide_1_up_module_3.io)
  )
  for (i <- 0 until 4) {
...
class SlideDownLookup(n: Int) extends VPermModule {
  ...
  for (i <- 0 until n) {
    ...
    res_agnostic(i) := RegNext(((elements_idx >= io.vl) && io.ta) || (!io.vm && !io.mask(i).asBool && io.ma))
    res_update(i) := RegNext(
      (io.slide_base <= (io.slide +& i.U)) && ((io.slide +& i.U) < (io.elem_vld +& io.slide_base))
    )
...
class SlideDownLookupModule extends VPermModule {
  ...
  when(io.uop_idx === 35.U) {
    ...
    ((io.vlmul === "b010".U) && (io.uop_idx === 9.U)) || ((io.vlmul === "b011".U) && (21.U <= io.uop_idx) && (io.uop_idx <= 25.U))
  ) {
    vd_idx := 3.U
  }.elsewhen(
    ((io.vlmul === "b010".U) && (7.U <= io.uop_idx) && (io.uop_idx <= 8.U)) || ((io.vlmul === "b011".U) && (15.U <= io.uop_idx) && (io.uop_idx <= 20.U))
  ) {
    vd_idx := 2.U
  }.elsewhen(
    ((io.vlmul === "b001".U) && (io.uop_idx === 2.U)) || ((io.vlmul === "b010".U) && (4.U <= io.uop_idx) && (io.uop_idx <= 6.U)) || ((io.vlmul === "b011".U) && (8.U <= io.uop_idx) && (io.uop_idx <= 14.U))
  ) {
    vd_idx := 1.U
  }.otherwise {
    vd_idx := 0.U
  ...
  switch(io.vlmul) {
    ...
    is("b011".U) { //lmul=8
      when(io.uop_idx === 0.U) {
        ...
        (io.uop_idx === 4.U) || (io.uop_idx === 11.U) || (io.uop_idx === 17.U) || (io.uop_idx === 22.U) || (io.uop_idx === 26.U)
      ) {
        slide_base := 3.U << elem_num_pow
      }.elsewhen(
        (io.uop_idx === 5.U) || (io.uop_idx === 12.U) || (io.uop_idx === 18.U) || (io.uop_idx === 23.U) || (io.uop_idx === 27.U) || (io.uop_idx === 30.U)
      ) {
        slide_base := 2.U << elem_num_pow
      }.elsewhen(
        (io.uop_idx === 6.U) || (io.uop_idx === 13.U) || (io.uop_idx === 19.U) || (io.uop_idx === 24.U) || (io.uop_idx === 28.U) || (io.uop_idx === 31.U) || (io.uop_idx === 33.U)
      ) {
        slide_base := 1.U << elem_num_pow
      }.otherwise {
        slide_base := 0.U
  ...
  val slide_down_module = VecInit(
    Seq(slide_down_module_0.io, slide_down_module_1.io, slide_down_module_2.io, slide_down_module_3.io)
  )
  for (i <- 0 until 4) {
...
class Slide1Down(n: Int) extends VPermModule {
  ...
  for (i <- 0 until n) {
    ...
    res_keep_old_vd(i) := RegNext(
      (!io.vm && !io
        .mask(i)
        .asBool && !io.ma) || (elements_idx < io.vstart) || ((elements_idx >= io.vl) && !io.ta) || (io.ld_rs1_with_prev_res && (elements_idx +& 1.U =/= io.vl))
    )
    res_agnostic(i) := RegNext(((elements_idx >= io.vl) && io.ta) || (!io.vm && !io.mask(i).asBool && io.ma))
    res_update_hi(i) := RegNext(
      (io.ld_rs1_with_prev_res || io.ld_rs1_without_prev_res) && (elements_idx +& 1.U === io.vl)
    )
...
class Slide1DownModule extends VPermModule {
  ...
  val ld_rs1_with_prev_res =
    (io.uop_idx === 1.U) || (io.uop_idx === 3.U) || (io.uop_idx === 5.U) || (io.uop_idx === 7.U) || (io.uop_idx === 9.U) || (io.uop_idx === 11.U) || (io.uop_idx === 13.U)
  ...
  val slide_1_down_module = VecInit(
    Seq(slide_1_down_module_0.io, slide_1_down_module_1.io, slide_1_down_module_2.io, slide_1_down_module_3.io)
  )
  for (i <- 0 until 4) {
