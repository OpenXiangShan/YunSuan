...
class VRGatherLookupModule extends VPermModule {
  ...
  when((56.U <= io.uop_idx) && (io.uop_idx <= 63.U)) {
    ...
    ((io.vlmul === "b010".U) && (12.U <= io.uop_idx) && (io.uop_idx <= 15.U)) || ((io.vlmul === "b011".U) && (24.U <= io.uop_idx) && (io.uop_idx <= 31.U))
  ) {
    vd_idx := 3.U
  }.elsewhen(
    ((io.vlmul === "b010".U) && (8.U <= io.uop_idx) && (io.uop_idx <= 11.U)) || ((io.vlmul === "b011".U) && (16.U <= io.uop_idx) && (io.uop_idx <= 23.U))
  ) {
    vd_idx := 2.U
  }.elsewhen(
    ((io.vlmul === "b001".U) && (2.U <= io.uop_idx) && (io.uop_idx <= 3.U)) || ((io.vlmul === "b010".U) && (4.U <= io.uop_idx) && (io.uop_idx <= 7.U)) || ((io.vlmul === "b011".U) && (8.U <= io.uop_idx) && (io.uop_idx <= 15.U))
  ) {
    vd_idx := 1.U
  }.otherwise {
    vd_idx := 0.U
  ...
  when((io.vlmul === "b011".U) && (io.uop_idx(2, 0) === "b111".U)) {
    ...
    ((io.vlmul === "b011".U) && (io.uop_idx(2, 0) === "b011".U)) || ((io.vlmul === "b010".U) && (io
      .uop_idx(1, 0) === "b11".U))
  ) {
    table_idx := 3.U
  }.elsewhen(
    ((io.vlmul === "b011".U) && (io.uop_idx(2, 0) === "b010".U)) || ((io.vlmul === "b010".U) && (io
      .uop_idx(1, 0) === "b10".U))
  ) {
    table_idx := 2.U
  }.elsewhen(
    ((io.vlmul === "b011".U) && (io.uop_idx(2, 0) === "b001".U)) || ((io.vlmul === "b010".U) && (io
      .uop_idx(1, 0) === "b01".U)) || ((io.vlmul === "b001".U) && (io.uop_idx(0) === "b1".U))
  ) {
    table_idx := 1.U
  }.otherwise {
    table_idx := 0.U
  ...
  val gather_lookup_module = VecInit(
    Seq(gather_lookup_module_0.io, gather_lookup_module_1.io, gather_lookup_module_2.io, gather_lookup_module_3.io)
  )
  for (i <- 0 until 4) {
  ...
  val gather_res_data = LookupTree(
    vformat,
    List(
  ...
  val gather_vx_lookup_module = VecInit(
    Seq(
      gather_vx_lookup_module_0.io,
      gather_vx_lookup_module_1.io,
      gather_vx_lookup_module_2.io,
      gather_vx_lookup_module_3.io
    )
  )
  for (i <- 0 until 4) {
  ...
  val gather_vx_res_data = LookupTree(
    vformat,
    List(
  ...
  io.res_vd := Mux(
    io.vstart >= io.vl,
    io.old_vd,
    Mux(io.opcode === VPermType.vrgather, gather_res_data, gather_vx_res_data)
  )
}
