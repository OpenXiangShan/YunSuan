...
class VectorIntAdder() extends Module {
  ...
  val io = IO(new Bundle {
    ...
    val out_temp = Mux1H(Seq(is_add, is_sub, is_add_carry, is_sub_borrow, is_widening_add, is_widening_sub, is_max_unsigned, is_min_unsigned,is_max_signed,is_min_signed),
      Seq(add, sub, add_carry, sub_borrow, widening_add, widening_sub, out_max_unsigned, out_min_unsigned, out_max_signed, out_min_signed))
