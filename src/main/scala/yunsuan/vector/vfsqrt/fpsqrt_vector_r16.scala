...
class fpsqrt_vector_r16(
  ...
  op_is_zero_0 := op_exp_is_zero_0 & op_frac_is_zero_0
  op_is_zero_1 := op_exp_is_zero_1 & op_frac_is_zero_1
  op_is_zero_2 := op_exp_is_zero_2 & op_frac_is_zero_2
  op_is_zero_3 := op_exp_is_zero_3 & op_frac_is_zero_3
  op_is_inf_0 := op_exp_is_max_0 & op_frac_is_zero_0
...
//      (Fill(64, fp_fmt_q(2)) & f64_res_0)
  ...
  val vector_fflags = Mux1H(
    Seq(
      fp_fmt_q(0) -> f16_fflags,
      fp_fmt_q(1) -> f32_fflags,
      fp_fmt_q(2) -> f64_fflags
    )
  )
  val scalar_fflags = Cat(
    0.U(15.W),
    Mux1H(
      Seq(
        fp_fmt_q(0) -> fflags_3,
  ...
  fflags_o := Mux(v_mode_q, vector_fflags, scalar_fflags)
//    Cat(
