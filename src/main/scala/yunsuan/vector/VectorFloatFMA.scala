...
class VectorFloatFMA() extends Module {
  ...
  def shiftLeftWithMux(srcValue: UInt, shiftValue: UInt): UInt = {
    ...
    for (i <- 0 until shiftValue.getWidth) {
      res_vec(i + 1) := Mux(
        ...
        res_vec(i) << (1 << (shiftValue.getWidth - 1 - i)),
        res_vec(i)
      )
    }
    res_vec(vecLength - 1)
  ...
  val is_fp64_reg0 = RegNext(is_fp64)
  val is_fp64_reg1 = RegNext(is_fp64_reg0)
  val is_fp64_reg2 = RegNext(is_fp64_reg1)
  ...
  val fp_c_f64 =
    Mux(is_vfmul, 0.U(64.W), sign_inv(Mux(swap_fp_a_fp_c, io.fp_a(63, 0), io.fp_c(63, 0)), fp_c_is_sign_inv))
  ...
  val fp_c_f32_0 =
    Mux(is_vfmul, 0.U(32.W), sign_inv(Mux(swap_fp_a_fp_c, io.fp_a(31, 0), io.fp_c(31, 0)), fp_c_is_sign_inv))
  val fp_c_f32_1 =
    Mux(is_vfmul, 0.U(32.W), sign_inv(Mux(swap_fp_a_fp_c, io.fp_a(63, 32), io.fp_c(63, 32)), fp_c_is_sign_inv))
  ...
  val fp_c_f16_0 =
    Mux(is_vfmul, 0.U(16.W), sign_inv(Mux(swap_fp_a_fp_c, io.fp_a(15, 0), io.fp_c(15, 0)), fp_c_is_sign_inv))
  val fp_c_f16_1 =
    Mux(is_vfmul, 0.U(16.W), sign_inv(Mux(swap_fp_a_fp_c, io.fp_a(31, 16), io.fp_c(31, 16)), fp_c_is_sign_inv))
  val fp_c_f16_2 =
    Mux(is_vfmul, 0.U(16.W), sign_inv(Mux(swap_fp_a_fp_c, io.fp_a(47, 32), io.fp_c(47, 32)), fp_c_is_sign_inv))
  val fp_c_f16_3 =
    Mux(is_vfmul, 0.U(16.W), sign_inv(Mux(swap_fp_a_fp_c, io.fp_a(63, 48), io.fp_c(63, 48)), fp_c_is_sign_inv))
  ...
  val sign_a_b_f32_0 =
    Mux(io.res_widening & is_fp32, widen_sign_a_b_f16_0, (fp_a_f32_0.head(1) ^ fp_b_f32_0.head(1)).asBool)
  val sign_a_b_f32_1 =
    Mux(io.res_widening & is_fp32, widen_sign_a_b_f16_1, (fp_a_f32_1.head(1) ^ fp_b_f32_1.head(1)).asBool)
  ...
  val is_sub_f64_reg0 = RegNext(is_sub_f64)
  val is_sub_f64_reg1 = RegNext(is_sub_f64_reg0)
  val is_sub_f64_reg2 = RegNext(is_sub_f64_reg1)
  ...
  val fp_a_significand_f32_0 = Mux(
    io.res_widening & is_fp32,
    Cat(widen_a_significand_f16_0, 0.U(13.W)),
    Cat(Ea_f32_0_is_not_zero, fp_a_f32_0(22, 0))
  )
  val fp_b_significand_f32_0 = Mux(
    io.res_widening & is_fp32,
    Cat(widen_b_significand_f16_0, 0.U(13.W)),
    Cat(Eb_f32_0_is_not_zero, fp_b_f32_0(22, 0))
  )
  val fp_c_significand_f32_0 = Cat(Ec_f32_0_is_not_zero, fp_c_f32_0(22, 0))
  val fp_a_significand_f32_1 = Mux(
    io.res_widening & is_fp32,
    Cat(widen_a_significand_f16_1, 0.U(13.W)),
    Cat(Ea_f32_1_is_not_zero, fp_a_f32_1(22, 0))
  )
  val fp_b_significand_f32_1 = Mux(
    io.res_widening & is_fp32,
    Cat(widen_b_significand_f16_1, 0.U(13.W)),
    Cat(Eb_f32_1_is_not_zero, fp_b_f32_1(22, 0))
  )
  val fp_c_significand_f32_1 = Cat(Ec_f32_1_is_not_zero, fp_c_f32_1(22, 0))
  val fp_a_significand_f64 = Mux(
    io.res_widening & is_fp64,
    Cat(widen_a_significand_f32_0, 0.U(29.W)),
    Cat(Ea_f64_is_not_zero, fp_a_f64.tail(exponentWidth + 1))
  )
  val fp_b_significand_f64 = Mux(
    io.res_widening & is_fp64,
    Cat(widen_b_significand_f32_0, 0.U(29.W)),
    Cat(Eb_f64_is_not_zero, fp_b_f64.tail(exponentWidth + 1))
  )
  ...
  val biasF32 = (1 << (8 - 1)) - 1
  val biasF16 = (1 << (5 - 1)) - 1
  val Ea_fix_f64_widening = Mux(
    io.res_widening & is_fp64,
    Cat(widen_Ea_fix_f32_0.head(1), Fill(3, (~widen_Ea_fix_f32_0.head(1)).asUInt), widen_Ea_fix_f32_0(6, 0)),
    Ea_fix_f64
  )
  val Eb_fix_f64_widening = Mux(
    io.res_widening & is_fp64,
    Cat(widen_Eb_fix_f32_0.head(1), Fill(3, (~widen_Eb_fix_f32_0.head(1)).asUInt), widen_Eb_fix_f32_0(6, 0)),
    Eb_fix_f64
  )
  val Ea_fix_f32_widening_0 = Mux(
    io.res_widening & is_fp32,
    Cat(widen_Ea_fix_f16_0.head(1), Fill(3, (~widen_Ea_fix_f16_0.head(1)).asUInt), widen_Ea_fix_f16_0(3, 0)),
    Ea_fix_f32_0
  )
  val Eb_fix_f32_widening_0 = Mux(
    io.res_widening & is_fp32,
    Cat(widen_Eb_fix_f16_0.head(1), Fill(3, (~widen_Eb_fix_f16_0.head(1)).asUInt), widen_Eb_fix_f16_0(3, 0)),
    Eb_fix_f32_0
  )
  val Ea_fix_f32_widening_1 = Mux(
    io.res_widening & is_fp32,
    Cat(widen_Ea_fix_f16_1.head(1), Fill(3, (~widen_Ea_fix_f16_1.head(1)).asUInt), widen_Ea_fix_f16_1(3, 0)),
    Ea_fix_f32_1
  )
  val Eb_fix_f32_widening_1 = Mux(
    io.res_widening & is_fp32,
    Cat(widen_Eb_fix_f16_1.head(1), Fill(3, (~widen_Eb_fix_f16_1.head(1)).asUInt), widen_Eb_fix_f16_1(3, 0)),
    Eb_fix_f32_1
  )
  ...
  val rshift_guard_f64 = Reg(UInt(1.W))
  val rshift_guard_f32_0 = Reg(UInt(1.W))
  val rshift_guard_f32_1 = Reg(UInt(1.W))
  val rshift_guard_f16_0 = Reg(UInt(1.W))
  val rshift_guard_f16_1 = Reg(UInt(1.W))
  val rshift_guard_f16_2 = Reg(UInt(1.W))
  val rshift_guard_f16_3 = Reg(UInt(1.W))
  val rshift_round_f64 = Reg(UInt(1.W))
  val rshift_round_f32_0 = Reg(UInt(1.W))
  val rshift_round_f32_1 = Reg(UInt(1.W))
  val rshift_round_f16_0 = Reg(UInt(1.W))
  val rshift_round_f16_1 = Reg(UInt(1.W))
  val rshift_round_f16_2 = Reg(UInt(1.W))
  val rshift_round_f16_3 = Reg(UInt(1.W))
  val rshift_sticky_f64 = Reg(UInt(1.W))
  val rshift_sticky_f32_0 = Reg(UInt(1.W))
  val rshift_sticky_f32_1 = Reg(UInt(1.W))
  val rshift_sticky_f16_0 = Reg(UInt(1.W))
  val rshift_sticky_f16_1 = Reg(UInt(1.W))
  val rshift_sticky_f16_2 = Reg(UInt(1.W))
  val rshift_sticky_f16_3 = Reg(UInt(1.W))
  rshift_guard_f64 := Mux(Ec_is_medium_f64, rshift_result_with_grs_f64(2), 0.U)
  rshift_guard_f32_0 := Mux(Ec_is_medium_f32_0, rshift_result_with_grs_f32_0(2), 0.U)
  rshift_guard_f32_1 := Mux(Ec_is_medium_f32_1, rshift_result_with_grs_f32_1(2), 0.U)
  rshift_guard_f16_0 := Mux(Ec_is_medium_f16_0, rshift_result_with_grs_f16_0(2), 0.U)
  rshift_guard_f16_1 := Mux(Ec_is_medium_f16_1, rshift_result_with_grs_f16_1(2), 0.U)
  rshift_guard_f16_2 := Mux(Ec_is_medium_f16_2, rshift_result_with_grs_f16_2(2), 0.U)
  rshift_guard_f16_3 := Mux(Ec_is_medium_f16_3, rshift_result_with_grs_f16_3(2), 0.U)
  rshift_round_f64 := Mux(Ec_is_medium_f64, rshift_result_with_grs_f64(1), 0.U)
  rshift_round_f32_0 := Mux(Ec_is_medium_f32_0, rshift_result_with_grs_f32_0(1), 0.U)
  rshift_round_f32_1 := Mux(Ec_is_medium_f32_1, rshift_result_with_grs_f32_1(1), 0.U)
  rshift_round_f16_0 := Mux(Ec_is_medium_f16_0, rshift_result_with_grs_f16_0(1), 0.U)
  rshift_round_f16_1 := Mux(Ec_is_medium_f16_1, rshift_result_with_grs_f16_1(1), 0.U)
  rshift_round_f16_2 := Mux(Ec_is_medium_f16_2, rshift_result_with_grs_f16_2(1), 0.U)
  rshift_round_f16_3 := Mux(Ec_is_medium_f16_3, rshift_result_with_grs_f16_3(1), 0.U)
  rshift_sticky_f64 := Mux(
    Ec_is_medium_f64,
    rshift_result_with_grs_f64(0),
    Mux(Ec_is_too_big_f64, 0.U, fp_c_significand_f64.orR)
  )
  rshift_sticky_f32_0 := Mux(
    Ec_is_medium_f32_0,
    rshift_result_with_grs_f32_0(0),
    Mux(Ec_is_too_big_f32_0, 0.U, fp_c_significand_f32_0.orR)
  )
  rshift_sticky_f32_1 := Mux(
    Ec_is_medium_f32_1,
    rshift_result_with_grs_f32_1(0),
    Mux(Ec_is_too_big_f32_1, 0.U, fp_c_significand_f32_1.orR)
  )
  rshift_sticky_f16_0 := Mux(
    Ec_is_medium_f16_0,
    rshift_result_with_grs_f16_0(0),
    Mux(Ec_is_too_big_f16_0, 0.U, fp_c_significand_f16_0.orR)
  )
  rshift_sticky_f16_1 := Mux(
    Ec_is_medium_f16_1,
    rshift_result_with_grs_f16_1(0),
    Mux(Ec_is_too_big_f16_1, 0.U, fp_c_significand_f16_1.orR)
  )
  rshift_sticky_f16_2 := Mux(
    Ec_is_medium_f16_2,
    rshift_result_with_grs_f16_2(0),
    Mux(Ec_is_too_big_f16_2, 0.U, fp_c_significand_f16_2.orR)
  )
  rshift_sticky_f16_3 := Mux(
    Ec_is_medium_f16_3,
    rshift_result_with_grs_f16_3(0),
    Mux(Ec_is_too_big_f16_3, 0.U, fp_c_significand_f16_3.orR)
  )
  ...
  val booth_in_a = Mux(
    ...
    Mux(
      ...
      Cat(
        Cat(fp_a_significand_f16_3, 0.U(2.W), fp_a_significand_f16_2),
        0.U(5.W),
        Cat(fp_a_significand_f16_1, 0.U(2.W), fp_a_significand_f16_0)
      )
    )
  )
  val booth_in_b = Mux(
    ...
    Mux(
      ...
      Cat(
        Cat(fp_b_significand_f16_3, 0.U(2.W), fp_b_significand_f16_2),
        0.U(5.W),
        Cat(fp_b_significand_f16_1, 0.U(2.W), fp_b_significand_f16_0)
      )
    )
  )
  ...
  val U_CSAnto2 = Module(
    new CSA_Nto2With3to2MainPipeline(
      U_BoothEncoder.io.out_pp.length,
      U_BoothEncoder.io.out_pp.head.getWidth,
      pipeLevel = 5
    )
  )
  ...
  val CSA3to2_in_b = Mux(
    ...
    Mux(
      is_fp32_reg0,
      Cat(
        U_CSAnto2.io.out_car.head(48),
        RegNext(is_sub_f32_1) & !rshift_guard_f32_1 & !rshift_round_f32_1 & !rshift_sticky_f32_1,
        U_CSAnto2.io.out_car(57, 49),
        U_CSAnto2.io.out_car(48, 1),
        RegNext(is_sub_f32_0) & !rshift_guard_f32_0 & !rshift_round_f32_0 & !rshift_sticky_f32_0
      ),
      Cat(
        Cat(
          U_CSAnto2.io.out_car.head(22),
          RegNext(is_sub_f16_3) & !rshift_guard_f16_3 & !rshift_round_f16_3 & !rshift_sticky_f16_3,
          U_CSAnto2.io.out_car(25 + 58, 23 + 58),
          U_CSAnto2.io.out_car(22 + 58, 1 + 58),
          RegNext(is_sub_f16_2) & !rshift_guard_f16_2 & !rshift_round_f16_2 & !rshift_sticky_f16_2
        ),
        U_CSAnto2.io.out_car(57, 49),
        Cat(
          U_CSAnto2.io.out_car(48, 27),
          RegNext(is_sub_f16_1) & !rshift_guard_f16_1 & !rshift_round_f16_1 & !rshift_sticky_f16_1,
          U_CSAnto2.io.out_car(25, 23),
          U_CSAnto2.io.out_car(22, 1),
          RegNext(is_sub_f16_0) & !rshift_guard_f16_0 & !rshift_round_f16_0 & !rshift_sticky_f16_0
        )
      )
    )
  )
  val CSA3to2_in_c = Mux(
    ...
    Mux(
      ...
      Cat(
        0.U,
        fp_c_rshiftValue_inv_f32_1_reg0(2 * 24 - 1, 0),
        0.U(10.W),
        fp_c_rshiftValue_inv_f32_0_reg0(2 * 24 - 1, 0)
      ),
      Cat(
        Cat(
          0.U,
          fp_c_rshiftValue_inv_f16_3_reg0(2 * 11 - 1, 0),
          0.U(4.W),
          fp_c_rshiftValue_inv_f16_2_reg0(2 * 11 - 1, 0)
        ),
        0.U(10.W),
  ...
  val fp_c_rshift_result_high_inv_add1 = Mux(
    is_fp64_reg0,
    ...
    Mux(
      ...
      Cat(
        fp_c_rshiftValue_inv_f16_3_reg0.head(11 + 3),
        0.U,
        fp_c_rshiftValue_inv_f16_2_reg0.head(11 + 3),
        0.U,
        fp_c_rshiftValue_inv_f16_1_reg0.head(11 + 3),
        0.U,
        fp_c_rshiftValue_inv_f16_0_reg0.head(11 + 3)
      )
    )
  ) + Cat(
  ...
  val adder_f64 = Cat(
    Mux(adder_lowbit_f64.head(1).asBool, fp_c_rshift_result_high_inv_add1_f64, fp_c_rshift_result_high_inv_add0_f64),
    adder_lowbit_f64.tail(1),
    Mux(
      is_sub_f64_reg0,
      ((~Cat(rshift_guard_f64, rshift_round_f64, rshift_sticky_f64)).asUInt + 1.U).head(2),
      Cat(rshift_guard_f64, rshift_round_f64)
    )
  )
  val adder_f32_0 = Cat(
    Mux(
      adder_lowbit_f32_0.head(1).asBool,
      fp_c_rshift_result_high_inv_add1_f32_0,
      fp_c_rshift_result_high_inv_add0_f32_0
    ),
    adder_lowbit_f32_0.tail(1),
    Mux(
      RegNext(is_sub_f32_0),
      ((~Cat(rshift_guard_f32_0, rshift_round_f32_0, rshift_sticky_f32_0)).asUInt + 1.U).head(2),
      Cat(rshift_guard_f32_0, rshift_round_f32_0)
    )
  )
  val adder_f32_1 = Cat(
    Mux(
      adder_lowbit_f32_1.head(1).asBool,
      fp_c_rshift_result_high_inv_add1_f32_1,
      fp_c_rshift_result_high_inv_add0_f32_1
    ),
    adder_lowbit_f32_1.tail(1),
    Mux(
      RegNext(is_sub_f32_1),
      ((~Cat(rshift_guard_f32_1, rshift_round_f32_1, rshift_sticky_f32_1)).asUInt + 1.U).head(2),
      Cat(rshift_guard_f32_1, rshift_round_f32_1)
    )
  )
  val adder_f16_0 = Cat(
    Mux(
      adder_lowbit_f16_0.head(1).asBool,
      fp_c_rshift_result_high_inv_add1_f16_0,
      fp_c_rshift_result_high_inv_add0_f16_0
    ),
    adder_lowbit_f16_0.tail(1),
    Mux(
      RegNext(is_sub_f16_0),
      ((~Cat(rshift_guard_f16_0, rshift_round_f16_0, rshift_sticky_f16_0)).asUInt + 1.U).head(2),
      Cat(rshift_guard_f16_0, rshift_round_f16_0)
    )
  )
  val adder_f16_1 = Cat(
    Mux(
      adder_lowbit_f16_1.head(1).asBool,
      fp_c_rshift_result_high_inv_add1_f16_1,
      fp_c_rshift_result_high_inv_add0_f16_1
    ),
    adder_lowbit_f16_1.tail(1),
    Mux(
      RegNext(is_sub_f16_1),
      ((~Cat(rshift_guard_f16_1, rshift_round_f16_1, rshift_sticky_f16_1)).asUInt + 1.U).head(2),
      Cat(rshift_guard_f16_1, rshift_round_f16_1)
    )
  )
  val adder_f16_2 = Cat(
    Mux(
      adder_lowbit_f16_2.head(1).asBool,
      fp_c_rshift_result_high_inv_add1_f16_2,
      fp_c_rshift_result_high_inv_add0_f16_2
    ),
    adder_lowbit_f16_2.tail(1),
    Mux(
      RegNext(is_sub_f16_2),
      ((~Cat(rshift_guard_f16_2, rshift_round_f16_2, rshift_sticky_f16_2)).asUInt + 1.U).head(2),
      Cat(rshift_guard_f16_2, rshift_round_f16_2)
    )
  )
  val adder_f16_3 = Cat(
    Mux(
      adder_lowbit_f16_3.head(1).asBool,
      fp_c_rshift_result_high_inv_add1_f16_3,
      fp_c_rshift_result_high_inv_add0_f16_3
    ),
    adder_lowbit_f16_3.tail(1),
    Mux(
      RegNext(is_sub_f16_3),
      ((~Cat(rshift_guard_f16_3, rshift_round_f16_3, rshift_sticky_f16_3)).asUInt + 1.U).head(2),
      Cat(rshift_guard_f16_3, rshift_round_f16_3)
    )
  )
  ...
  val adder_is_negative_f64_reg2 = ShiftRegister(adder_is_negative_f64, 2)
  val adder_is_negative_f32_0_reg2 = ShiftRegister(adder_is_negative_f32_0, 2)
  val adder_is_negative_f32_1_reg2 = ShiftRegister(adder_is_negative_f32_1, 2)
  val adder_is_negative_f16_0_reg2 = ShiftRegister(adder_is_negative_f16_0, 2)
  val adder_is_negative_f16_1_reg2 = ShiftRegister(adder_is_negative_f16_1, 2)
  val adder_is_negative_f16_2_reg2 = ShiftRegister(adder_is_negative_f16_2, 2)
  val adder_is_negative_f16_3_reg2 = ShiftRegister(adder_is_negative_f16_3, 2)
  ...
  val E_greater_f64_reg2 =
    ShiftRegister(Mux(Eab_is_greater_f64, Eab_f64(exponentWidth, 0).asUInt, Cat(0.U(1.W), Ec_fix_f64)), 3)
  val E_greater_f32_0_reg2 =
    ShiftRegister(Mux(Eab_is_greater_f32_0, Eab_f32_0(8, 0).asUInt, Cat(0.U(1.W), Ec_fix_f32_0)), 3)
  val E_greater_f32_1_reg2 =
    ShiftRegister(Mux(Eab_is_greater_f32_1, Eab_f32_1(8, 0).asUInt, Cat(0.U(1.W), Ec_fix_f32_1)), 3)
  val E_greater_f16_0_reg2 =
    ShiftRegister(Mux(Eab_is_greater_f16_0, Eab_f16_0(5, 0).asUInt, Cat(0.U(1.W), Ec_fix_f16_0)), 3)
  val E_greater_f16_1_reg2 =
    ShiftRegister(Mux(Eab_is_greater_f16_1, Eab_f16_1(5, 0).asUInt, Cat(0.U(1.W), Ec_fix_f16_1)), 3)
  val E_greater_f16_2_reg2 =
    ShiftRegister(Mux(Eab_is_greater_f16_2, Eab_f16_2(5, 0).asUInt, Cat(0.U(1.W), Ec_fix_f16_2)), 3)
  val E_greater_f16_3_reg2 =
    ShiftRegister(Mux(Eab_is_greater_f16_3, Eab_f16_3(5, 0).asUInt, Cat(0.U(1.W), Ec_fix_f16_3)), 3)

  val lshift_value_max_f64_reg0 = Reg(UInt(12.W))
  val lshift_value_max_f32_0_reg0 = Reg(UInt(9.W))
  val lshift_value_max_f32_1_reg0 = Reg(UInt(9.W))
  val lshift_value_max_f16_0_reg0 = Reg(UInt(6.W))
  val lshift_value_max_f16_1_reg0 = Reg(UInt(6.W))
  val lshift_value_max_f16_2_reg0 = Reg(UInt(6.W))
  val lshift_value_max_f16_3_reg0 = Reg(UInt(6.W))
  lshift_value_max_f64_reg0 := Mux(
    Eab_is_greater_f64,
    Eab_f64(exponentWidth, 0).asUInt - 1.U,
    Cat(0.U, Ec_fix_f64 - 1.U)
  )
  lshift_value_max_f32_0_reg0 := Mux(Eab_is_greater_f32_0, Eab_f32_0(8, 0).asUInt - 1.U, Cat(0.U, Ec_fix_f32_0 - 1.U))
  lshift_value_max_f32_1_reg0 := Mux(Eab_is_greater_f32_1, Eab_f32_1(8, 0).asUInt - 1.U, Cat(0.U, Ec_fix_f32_1 - 1.U))
  lshift_value_max_f16_0_reg0 := Mux(Eab_is_greater_f16_0, Eab_f16_0(5, 0).asUInt - 1.U, Cat(0.U, Ec_fix_f16_0 - 1.U))
  lshift_value_max_f16_1_reg0 := Mux(Eab_is_greater_f16_1, Eab_f16_1(5, 0).asUInt - 1.U, Cat(0.U, Ec_fix_f16_1 - 1.U))
  lshift_value_max_f16_2_reg0 := Mux(Eab_is_greater_f16_2, Eab_f16_2(5, 0).asUInt - 1.U, Cat(0.U, Ec_fix_f16_2 - 1.U))
  lshift_value_max_f16_3_reg0 := Mux(Eab_is_greater_f16_3, Eab_f16_3(5, 0).asUInt - 1.U, Cat(0.U, Ec_fix_f16_3 - 1.U))
  ...
  val lshift_value_mask_f64 = Mux(
    lshift_value_max_f64_reg0.head(lshift_value_max_f64_reg0.getWidth - LZDWidth_f64).orR,
    0.U(adder_inv_f64.getWidth.W),
    Fill(adder_inv_f64.getWidth, 1.U) >> lshift_value_max_f64_reg0.tail(
      lshift_value_max_f64_reg0.getWidth - LZDWidth_f64
    )
  ).asUInt
  val lshift_value_mask_f32_0 = Mux(
    lshift_value_max_f32_0_reg0.head(lshift_value_max_f32_0_reg0.getWidth - LZDWidth_f32_0).orR,
    0.U(adder_inv_f32_0.getWidth.W),
    Fill(adder_inv_f32_0.getWidth, 1.U) >> lshift_value_max_f32_0_reg0.tail(
      lshift_value_max_f32_0_reg0.getWidth - LZDWidth_f32_0
    )
  ).asUInt
  val lshift_value_mask_f32_1 = Mux(
    lshift_value_max_f32_1_reg0.head(lshift_value_max_f32_1_reg0.getWidth - LZDWidth_f32_1).orR,
    0.U(adder_inv_f32_1.getWidth.W),
    Fill(adder_inv_f32_1.getWidth, 1.U) >> lshift_value_max_f32_1_reg0.tail(
      lshift_value_max_f32_1_reg0.getWidth - LZDWidth_f32_1
    )
  ).asUInt
  val lshift_value_mask_f16_0 = Mux(
    lshift_value_max_f16_0_reg0.head(lshift_value_max_f16_0_reg0.getWidth - LZDWidth_f16_0).orR,
    0.U(adder_inv_f16_0.getWidth.W),
    Fill(adder_inv_f16_0.getWidth, 1.U) >> lshift_value_max_f16_0_reg0.tail(
      lshift_value_max_f16_0_reg0.getWidth - LZDWidth_f16_0
    )
  ).asUInt
  val lshift_value_mask_f16_1 = Mux(
    lshift_value_max_f16_1_reg0.head(lshift_value_max_f16_1_reg0.getWidth - LZDWidth_f16_1).orR,
    0.U(adder_inv_f16_1.getWidth.W),
    Fill(adder_inv_f16_1.getWidth, 1.U) >> lshift_value_max_f16_1_reg0.tail(
      lshift_value_max_f16_1_reg0.getWidth - LZDWidth_f16_1
    )
  ).asUInt
  val lshift_value_mask_f16_2 = Mux(
    lshift_value_max_f16_2_reg0.head(lshift_value_max_f16_2_reg0.getWidth - LZDWidth_f16_2).orR,
    0.U(adder_inv_f16_2.getWidth.W),
    Fill(adder_inv_f16_2.getWidth, 1.U) >> lshift_value_max_f16_2_reg0.tail(
      lshift_value_max_f16_2_reg0.getWidth - LZDWidth_f16_2
    )
  ).asUInt
  val lshift_value_mask_f16_3 = Mux(
    lshift_value_max_f16_3_reg0.head(lshift_value_max_f16_3_reg0.getWidth - LZDWidth_f16_3).orR,
    0.U(adder_inv_f16_3.getWidth.W),
    Fill(adder_inv_f16_3.getWidth, 1.U) >> lshift_value_max_f16_3_reg0.tail(
      lshift_value_max_f16_3_reg0.getWidth - LZDWidth_f16_3
    )
  ).asUInt

  val tzd_adder_f64_reg1 = LZD(
    RegNext(Reverse(Mux(is_fp64_reg0, adder_f64.asUInt, Cat(1.U(87.W), adder_f32_1.asUInt)))).asTypeOf(adder_f64)
  )
  val tzd_adder_f32_0_reg1 = LZD(RegNext(Reverse(adder_f32_0.asUInt)).asTypeOf(adder_f32_0))
  val tzd_adder_f32_1_reg1 = tzd_adder_f64_reg1.asTypeOf(tzd_adder_f32_0_reg1)
  val tzd_adder_f16_0_reg1 = LZD(RegNext(Reverse(adder_f16_0.asUInt)).asTypeOf(adder_f16_0))
  val tzd_adder_f16_1_reg1 = LZD(RegNext(Reverse(adder_f16_1.asUInt)).asTypeOf(adder_f16_1))
  val tzd_adder_f16_2_reg1 = LZD(RegNext(Reverse(adder_f16_2.asUInt)).asTypeOf(adder_f16_2))
  val tzd_adder_f16_3_reg1 = LZD(RegNext(Reverse(adder_f16_3.asUInt)).asTypeOf(adder_f16_3))
  val lzd_adder_inv_mask_f64 = LZD(
    RegNext(
      Mux(
        is_fp64_reg0,
        adder_inv_f64 | lshift_value_mask_f64,
        Cat(adder_inv_f32_1 | lshift_value_mask_f32_1, 1.U << 86)
      )
    ).asTypeOf(adder_inv_f64)
  )
  val lzd_adder_inv_mask_f32_0 = LZD(RegNext(adder_inv_f32_0 | lshift_value_mask_f32_0).asTypeOf(adder_inv_f32_0))
  val lzd_adder_inv_mask_f32_1 = lzd_adder_inv_mask_f64.asTypeOf(lzd_adder_inv_mask_f32_0)
  val lzd_adder_inv_mask_f16_0 = LZD(RegNext(adder_inv_f16_0 | lshift_value_mask_f16_0).asTypeOf(adder_inv_f16_0))
  val lzd_adder_inv_mask_f16_1 = LZD(RegNext(adder_inv_f16_1 | lshift_value_mask_f16_1).asTypeOf(adder_inv_f16_1))
  val lzd_adder_inv_mask_f16_2 = LZD(RegNext(adder_inv_f16_2 | lshift_value_mask_f16_2).asTypeOf(adder_inv_f16_2))
  val lzd_adder_inv_mask_f16_3 = LZD(RegNext(adder_inv_f16_3 | lshift_value_mask_f16_3).asTypeOf(adder_inv_f16_3))
  ...
  val lshift_mask_valid_f64_reg1 =
    (RegNext(adder_inv_f64) | RegNext(lshift_value_mask_f64)) === RegNext(lshift_value_mask_f64)
  val lshift_mask_valid_f32_0_reg1 =
    (RegNext(adder_inv_f32_0) | RegNext(lshift_value_mask_f32_0)) === RegNext(lshift_value_mask_f32_0)
  val lshift_mask_valid_f32_1_reg1 =
    (RegNext(adder_inv_f32_1) | RegNext(lshift_value_mask_f32_1)) === RegNext(lshift_value_mask_f32_1)
  val lshift_mask_valid_f16_0_reg1 =
    (RegNext(adder_inv_f16_0) | RegNext(lshift_value_mask_f16_0)) === RegNext(lshift_value_mask_f16_0)
  val lshift_mask_valid_f16_1_reg1 =
    (RegNext(adder_inv_f16_1) | RegNext(lshift_value_mask_f16_1)) === RegNext(lshift_value_mask_f16_1)
  val lshift_mask_valid_f16_2_reg1 =
    (RegNext(adder_inv_f16_2) | RegNext(lshift_value_mask_f16_2)) === RegNext(lshift_value_mask_f16_2)
  val lshift_mask_valid_f16_3_reg1 =
    (RegNext(adder_inv_f16_3) | RegNext(lshift_value_mask_f16_3)) === RegNext(lshift_value_mask_f16_3)
  ...
  val adder_f64_reg1 = Reg(UInt(adder_f64.getWidth.W))
  val adder_f32_0_reg1 = Reg(UInt(adder_f32_0.getWidth.W))
  val adder_f32_1_reg1 = Reg(UInt(adder_f32_1.getWidth.W))
  val adder_f16_0_reg1 = Reg(UInt(adder_f16_0.getWidth.W))
  val adder_f16_1_reg1 = Reg(UInt(adder_f16_1.getWidth.W))
  val adder_f16_2_reg1 = Reg(UInt(adder_f16_2.getWidth.W))
  val adder_f16_3_reg1 = Reg(UInt(adder_f16_3.getWidth.W))
  ...
  val lshift_adder_inv_f64 = Cat(
    Mux(
      RegNext(adder_is_negative_f64),
      ~lshift_adder_f64.head(significandWidth + 4),
      lshift_adder_f64.head(significandWidth + 4)
    ),
    lshift_adder_f64.tail(significandWidth + 4)
  )
  val lshift_adder_inv_f32_0 = Cat(
    Mux(RegNext(adder_is_negative_f32_0), ~lshift_adder_f32_0.head(24 + 4), lshift_adder_f32_0.head(24 + 4)),
    lshift_adder_f32_0.tail(24 + 4)
  )
  val lshift_adder_inv_f32_1 = Cat(
    Mux(RegNext(adder_is_negative_f32_1), ~lshift_adder_f32_1.head(24 + 4), lshift_adder_f32_1.head(24 + 4)),
    lshift_adder_f32_1.tail(24 + 4)
  )
  val lshift_adder_inv_f16_0 = Cat(
    Mux(RegNext(adder_is_negative_f16_0), ~lshift_adder_f16_0.head(11 + 4), lshift_adder_f16_0.head(11 + 4)),
    lshift_adder_f16_0.tail(11 + 4)
  )
  val lshift_adder_inv_f16_1 = Cat(
    Mux(RegNext(adder_is_negative_f16_1), ~lshift_adder_f16_1.head(11 + 4), lshift_adder_f16_1.head(11 + 4)),
    lshift_adder_f16_1.tail(11 + 4)
  )
  val lshift_adder_inv_f16_2 = Cat(
    Mux(RegNext(adder_is_negative_f16_2), ~lshift_adder_f16_2.head(11 + 4), lshift_adder_f16_2.head(11 + 4)),
    lshift_adder_f16_2.tail(11 + 4)
  )
  val lshift_adder_inv_f16_3 = Cat(
    Mux(RegNext(adder_is_negative_f16_3), ~lshift_adder_f16_3.head(11 + 4), lshift_adder_f16_3.head(11 + 4)),
    lshift_adder_f16_3.tail(11 + 4)
  )
  ...
  val lshift_adder_inv_fix_f64 =
    Mux(is_fix_f64, lshift_adder_inv_f64.head(adder_inv_f64.getWidth), lshift_adder_inv_f64.tail(1))
  val lshift_adder_inv_fix_f32_0 =
    Mux(is_fix_f32_0, lshift_adder_inv_f32_0.head(adder_inv_f32_0.getWidth), lshift_adder_inv_f32_0.tail(1))
  val lshift_adder_inv_fix_f32_1 =
    Mux(is_fix_f32_1, lshift_adder_inv_f32_1.head(adder_inv_f32_1.getWidth), lshift_adder_inv_f32_1.tail(1))
  val lshift_adder_inv_fix_f16_0 =
    Mux(is_fix_f16_0, lshift_adder_inv_f16_0.head(adder_inv_f16_0.getWidth), lshift_adder_inv_f16_0.tail(1))
  val lshift_adder_inv_fix_f16_1 =
    Mux(is_fix_f16_1, lshift_adder_inv_f16_1.head(adder_inv_f16_1.getWidth), lshift_adder_inv_f16_1.tail(1))
  val lshift_adder_inv_fix_f16_2 =
    Mux(is_fix_f16_2, lshift_adder_inv_f16_2.head(adder_inv_f16_2.getWidth), lshift_adder_inv_f16_2.tail(1))
  val lshift_adder_inv_fix_f16_3 =
    Mux(is_fix_f16_3, lshift_adder_inv_f16_3.head(adder_inv_f16_3.getWidth), lshift_adder_inv_f16_3.tail(1))

  val fraction_result_no_round_f64_reg2 = RegNext(lshift_adder_inv_fix_f64.tail(1).head(significandWidth - 1))
  val fraction_result_no_round_f32_0_reg2 = RegNext(lshift_adder_inv_fix_f32_0.tail(1).head(24 - 1))
  val fraction_result_no_round_f32_1_reg2 = RegNext(lshift_adder_inv_fix_f32_1.tail(1).head(24 - 1))
  val fraction_result_no_round_f16_0_reg2 = RegNext(lshift_adder_inv_fix_f16_0.tail(1).head(11 - 1))
  val fraction_result_no_round_f16_1_reg2 = RegNext(lshift_adder_inv_fix_f16_1.tail(1).head(11 - 1))
  val fraction_result_no_round_f16_2_reg2 = RegNext(lshift_adder_inv_fix_f16_2.tail(1).head(11 - 1))
  val fraction_result_no_round_f16_3_reg2 = RegNext(lshift_adder_inv_fix_f16_3.tail(1).head(11 - 1))
  ...
  val sign_result_temp_f64_reg2 =
    ShiftRegister(Mux(adder_is_negative_f64, RegNext(sign_c_f64), RegNext(sign_a_b_f64)), 2)
  val sign_result_temp_f32_0_reg2 =
    ShiftRegister(Mux(adder_is_negative_f32_0, RegNext(sign_c_f32_0), RegNext(sign_a_b_f32_0)), 2)
  val sign_result_temp_f32_1_reg2 =
    ShiftRegister(Mux(adder_is_negative_f32_1, RegNext(sign_c_f32_1), RegNext(sign_a_b_f32_1)), 2)
  val sign_result_temp_f16_0_reg2 =
    ShiftRegister(Mux(adder_is_negative_f16_0, RegNext(sign_c_f16_0), RegNext(sign_a_b_f16_0)), 2)
  val sign_result_temp_f16_1_reg2 =
    ShiftRegister(Mux(adder_is_negative_f16_1, RegNext(sign_c_f16_1), RegNext(sign_a_b_f16_1)), 2)
  val sign_result_temp_f16_2_reg2 =
    ShiftRegister(Mux(adder_is_negative_f16_2, RegNext(sign_c_f16_2), RegNext(sign_a_b_f16_2)), 2)
  val sign_result_temp_f16_3_reg2 =
    ShiftRegister(Mux(adder_is_negative_f16_3, RegNext(sign_c_f16_3), RegNext(sign_a_b_f16_3)), 2)
  ...
  val RNE_reg2 = ShiftRegister(RNE, 3)
  val RTZ_reg2 = ShiftRegister(RTZ, 3)
  val RDN_reg2 = ShiftRegister(RDN, 3)
  val RUP_reg2 = ShiftRegister(RUP, 3)
  val RMM_reg2 = ShiftRegister(RMM, 3)

  val sticky_f64_reg2 = RegNext(
    RegNext(
      rshift_sticky_f64
    ) | (lzd_adder_inv_mask_f64_reg1 + tzd_adder_f64_reg1 < (adder_inv_f64.getWidth - significandWidth - 2).U)
  )
  val sticky_f32_0_reg2 = RegNext(
    RegNext(
      rshift_sticky_f32_0
    ) | (lzd_adder_inv_mask_f32_0_reg1 + tzd_adder_f32_0_reg1 < (adder_inv_f32_0.getWidth - 24 - 2).U)
  )
  val sticky_f32_1_reg2 = RegNext(
    RegNext(
      rshift_sticky_f32_1
    ) | (lzd_adder_inv_mask_f32_1_reg1 + tzd_adder_f32_1_reg1 < (adder_inv_f32_1.getWidth - 24 - 2).U)
  )
  val sticky_f16_0_reg2 = RegNext(
    RegNext(
      rshift_sticky_f16_0
    ) | (lzd_adder_inv_mask_f16_0_reg1 + tzd_adder_f16_0_reg1 < (adder_inv_f16_0.getWidth - 11 - 2).U)
  )
  val sticky_f16_1_reg2 = RegNext(
    RegNext(
      rshift_sticky_f16_1
    ) | (lzd_adder_inv_mask_f16_1_reg1 + tzd_adder_f16_1_reg1 < (adder_inv_f16_1.getWidth - 11 - 2).U)
  )
  val sticky_f16_2_reg2 = RegNext(
    RegNext(
      rshift_sticky_f16_2
    ) | (lzd_adder_inv_mask_f16_2_reg1 + tzd_adder_f16_2_reg1 < (adder_inv_f16_2.getWidth - 11 - 2).U)
  )
  val sticky_f16_3_reg2 = RegNext(
    RegNext(
      rshift_sticky_f16_3
    ) | (lzd_adder_inv_mask_f16_3_reg1 + tzd_adder_f16_3_reg1 < (adder_inv_f16_3.getWidth - 11 - 2).U)
  )
  val sticky_uf_f64_reg2 = RegNext(
    RegNext(
      rshift_sticky_f64
    ) | (lzd_adder_inv_mask_f64_reg1 + tzd_adder_f64_reg1 < (adder_inv_f64.getWidth - significandWidth - 3).U)
  )
  val sticky_uf_f32_0_reg2 = RegNext(
    RegNext(
      rshift_sticky_f32_0
    ) | (lzd_adder_inv_mask_f32_0_reg1 + tzd_adder_f32_0_reg1 < (adder_inv_f32_0.getWidth - 24 - 3).U)
  )
  val sticky_uf_f32_1_reg2 = RegNext(
    RegNext(
      rshift_sticky_f32_1
    ) | (lzd_adder_inv_mask_f32_1_reg1 + tzd_adder_f32_1_reg1 < (adder_inv_f32_1.getWidth - 24 - 3).U)
  )
  val sticky_uf_f16_0_reg2 = RegNext(
    RegNext(
      rshift_sticky_f16_0
    ) | (lzd_adder_inv_mask_f16_0_reg1 + tzd_adder_f16_0_reg1 < (adder_inv_f16_0.getWidth - 11 - 3).U)
  )
  val sticky_uf_f16_1_reg2 = RegNext(
    RegNext(
      rshift_sticky_f16_1
    ) | (lzd_adder_inv_mask_f16_1_reg1 + tzd_adder_f16_1_reg1 < (adder_inv_f16_1.getWidth - 11 - 3).U)
  )
  val sticky_uf_f16_2_reg2 = RegNext(
    RegNext(
      rshift_sticky_f16_2
    ) | (lzd_adder_inv_mask_f16_2_reg1 + tzd_adder_f16_2_reg1 < (adder_inv_f16_2.getWidth - 11 - 3).U)
  )
  val sticky_uf_f16_3_reg2 = RegNext(
    RegNext(
      rshift_sticky_f16_3
    ) | (lzd_adder_inv_mask_f16_3_reg1 + tzd_adder_f16_3_reg1 < (adder_inv_f16_3.getWidth - 11 - 3).U)
  )

  val round_lshift_f64_reg2 = RegNext(lshift_adder_inv_fix_f64.tail(significandWidth + 1).head(1))
  val round_lshift_f32_0_reg2 = RegNext(lshift_adder_inv_fix_f32_0.tail(24 + 1).head(1))
  val round_lshift_f32_1_Reg2 = RegNext(lshift_adder_inv_fix_f32_1.tail(24 + 1).head(1))
  val round_lshift_f16_0_reg2 = RegNext(lshift_adder_inv_fix_f16_0.tail(11 + 1).head(1))
  val round_lshift_f16_1_reg2 = RegNext(lshift_adder_inv_fix_f16_1.tail(11 + 1).head(1))
  val round_lshift_f16_2_reg2 = RegNext(lshift_adder_inv_fix_f16_2.tail(11 + 1).head(1))
  val round_lshift_f16_3_reg2 = RegNext(lshift_adder_inv_fix_f16_3.tail(11 + 1).head(1))
  val guard_lshift_f64_reg2 = RegNext(lshift_adder_inv_fix_f64.tail(significandWidth).head(1))
  val guard_lshift_f32_0_reg2 = RegNext(lshift_adder_inv_fix_f32_0.tail(24).head(1))
  val guard_lshift_f32_1_reg2 = RegNext(lshift_adder_inv_fix_f32_1.tail(24).head(1))
  val guard_lshift_f16_0_reg2 = RegNext(lshift_adder_inv_fix_f16_0.tail(11).head(1))
  val guard_lshift_f16_1_reg2 = RegNext(lshift_adder_inv_fix_f16_1.tail(11).head(1))
  val guard_lshift_f16_2_reg2 = RegNext(lshift_adder_inv_fix_f16_2.tail(11).head(1))
  val guard_lshift_f16_3_reg2 = RegNext(lshift_adder_inv_fix_f16_3.tail(11).head(1))
  val round_f64 = Mux(adder_is_negative_f64_reg2, round_lshift_f64_reg2 ^ !sticky_f64_reg2, round_lshift_f64_reg2)
  val round_f32_0 =
    Mux(adder_is_negative_f32_0_reg2, round_lshift_f32_0_reg2 ^ !sticky_f32_0_reg2, round_lshift_f32_0_reg2)
  val round_f32_1 =
    Mux(adder_is_negative_f32_1_reg2, round_lshift_f32_1_Reg2 ^ !sticky_f32_1_reg2, round_lshift_f32_1_Reg2)
  val round_f16_0 =
    Mux(adder_is_negative_f16_0_reg2, round_lshift_f16_0_reg2 ^ !sticky_f16_0_reg2, round_lshift_f16_0_reg2)
  val round_f16_1 =
    Mux(adder_is_negative_f16_1_reg2, round_lshift_f16_1_reg2 ^ !sticky_f16_1_reg2, round_lshift_f16_1_reg2)
  val round_f16_2 =
    Mux(adder_is_negative_f16_2_reg2, round_lshift_f16_2_reg2 ^ !sticky_f16_2_reg2, round_lshift_f16_2_reg2)
  val round_f16_3 =
    Mux(adder_is_negative_f16_3_reg2, round_lshift_f16_3_reg2 ^ !sticky_f16_3_reg2, round_lshift_f16_3_reg2)
  val guard_f64 = Mux(
    adder_is_negative_f64_reg2,
    guard_lshift_f64_reg2 ^ (!sticky_f64_reg2 & round_lshift_f64_reg2),
    guard_lshift_f64_reg2
  )
  val guard_f32_0 = Mux(
    adder_is_negative_f32_0_reg2,
    guard_lshift_f32_0_reg2 ^ (!sticky_f32_0_reg2 & round_lshift_f32_0_reg2),
    guard_lshift_f32_0_reg2
  )
  val guard_f32_1 = Mux(
    adder_is_negative_f32_1_reg2,
    guard_lshift_f32_1_reg2 ^ (!sticky_f32_1_reg2 & round_lshift_f32_1_Reg2),
    guard_lshift_f32_1_reg2
  )
  val guard_f16_0 = Mux(
    adder_is_negative_f16_0_reg2,
    guard_lshift_f16_0_reg2 ^ (!sticky_f16_0_reg2 & round_lshift_f16_0_reg2),
    guard_lshift_f16_0_reg2
  )
  val guard_f16_1 = Mux(
    adder_is_negative_f16_1_reg2,
    guard_lshift_f16_1_reg2 ^ (!sticky_f16_1_reg2 & round_lshift_f16_1_reg2),
    guard_lshift_f16_1_reg2
  )
  val guard_f16_2 = Mux(
    adder_is_negative_f16_2_reg2,
    guard_lshift_f16_2_reg2 ^ (!sticky_f16_2_reg2 & round_lshift_f16_2_reg2),
    guard_lshift_f16_2_reg2
  )
  val guard_f16_3 = Mux(
    adder_is_negative_f16_3_reg2,
    guard_lshift_f16_3_reg2 ^ (!sticky_f16_3_reg2 & round_lshift_f16_3_reg2),
  ...
  val round_lshift_uf_f64_reg2 = RegNext(lshift_adder_inv_fix_f64.tail(significandWidth + 2).head(1))
  val round_lshift_uf_f32_0_reg2 = RegNext(lshift_adder_inv_fix_f32_0.tail(24 + 2).head(1))
  val round_lshift_uf_f32_1_reg2 = RegNext(lshift_adder_inv_fix_f32_1.tail(24 + 2).head(1))
  val round_lshift_uf_f16_0_reg2 = RegNext(lshift_adder_inv_fix_f16_0.tail(11 + 2).head(1))
  val round_lshift_uf_f16_1_reg2 = RegNext(lshift_adder_inv_fix_f16_1.tail(11 + 2).head(1))
  val round_lshift_uf_f16_2_reg2 = RegNext(lshift_adder_inv_fix_f16_2.tail(11 + 2).head(1))
  val round_lshift_uf_f16_3_reg2 = RegNext(lshift_adder_inv_fix_f16_3.tail(11 + 2).head(1))
  val round_uf_f64 =
    Mux(adder_is_negative_f64_reg2, round_lshift_uf_f64_reg2 ^ !sticky_uf_f64_reg2, round_lshift_uf_f64_reg2)
  val round_uf_f32_0 =
    Mux(adder_is_negative_f32_0_reg2, round_lshift_uf_f32_0_reg2 ^ !sticky_uf_f32_0_reg2, round_lshift_uf_f32_0_reg2)
  val round_uf_f32_1 =
    Mux(adder_is_negative_f32_1_reg2, round_lshift_uf_f32_1_reg2 ^ !sticky_uf_f32_1_reg2, round_lshift_uf_f32_1_reg2)
  val round_uf_f16_0 =
    Mux(adder_is_negative_f16_0_reg2, round_lshift_uf_f16_0_reg2 ^ !sticky_uf_f16_0_reg2, round_lshift_uf_f16_0_reg2)
  val round_uf_f16_1 =
    Mux(adder_is_negative_f16_1_reg2, round_lshift_uf_f16_1_reg2 ^ !sticky_uf_f16_1_reg2, round_lshift_uf_f16_1_reg2)
  val round_uf_f16_2 =
    Mux(adder_is_negative_f16_2_reg2, round_lshift_uf_f16_2_reg2 ^ !sticky_uf_f16_2_reg2, round_lshift_uf_f16_2_reg2)
  val round_uf_f16_3 =
    Mux(adder_is_negative_f16_3_reg2, round_lshift_uf_f16_3_reg2 ^ !sticky_uf_f16_3_reg2, round_lshift_uf_f16_3_reg2)
  ...
  round_add1_f32_0 := RNE_reg2 & (guard_f32_0 & (fraction_result_no_round_f32_0_reg2(
    0
  ) | round_f32_0 | sticky_f32_0_reg2)) |
  ...
  round_add1_f32_1 := RNE_reg2 & (guard_f32_1 & (fraction_result_no_round_f32_1_reg2(
    0
  ...
  round_add1_f16_0 := RNE_reg2 & (guard_f16_0 & (fraction_result_no_round_f16_0_reg2(
    0
  ) | round_f16_0 | sticky_f16_0_reg2)) |
  ...
  round_add1_f16_1 := RNE_reg2 & (guard_f16_1 & (fraction_result_no_round_f16_1_reg2(
    0
  ) | round_f16_1 | sticky_f16_1_reg2)) |
  ...
  round_add1_f16_2 := RNE_reg2 & (guard_f16_2 & (fraction_result_no_round_f16_2_reg2(
    0
  ...
  round_add1_f16_3 := RNE_reg2 & (guard_f16_3 & (fraction_result_no_round_f16_3_reg2(
    0
  ...
  val exponent_result_add_value_f64 = Mux(
    exponent_add_1_f64 | RegNext(is_fix_f64),
    E_greater_f64_reg2 - RegNext(lshift_value_f64_reg1) + 1.U,
    E_greater_f64_reg2 - RegNext(lshift_value_f64_reg1)
  )
  val exponent_result_add_value_f32_0 = Mux(
    exponent_add_1_f32_0 | RegNext(is_fix_f32_0),
    E_greater_f32_0_reg2 - RegNext(lshift_value_f32_0_reg1) + 1.U,
    E_greater_f32_0_reg2 - RegNext(lshift_value_f32_0_reg1)
  )
  val exponent_result_add_value_f32_1 = Mux(
    exponent_add_1_f32_1 | RegNext(is_fix_f32_1),
    E_greater_f32_1_reg2 - RegNext(lshift_value_f32_1_reg1) + 1.U,
    E_greater_f32_1_reg2 - RegNext(lshift_value_f32_1_reg1)
  )
  val exponent_result_add_value_f16_0 = Mux(
    exponent_add_1_f16_0 | RegNext(is_fix_f16_0),
    E_greater_f16_0_reg2 - RegNext(lshift_value_f16_0_reg1) + 1.U,
    E_greater_f16_0_reg2 - RegNext(lshift_value_f16_0_reg1)
  )
  val exponent_result_add_value_f16_1 = Mux(
    exponent_add_1_f16_1 | RegNext(is_fix_f16_1),
    E_greater_f16_1_reg2 - RegNext(lshift_value_f16_1_reg1) + 1.U,
    E_greater_f16_1_reg2 - RegNext(lshift_value_f16_1_reg1)
  )
  val exponent_result_add_value_f16_2 = Mux(
    exponent_add_1_f16_2 | RegNext(is_fix_f16_2),
    E_greater_f16_2_reg2 - RegNext(lshift_value_f16_2_reg1) + 1.U,
    E_greater_f16_2_reg2 - RegNext(lshift_value_f16_2_reg1)
  )
  val exponent_result_add_value_f16_3 = Mux(
    exponent_add_1_f16_3 | RegNext(is_fix_f16_3),
    E_greater_f16_3_reg2 - RegNext(lshift_value_f16_3_reg1) + 1.U,
    E_greater_f16_3_reg2 - RegNext(lshift_value_f16_3_reg1)
  )
  val exponent_overflow_f64 = exponent_result_add_value_f64.head(1).asBool | exponent_result_add_value_f64.tail(1).andR
  val exponent_overflow_f32_0 =
    exponent_result_add_value_f32_0.head(1).asBool | exponent_result_add_value_f32_0.tail(1).andR
  val exponent_overflow_f32_1 =
    exponent_result_add_value_f32_1.head(1).asBool | exponent_result_add_value_f32_1.tail(1).andR
  val exponent_overflow_f16_0 =
    exponent_result_add_value_f16_0.head(1).asBool | exponent_result_add_value_f16_0.tail(1).andR
  val exponent_overflow_f16_1 =
    exponent_result_add_value_f16_1.head(1).asBool | exponent_result_add_value_f16_1.tail(1).andR
  val exponent_overflow_f16_2 =
    exponent_result_add_value_f16_2.head(1).asBool | exponent_result_add_value_f16_2.tail(1).andR
  val exponent_overflow_f16_3 =
    exponent_result_add_value_f16_3.head(1).asBool | exponent_result_add_value_f16_3.tail(1).andR
  val exponent_is_min_f64 = RegNext(!lshift_adder_inv_fix_f64.head(1).asBool & lshift_mask_valid_f64_reg1 & !is_fix_f64)
  val exponent_is_min_f32_0 = RegNext(
    !lshift_adder_inv_fix_f32_0.head(1).asBool & lshift_mask_valid_f32_0_reg1 & !is_fix_f32_0
  )
  val exponent_is_min_f32_1 = RegNext(
    !lshift_adder_inv_fix_f32_1.head(1).asBool & lshift_mask_valid_f32_1_reg1 & !is_fix_f32_1
  )
  val exponent_is_min_f16_0 = RegNext(
    !lshift_adder_inv_fix_f16_0.head(1).asBool & lshift_mask_valid_f16_0_reg1 & !is_fix_f16_0
  )
  val exponent_is_min_f16_1 = RegNext(
    !lshift_adder_inv_fix_f16_1.head(1).asBool & lshift_mask_valid_f16_1_reg1 & !is_fix_f16_1
  )
  val exponent_is_min_f16_2 = RegNext(
    !lshift_adder_inv_fix_f16_2.head(1).asBool & lshift_mask_valid_f16_2_reg1 & !is_fix_f16_2
  )
  val exponent_is_min_f16_3 = RegNext(
    !lshift_adder_inv_fix_f16_3.head(1).asBool & lshift_mask_valid_f16_3_reg1 & !is_fix_f16_3
  )
  val exponent_result_temp_f64 = Mux(
    exponent_is_min_f64,
    Cat(0.U((exponentWidth - 1).W), exponent_add_1_f64),
    exponent_result_add_value_f64(exponentWidth - 1, 0)
  )
  val exponent_result_temp_f32_0 =
    Mux(exponent_is_min_f32_0, Cat(0.U((5 - 1).W), exponent_add_1_f32_0), exponent_result_add_value_f32_0(8 - 1, 0))
  val exponent_result_temp_f32_1 =
    Mux(exponent_is_min_f32_1, Cat(0.U((5 - 1).W), exponent_add_1_f32_1), exponent_result_add_value_f32_1(8 - 1, 0))
  val exponent_result_temp_f16_0 =
    Mux(exponent_is_min_f16_0, Cat(0.U((5 - 1).W), exponent_add_1_f16_0), exponent_result_add_value_f16_0(5 - 1, 0))
  val exponent_result_temp_f16_1 =
    Mux(exponent_is_min_f16_1, Cat(0.U((5 - 1).W), exponent_add_1_f16_1), exponent_result_add_value_f16_1(5 - 1, 0))
  val exponent_result_temp_f16_2 =
    Mux(exponent_is_min_f16_2, Cat(0.U((5 - 1).W), exponent_add_1_f16_2), exponent_result_add_value_f16_2(5 - 1, 0))
  val exponent_result_temp_f16_3 =
    Mux(exponent_is_min_f16_3, Cat(0.U((5 - 1).W), exponent_add_1_f16_3), exponent_result_add_value_f16_3(5 - 1, 0))
  val fraction_result_temp_f64 =
    Mux(round_add1_f64.asBool, fraction_result_round_f64.tail(1), fraction_result_no_round_f64_reg2)
  val fraction_result_temp_f32_0 =
    Mux(round_add1_f32_0.asBool, fraction_result_round_f32_0.tail(1), fraction_result_no_round_f32_0_reg2)
  val fraction_result_temp_f32_1 =
    Mux(round_add1_f32_1.asBool, fraction_result_round_f32_1.tail(1), fraction_result_no_round_f32_1_reg2)
  val fraction_result_temp_f16_0 =
    Mux(round_add1_f16_0.asBool, fraction_result_round_f16_0.tail(1), fraction_result_no_round_f16_0_reg2)
  val fraction_result_temp_f16_1 =
    Mux(round_add1_f16_1.asBool, fraction_result_round_f16_1.tail(1), fraction_result_no_round_f16_1_reg2)
  val fraction_result_temp_f16_2 =
    Mux(round_add1_f16_2.asBool, fraction_result_round_f16_2.tail(1), fraction_result_no_round_f16_2_reg2)
  val fraction_result_temp_f16_3 =
    Mux(round_add1_f16_3.asBool, fraction_result_round_f16_3.tail(1), fraction_result_no_round_f16_3_reg2)
  ...
  val fp_a_is_zero_f64 = !fp_a_significand_f64.orR
  val fp_a_is_zero_f32_0 = !fp_a_significand_f32_0.orR
  val fp_a_is_zero_f32_1 = !fp_a_significand_f32_1.orR
  val fp_a_is_zero_f16_0 = !fp_a_significand_f16_0.orR
  val fp_a_is_zero_f16_1 = !fp_a_significand_f16_1.orR
  val fp_a_is_zero_f16_2 = !fp_a_significand_f16_2.orR
  val fp_a_is_zero_f16_3 = !fp_a_significand_f16_3.orR
  val fp_b_is_zero_f64 = !fp_b_significand_f64.orR
  val fp_b_is_zero_f32_0 = !fp_b_significand_f32_0.orR
  val fp_b_is_zero_f32_1 = !fp_b_significand_f32_1.orR
  val fp_b_is_zero_f16_0 = !fp_b_significand_f16_0.orR
  val fp_b_is_zero_f16_1 = !fp_b_significand_f16_1.orR
  val fp_b_is_zero_f16_2 = !fp_b_significand_f16_2.orR
  val fp_b_is_zero_f16_3 = !fp_b_significand_f16_3.orR
  val fp_c_is_zero_f64 = !fp_c_significand_f64.orR
  val fp_c_is_zero_f32_0 = !fp_c_significand_f32_0.orR
  val fp_c_is_zero_f32_1 = !fp_c_significand_f32_1.orR
  val fp_c_is_zero_f16_0 = !fp_c_significand_f16_0.orR
  val fp_c_is_zero_f16_1 = !fp_c_significand_f16_1.orR
  val fp_c_is_zero_f16_2 = !fp_c_significand_f16_2.orR
  val fp_c_is_zero_f16_3 = !fp_c_significand_f16_3.orR

  val normal_result_is_zero_f64_reg2 = ShiftRegister(!adder_f64.orR, 2)
  val normal_result_is_zero_f32_0_reg2 = ShiftRegister(!adder_f32_0.orR, 2)
  val normal_result_is_zero_f32_1_reg2 = ShiftRegister(!adder_f32_1.orR, 2)
  val normal_result_is_zero_f16_0_reg2 = ShiftRegister(!adder_f16_0.orR, 2)
  val normal_result_is_zero_f16_1_reg2 = ShiftRegister(!adder_f16_1.orR, 2)
  val normal_result_is_zero_f16_2_reg2 = ShiftRegister(!adder_f16_2.orR, 2)
  val normal_result_is_zero_f16_3_reg2 = ShiftRegister(!adder_f16_3.orR, 2)
  val has_zero_f64_reg2 =
    ShiftRegister(fp_a_is_zero_f64 | fp_b_is_zero_f64 | fp_c_is_zero_f64, 3) | normal_result_is_zero_f64_reg2
  val has_zero_f32_0_reg2 =
    ShiftRegister(fp_a_is_zero_f32_0 | fp_b_is_zero_f32_0 | fp_c_is_zero_f32_0, 3) | normal_result_is_zero_f32_0_reg2
  val has_zero_f32_1_reg2 =
    ShiftRegister(fp_a_is_zero_f32_1 | fp_b_is_zero_f32_1 | fp_c_is_zero_f32_1, 3) | normal_result_is_zero_f32_1_reg2
  val has_zero_f16_0_reg2 =
    ShiftRegister(fp_a_is_zero_f16_0 | fp_b_is_zero_f16_0 | fp_c_is_zero_f16_0, 3) | normal_result_is_zero_f16_0_reg2
  val has_zero_f16_1_reg2 =
    ShiftRegister(fp_a_is_zero_f16_1 | fp_b_is_zero_f16_1 | fp_c_is_zero_f16_1, 3) | normal_result_is_zero_f16_1_reg2
  val has_zero_f16_2_reg2 =
    ShiftRegister(fp_a_is_zero_f16_2 | fp_b_is_zero_f16_2 | fp_c_is_zero_f16_2, 3) | normal_result_is_zero_f16_2_reg2
  val has_zero_f16_3_reg2 =
    ShiftRegister(fp_a_is_zero_f16_3 | fp_b_is_zero_f16_3 | fp_c_is_zero_f16_3, 3) | normal_result_is_zero_f16_3_reg2
  ...
  val result_overflow_down_f64 =
    Cat(sign_result_temp_f64_reg2, Fill(exponentWidth - 1, 1.U), 0.U, Fill(significandWidth - 1, 1.U))
  ...
  val fp_a_is_nan_f64 = io.fp_aIsFpCanonicalNAN | Mux(
    io.res_widening & is_fp64,
    widen_Ea_f32_0.andR,
    Ea_f64.andR
  ) & fp_a_significand_f64.tail(1).orR
  val fp_a_is_nan_f32_0 = io.fp_aIsFpCanonicalNAN | Mux(
    io.res_widening & is_fp32,
    widen_Ea_f16_0.andR,
    Ea_f32_0.andR
  ) & fp_a_significand_f32_0.tail(1).orR
  val fp_a_is_nan_f32_1 = io.fp_aIsFpCanonicalNAN | Mux(
    io.res_widening & is_fp32,
    widen_Ea_f16_1.andR,
    Ea_f32_1.andR
  ) & fp_a_significand_f32_1.tail(1).orR
  ...
  val fp_b_is_nan_f64 = io.fp_bIsFpCanonicalNAN | Mux(
    io.res_widening & is_fp64,
    widen_Eb_f32_0.andR,
    Eb_f64.andR
  ) & fp_b_significand_f64.tail(1).orR
  val fp_b_is_nan_f32_0 = io.fp_bIsFpCanonicalNAN | Mux(
    io.res_widening & is_fp32,
    widen_Eb_f16_0.andR,
    Eb_f32_0.andR
  ) & fp_b_significand_f32_0.tail(1).orR
  val fp_b_is_nan_f32_1 = io.fp_bIsFpCanonicalNAN | Mux(
    io.res_widening & is_fp32,
    widen_Eb_f16_1.andR,
    Eb_f32_1.andR
  ) & fp_b_significand_f32_1.tail(1).orR
  ...
  val fp_a_is_snan_f64 = io.fp_aIsFpCanonicalNAN | Mux(
    io.res_widening & is_fp64,
    widen_Ea_f32_0.andR,
    Ea_f64.andR
  ) & !fp_a_significand_f64.tail(1).head(1) & fp_a_significand_f64.tail(2).orR
  val fp_a_is_snan_f32_0 = io.fp_aIsFpCanonicalNAN | Mux(
    io.res_widening & is_fp32,
    widen_Ea_f16_0.andR,
    Ea_f32_0.andR
  ) & !fp_a_significand_f32_0.tail(1).head(1) & fp_a_significand_f32_0.tail(2).orR
  val fp_a_is_snan_f32_1 = io.fp_aIsFpCanonicalNAN | Mux(
    io.res_widening & is_fp32,
    widen_Ea_f16_1.andR,
    Ea_f32_1.andR
  ) & !fp_a_significand_f32_1.tail(1).head(1) & fp_a_significand_f32_1.tail(2).orR
  val fp_a_is_snan_f16_0 =
    io.fp_aIsFpCanonicalNAN | Ea_f16_0.andR & !fp_a_significand_f16_0.tail(1).head(1) & fp_a_significand_f16_0
      .tail(2)
      .orR
  val fp_a_is_snan_f16_1 =
    io.fp_aIsFpCanonicalNAN | Ea_f16_1.andR & !fp_a_significand_f16_1.tail(1).head(1) & fp_a_significand_f16_1
      .tail(2)
      .orR
  val fp_a_is_snan_f16_2 =
    io.fp_aIsFpCanonicalNAN | Ea_f16_2.andR & !fp_a_significand_f16_2.tail(1).head(1) & fp_a_significand_f16_2
      .tail(2)
      .orR
  val fp_a_is_snan_f16_3 =
    io.fp_aIsFpCanonicalNAN | Ea_f16_3.andR & !fp_a_significand_f16_3.tail(1).head(1) & fp_a_significand_f16_3
      .tail(2)
      .orR
  val fp_b_is_snan_f64 = io.fp_bIsFpCanonicalNAN | Mux(
    io.res_widening & is_fp64,
    widen_Eb_f32_0.andR,
    Eb_f64.andR
  ) & !fp_b_significand_f64.tail(1).head(1) & fp_b_significand_f64.tail(2).orR
  val fp_b_is_snan_f32_0 = io.fp_bIsFpCanonicalNAN | Mux(
    io.res_widening & is_fp32,
    widen_Eb_f16_0.andR,
    Eb_f32_0.andR
  ) & !fp_b_significand_f32_0.tail(1).head(1) & fp_b_significand_f32_0.tail(2).orR
  val fp_b_is_snan_f32_1 = io.fp_bIsFpCanonicalNAN | Mux(
    io.res_widening & is_fp32,
    widen_Eb_f16_1.andR,
    Eb_f32_1.andR
  ) & !fp_b_significand_f32_1.tail(1).head(1) & fp_b_significand_f32_1.tail(2).orR
  val fp_b_is_snan_f16_0 =
    io.fp_bIsFpCanonicalNAN | Eb_f16_0.andR & !fp_b_significand_f16_0.tail(1).head(1) & fp_b_significand_f16_0
      .tail(2)
      .orR
  val fp_b_is_snan_f16_1 =
    io.fp_bIsFpCanonicalNAN | Eb_f16_1.andR & !fp_b_significand_f16_1.tail(1).head(1) & fp_b_significand_f16_1
      .tail(2)
      .orR
  val fp_b_is_snan_f16_2 =
    io.fp_bIsFpCanonicalNAN | Eb_f16_2.andR & !fp_b_significand_f16_2.tail(1).head(1) & fp_b_significand_f16_2
      .tail(2)
      .orR
  val fp_b_is_snan_f16_3 =
    io.fp_bIsFpCanonicalNAN | Eb_f16_3.andR & !fp_b_significand_f16_3.tail(1).head(1) & fp_b_significand_f16_3
      .tail(2)
      .orR
  val fp_c_is_snan_f64 =
    io.fp_cIsFpCanonicalNAN | Ec_f64.andR & !fp_c_significand_f64.tail(1).head(1) & fp_c_significand_f64.tail(2).orR
  val fp_c_is_snan_f32_0 =
    io.fp_cIsFpCanonicalNAN | Ec_f32_0.andR & !fp_c_significand_f32_0.tail(1).head(1) & fp_c_significand_f32_0
      .tail(2)
      .orR
  val fp_c_is_snan_f32_1 =
    io.fp_cIsFpCanonicalNAN | Ec_f32_1.andR & !fp_c_significand_f32_1.tail(1).head(1) & fp_c_significand_f32_1
      .tail(2)
      .orR
  val fp_c_is_snan_f16_0 =
    io.fp_cIsFpCanonicalNAN | Ec_f16_0.andR & !fp_c_significand_f16_0.tail(1).head(1) & fp_c_significand_f16_0
      .tail(2)
      .orR
  val fp_c_is_snan_f16_1 =
    io.fp_cIsFpCanonicalNAN | Ec_f16_1.andR & !fp_c_significand_f16_1.tail(1).head(1) & fp_c_significand_f16_1
      .tail(2)
      .orR
  val fp_c_is_snan_f16_2 =
    io.fp_cIsFpCanonicalNAN | Ec_f16_2.andR & !fp_c_significand_f16_2.tail(1).head(1) & fp_c_significand_f16_2
      .tail(2)
      .orR
  val fp_c_is_snan_f16_3 =
    io.fp_cIsFpCanonicalNAN | Ec_f16_3.andR & !fp_c_significand_f16_3.tail(1).head(1) & fp_c_significand_f16_3
      .tail(2)
      .orR
  ...
  val fp_a_is_inf_f64 =
    Mux(io.res_widening & is_fp64, widen_Ea_f32_0.andR, Ea_f64.andR) & !fp_a_significand_f64.tail(1).orR
  val fp_a_is_inf_f32_0 =
    Mux(io.res_widening & is_fp32, widen_Ea_f16_0.andR, Ea_f32_0.andR) & !fp_a_significand_f32_0.tail(1).orR
  val fp_a_is_inf_f32_1 =
    Mux(io.res_widening & is_fp32, widen_Ea_f16_1.andR, Ea_f32_1.andR) & !fp_a_significand_f32_1.tail(1).orR
  val fp_a_is_inf_f16_0 = Ea_f16_0.andR & !fp_a_significand_f16_0.tail(1).orR
  val fp_a_is_inf_f16_1 = Ea_f16_1.andR & !fp_a_significand_f16_1.tail(1).orR
  val fp_a_is_inf_f16_2 = Ea_f16_2.andR & !fp_a_significand_f16_2.tail(1).orR
  val fp_a_is_inf_f16_3 = Ea_f16_3.andR & !fp_a_significand_f16_3.tail(1).orR
  val fp_b_is_inf_f64 =
    Mux(io.res_widening & is_fp64, widen_Eb_f32_0.andR, Eb_f64.andR) & !fp_b_significand_f64.tail(1).orR
  val fp_b_is_inf_f32_0 =
    Mux(io.res_widening & is_fp32, widen_Eb_f16_0.andR, Eb_f32_0.andR) & !fp_b_significand_f32_0.tail(1).orR
  val fp_b_is_inf_f32_1 =
    Mux(io.res_widening & is_fp32, widen_Eb_f16_1.andR, Eb_f32_1.andR) & !fp_b_significand_f32_1.tail(1).orR
  val fp_b_is_inf_f16_0 = Eb_f16_0.andR & !fp_b_significand_f16_0.tail(1).orR
  val fp_b_is_inf_f16_1 = Eb_f16_1.andR & !fp_b_significand_f16_1.tail(1).orR
  val fp_b_is_inf_f16_2 = Eb_f16_2.andR & !fp_b_significand_f16_2.tail(1).orR
  val fp_b_is_inf_f16_3 = Eb_f16_3.andR & !fp_b_significand_f16_3.tail(1).orR
  val fp_c_is_inf_f64 = Ec_f64.andR & !fp_c_significand_f64.tail(1).orR
  val fp_c_is_inf_f32_0 = Ec_f32_0.andR & !fp_c_significand_f32_0.tail(1).orR
  val fp_c_is_inf_f32_1 = Ec_f32_1.andR & !fp_c_significand_f32_1.tail(1).orR
  val fp_c_is_inf_f16_0 = Ec_f16_0.andR & !fp_c_significand_f16_0.tail(1).orR
  val fp_c_is_inf_f16_1 = Ec_f16_1.andR & !fp_c_significand_f16_1.tail(1).orR
  val fp_c_is_inf_f16_2 = Ec_f16_2.andR & !fp_c_significand_f16_2.tail(1).orR
  val fp_c_is_inf_f16_3 = Ec_f16_3.andR & !fp_c_significand_f16_3.tail(1).orR
  ...
  val has_nan_f64_reg2 = ShiftRegister(has_nan_f64, 3)
  val has_nan_f64_is_NV_reg2 =
    ShiftRegister(has_snan_f64.asBool | (fp_a_is_inf_f64 & fp_b_is_zero_f64) | (fp_a_is_zero_f64 & fp_b_is_inf_f64), 3)
  val has_inf_f64_reg2 = ShiftRegister(has_inf_f64, 3)
  val has_inf_f64_is_NV_reg2 = ShiftRegister(
  ...
  val has_inf_f64_result_inf_sign_reg2 =
    ShiftRegister(Mux(fp_a_is_inf_f64 | fp_b_is_inf_f64, sign_a_b_f64, sign_c_f64), 3)
  val is_overflow_f64_down_reg2 =
    RTZ_reg2 | (RDN_reg2 & !sign_result_temp_f64_reg2.asBool) | (RUP_reg2 & sign_result_temp_f64_reg2.asBool)
  ...
  when(has_nan_f64_reg2) {
    ...
    fflags_f64 := Mux(
      ...
      0.U,
      Cat(NV_f64, DZ_f64, OF_f64, UF_f64, NX_f64)
    )
  }.otherwise {
    fp_result_f64 := normal_result_f64
  }

  val has_nan_f32_0_reg2 = ShiftRegister(has_nan_f32_0, 3)
  val has_nan_f32_0_is_NV_reg2 = ShiftRegister(
    has_snan_f32_0.asBool | (fp_a_is_inf_f32_0 & fp_b_is_zero_f32_0) | (fp_a_is_zero_f32_0 & fp_b_is_inf_f32_0),
    3
  )
  val has_inf_f32_0_reg2 = ShiftRegister(has_inf_f32_0, 3)
  val has_inf_f32_0_is_NV_reg2 = ShiftRegister(
  ...
  val has_inf_f32_0_result_inf_sign_reg2 =
    ShiftRegister(Mux(fp_a_is_inf_f32_0 | fp_b_is_inf_f32_0, sign_a_b_f32_0, sign_c_f32_0), 3)
  val is_overflow_f32_0_down_reg2 =
    RTZ_reg2 | (RDN_reg2 & !sign_result_temp_f32_0_reg2.asBool) | (RUP_reg2 & sign_result_temp_f32_0_reg2.asBool)
  ...
  when(has_nan_f32_0_reg2) {
    ...
    fp_result_f32_0 := Mux(
      ...
      result_nan_f32_0,
      Cat(has_inf_f32_0_result_inf_sign_reg2, result_inf_f32_0)
    )
    ...
    fflags_f32_0 := Mux(
      ...
      0.U,
      Cat(NV_f32_0, DZ_f32_0, OF_f32_0, UF_f32_0, NX_f32_0)
    )
  }.otherwise {
    fp_result_f32_0 := normal_result_f32_0
  }
  val has_nan_f32_1_reg2 = ShiftRegister(has_nan_f32_1, 3)
  val has_nan_f32_1_is_NV_reg2 = ShiftRegister(
    has_snan_f32_1.asBool | (fp_a_is_inf_f32_1 & fp_b_is_zero_f32_1) | (fp_a_is_zero_f32_1 & fp_b_is_inf_f32_1),
    3
  )
  val has_inf_f32_1_reg2 = ShiftRegister(has_inf_f32_1, 3)
  val has_inf_f32_1_is_NV_reg2 = ShiftRegister(
  ...
  val has_inf_f32_1_result_inf_sign_reg2 =
    ShiftRegister(Mux(fp_a_is_inf_f32_1 | fp_b_is_inf_f32_1, sign_a_b_f32_1, sign_c_f32_1), 3)
  val is_overflow_f32_1_down_reg2 =
    RTZ_reg2 | (RDN_reg2 & !sign_result_temp_f32_1_reg2.asBool) | (RUP_reg2 & sign_result_temp_f32_1_reg2.asBool)
  ...
  when(has_nan_f32_1_reg2) {
    ...
    fp_result_f32_1 := Mux(
      ...
      result_nan_f32_1,
      Cat(has_inf_f32_1_result_inf_sign_reg2, result_inf_f32_1)
    )
    ...
    fflags_f32_1 := Mux(
      ...
      0.U,
      Cat(NV_f32_1, DZ_f32_1, OF_f32_1, UF_f32_1, NX_f32_1)
    )
  }.otherwise {
    fp_result_f32_1 := normal_result_f32_1
  }
  val has_nan_f16_0_reg2 = ShiftRegister(has_nan_f16_0, 3)
  val has_nan_f16_0_is_NV_reg2 = ShiftRegister(
    has_snan_f16_0.asBool | (fp_a_is_inf_f16_0 & fp_b_is_zero_f16_0) | (fp_a_is_zero_f16_0 & fp_b_is_inf_f16_0),
    3
  )
  val has_inf_f16_0_reg2 = ShiftRegister(has_inf_f16_0, 3)
  val has_inf_f16_0_is_NV_reg2 = ShiftRegister(
  ...
  val has_inf_f16_0_result_inf_sign_reg2 =
    ShiftRegister(Mux(fp_a_is_inf_f16_0 | fp_b_is_inf_f16_0, sign_a_b_f16_0, sign_c_f16_0), 3)
  val is_overflow_f16_0_down_reg2 =
    RTZ_reg2 | (RDN_reg2 & !sign_result_temp_f16_0_reg2.asBool) | (RUP_reg2 & sign_result_temp_f16_0_reg2.asBool)
  ...
  when(has_nan_f16_0_reg2) {
    ...
    fp_result_f16_0 := Mux(
      ...
      result_nan_f16_0,
      Cat(has_inf_f16_0_result_inf_sign_reg2, result_inf_f16_0)
    )
    ...
    fflags_f16_0 := Mux(
      ...
      0.U,
      Cat(NV_f16_0, DZ_f16_0, OF_f16_0, UF_f16_0, NX_f16_0)
    )
  }.otherwise {
    fp_result_f16_0 := normal_result_f16_0
  }
  val has_nan_f16_1_reg2 = ShiftRegister(has_nan_f16_1, 3)
  val has_nan_f16_1_is_NV_reg2 = ShiftRegister(
    has_snan_f16_1.asBool | (fp_a_is_inf_f16_1 & fp_b_is_zero_f16_1) | (fp_a_is_zero_f16_1 & fp_b_is_inf_f16_1),
    3
  )
  val has_inf_f16_1_reg2 = ShiftRegister(has_inf_f16_1, 3)
  val has_inf_f16_1_is_NV_reg2 = ShiftRegister(
  ...
  val has_inf_f16_1_result_inf_sign_reg2 =
    ShiftRegister(Mux(fp_a_is_inf_f16_1 | fp_b_is_inf_f16_1, sign_a_b_f16_1, sign_c_f16_1), 3)
  val is_overflow_f16_1_down_reg2 =
    RTZ_reg2 | (RDN_reg2 & !sign_result_temp_f16_1_reg2.asBool) | (RUP_reg2 & sign_result_temp_f16_1_reg2.asBool)
  ...
  when(has_nan_f16_1_reg2) {
    ...
    fp_result_f16_1 := Mux(
      ...
      result_nan_f16_1,
      Cat(has_inf_f16_1_result_inf_sign_reg2, result_inf_f16_1)
    )
    ...
    fflags_f16_1 := Mux(
      ...
      0.U,
      Cat(NV_f16_1, DZ_f16_1, OF_f16_1, UF_f16_1, NX_f16_1)
    )
  }.otherwise {
    fp_result_f16_1 := normal_result_f16_1
  }
  val has_nan_f16_2_reg2 = ShiftRegister(has_nan_f16_2, 3)
  val has_nan_f16_2_is_NV_reg2 = ShiftRegister(
    has_snan_f16_2.asBool | (fp_a_is_inf_f16_2 & fp_b_is_zero_f16_2) | (fp_a_is_zero_f16_2 & fp_b_is_inf_f16_2),
    3
  )
  val has_inf_f16_2_reg2 = ShiftRegister(has_inf_f16_2, 3)
  val has_inf_f16_2_is_NV_reg2 = ShiftRegister(
  ...
  val has_inf_f16_2_result_inf_sign_reg2 =
    ShiftRegister(Mux(fp_a_is_inf_f16_2 | fp_b_is_inf_f16_2, sign_a_b_f16_2, sign_c_f16_2), 3)
  val is_overflow_f16_2_down_reg2 =
    RTZ_reg2 | (RDN_reg2 & !sign_result_temp_f16_2_reg2.asBool) | (RUP_reg2 & sign_result_temp_f16_2_reg2.asBool)
  ...
  when(has_nan_f16_2_reg2) {
    ...
    fp_result_f16_2 := Mux(
      ...
      result_nan_f16_2,
      Cat(has_inf_f16_2_result_inf_sign_reg2, result_inf_f16_2)
    )
    ...
    fflags_f16_2 := Mux(
      ...
      0.U,
      Cat(NV_f16_2, DZ_f16_2, OF_f16_2, UF_f16_2, NX_f16_2)
    )
  }.otherwise {
    fp_result_f16_2 := normal_result_f16_2
  }
  val has_nan_f16_3_reg2 = ShiftRegister(has_nan_f16_3, 3)
  val has_nan_f16_3_is_NV_reg2 = ShiftRegister(
    has_snan_f16_3.asBool | (fp_a_is_inf_f16_3 & fp_b_is_zero_f16_3) | (fp_a_is_zero_f16_3 & fp_b_is_inf_f16_3),
    3
  )
  val has_inf_f16_3_reg2 = ShiftRegister(has_inf_f16_3, 3)
  val has_inf_f16_3_is_NV_reg2 = ShiftRegister(
  ...
  val has_inf_f16_3_result_inf_sign_reg2 =
    ShiftRegister(Mux(fp_a_is_inf_f16_3 | fp_b_is_inf_f16_3, sign_a_b_f16_3, sign_c_f16_3), 3)
  val is_overflow_f16_3_down_reg2 =
    RTZ_reg2 | (RDN_reg2 & !sign_result_temp_f16_3_reg2.asBool) | (RUP_reg2 & sign_result_temp_f16_3_reg2.asBool)
  ...
  when(has_nan_f16_3_reg2) {
    ...
    fp_result_f16_3 := Mux(
      ...
      result_nan_f16_3,
      Cat(has_inf_f16_3_result_inf_sign_reg2, result_inf_f16_3)
    )
    ...
    fflags_f16_3 := Mux(
      ...
      0.U,
      Cat(NV_f16_3, DZ_f16_3, OF_f16_3, UF_f16_3, NX_f16_3)
    )
  }.otherwise {
...
private[vector] class BoothEncoderF64F32F16(
  width:                 Int = 53,
  ...
  for (i <- 0 until 6) {
    ...
    i match {
      ...
      case 5 =>
        if (is_addend_expand_1bit)
          addend_seq_f16(i) := Cat(1.U, pp_seq_f16(i), 0.U, sign_seq(i - 1), 0.U(tail_zero_width.W))
        else addend_seq_f16(i) := Cat(pp_seq_f16(i), 0.U, sign_seq(i - 1), 0.U((2 * (i - 1)).W))
      case _ =>
        addend_seq_f16(i) := Cat(
          1.U(head_first_one_width.W),
          ~sign_seq(i),
          pp_seq_f16(i),
          0.U,
          sign_seq(i - 1),
          0.U(tail_zero_width.W)
        )
    }
  ...
  for (i <- 7 until 13) {
    ...
    i match {
      ...
      case 11 =>
        addend_seq_f16(i) := Cat(1.U, ~sign_seq(i), pp_seq_f16(i), 0.U, sign_seq(i - 1), 0.U(tail_zero_width.W))
      case 12 =>
        if (is_addend_expand_1bit)
          addend_seq_f16(i) := Cat(1.U, pp_seq_f16(i), 0.U, sign_seq(i - 1), 0.U(tail_zero_width.W))
        else addend_seq_f16(i) := Cat(pp_seq_f16(i), 0.U, sign_seq(i - 1), 0.U((2 * (i - 1)).W))
  ...
  for (i <- 14 until 20) {
    ...
    i match {
      ...
      case 15 =>
        addend_seq_f16(i) := Cat(1.U(head_first_one_width.W), ~sign_seq(i), pp_seq_f16(i), 0.U, sign_seq(i - 1))
      case 18 =>
        addend_seq_f16(i) := Cat(1.U, ~sign_seq(i), pp_seq_f16(i), 0.U, sign_seq(i - 1), 0.U(tail_zero_width.W))
      case 19 =>
        if (is_addend_expand_1bit)
  ...
  for (i <- 0 until 13) {
    ...
    i match {
      ...
      case 11 =>
        addend_seq_f32(i) := Cat(1.U, ~sign_seq(i), pp_seq_f32(i), 0.U, sign_seq(i - 1), 0.U(tail_zero_width.W))
      case 12 => addend_seq_f32(i) := Cat(pp_seq_f32(i).tail(1), 0.U, sign_seq(i - 1), 0.U(tail_zero_width.W))
      case _ =>
        addend_seq_f32(i) := Cat(
          1.U(head_first_one_width.W),
          ~sign_seq(i),
          pp_seq_f32(i),
          0.U,
  ...
  for (i <- 14 until 27) {
    ...
    i match {
      ...
      case 15 =>
        addend_seq_f32(i) := Cat(1.U(head_first_one_width.W), ~sign_seq(i), pp_seq_f32(i), 0.U, sign_seq(i - 1))
      case 25 =>
        addend_seq_f32(i) := Cat(1.U, ~sign_seq(i), pp_seq_f32(i), 0.U, sign_seq(i - 1), 0.U(tail_zero_width.W))
  ...
  for (i <- 0 until outNum) {
    ...
    i match {
      ...
      case `outNumBeforeLast` =>
        if (width % 2 == 0) {
          if (is_addend_expand_1bit)
            addend_seq_f64(i) := Cat(1.U, ~sign_seq(i), pp_seq_f64(i), 0.U, sign_seq(i - 1), 0.U(tail_zero_width.W))
      ...
      case `outNumLast` =>
        ...
        else if (is_addend_expand_1bit)
          addend_seq_f64(i) := Cat(1.U, pp_seq_f64(i), 0.U, sign_seq(i - 1), 0.U(tail_zero_width.W))
        else addend_seq_f64(i) := Cat(pp_seq_f64(i), 0.U, sign_seq(i - 1), 0.U((2 * (i - 1)).W))
      case _ =>
        addend_seq_f64(i) := Cat(
          1.U(head_first_one_width.W),
          ~sign_seq(i),
          pp_seq_f64(i),
          0.U,
...
private[vector] class CSA_Nto2With3to2MainPipeline(n: Int, width: Int, pipeLevel: Int) extends Module {
  val io = IO(new Bundle() {
  ...
  while (CSA4to2Num != 0 || CSA3to2Num != 0) {
    ...
    for (i <- 0 until CSA4to2Num) {
      ...
      U_CSA4to2.io.in_a := (if (is_piped) RegNext(in(i * 4 + 0)) else in(i * 4 + 0))
      U_CSA4to2.io.in_b := (if (is_piped) RegNext(in(i * 4 + 1)) else in(i * 4 + 1))
      U_CSA4to2.io.in_c := (if (is_piped) RegNext(in(i * 4 + 2)) else in(i * 4 + 2))
      U_CSA4to2.io.in_d := (if (is_piped) RegNext(in(i * 4 + 3)) else in(i * 4 + 3))
    ...
    for (i <- 0 until CSA3to2Num) {
      ...
      U_CSA3to2.io.in_a := (if (is_piped) RegNext(in(i * 3 + 0)) else in(i * 3 + 0))
      U_CSA3to2.io.in_b := (if (is_piped) RegNext(in(i * 3 + 1)) else in(i * 3 + 1))
      U_CSA3to2.io.in_c := (if (is_piped) RegNext(in(i * 3 + 2)) else in(i * 3 + 2))
  ...
  io.out_sum := (if (pipeLevel > ceng) RegNext(in_next(0)) else in_next(0))
  io.out_car := (if (pipeLevel > ceng) RegNext(in_next(1)) else in_next(1))
