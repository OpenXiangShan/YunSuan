...
class VectorFloatFMA() extends Module{
  ...
  val fp_a_is_nan_f64   = Mux(io.res_widening & is_fp64,widen_Ea_f32_0.andR,Ea_f64.andR  ) & fp_a_significand_f64.tail(1).orR
  val fp_a_is_nan_f32_0 = Mux(io.res_widening & is_fp32,widen_Ea_f16_0.andR,Ea_f32_0.andR) & fp_a_significand_f32_0.tail(1).orR
  val fp_a_is_nan_f32_1 = Mux(io.res_widening & is_fp32,widen_Ea_f16_1.andR,Ea_f32_1.andR) & fp_a_significand_f32_1.tail(1).orR
  ...
  val fp_b_is_nan_f64   = Mux(io.res_widening & is_fp64,widen_Eb_f32_0.andR,Eb_f64.andR  ) & fp_b_significand_f64.tail(1).orR
  val fp_b_is_nan_f32_0 = Mux(io.res_widening & is_fp32,widen_Eb_f16_0.andR,Eb_f32_0.andR) & fp_b_significand_f32_0.tail(1).orR
  val fp_b_is_nan_f32_1 = Mux(io.res_widening & is_fp32,widen_Eb_f16_1.andR,Eb_f32_1.andR) & fp_b_significand_f32_1.tail(1).orR
  ...
  val fp_a_is_inf_f64   = Mux(io.res_widening & is_fp64,widen_Ea_f32_0.andR,Ea_f64.andR  ) & !fp_a_significand_f64.tail(1).orR
  val fp_a_is_inf_f32_0 = Mux(io.res_widening & is_fp32,widen_Ea_f16_0.andR,Ea_f32_0.andR) & !fp_a_significand_f32_0.tail(1).orR
  val fp_a_is_inf_f32_1 = Mux(io.res_widening & is_fp32,widen_Ea_f16_1.andR,Ea_f32_1.andR) & !fp_a_significand_f32_1.tail(1).orR
  ...
  val fp_b_is_inf_f64   = Mux(io.res_widening & is_fp64,widen_Eb_f32_0.andR,Eb_f64.andR  ) & !fp_b_significand_f64.tail(1).orR
  val fp_b_is_inf_f32_0 = Mux(io.res_widening & is_fp32,widen_Eb_f16_0.andR,Eb_f32_0.andR) & !fp_b_significand_f32_0.tail(1).orR
  val fp_b_is_inf_f32_1 = Mux(io.res_widening & is_fp32,widen_Eb_f16_1.andR,Eb_f32_1.andR) & !fp_b_significand_f32_1.tail(1).orR
