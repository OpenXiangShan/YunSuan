...
class VectorFloatDividerR64() extends Module {
  ...
  when(io.flush_i) {
    ...
    fsm_d := Mux(
      is_vec_q | res_is_denormal_f64_0,
      FSM_POST_1,
      Mux(!is_vec_q & io.finish_ready_i, FSM_PRE_0, FSM_POST_0)
    )
  ...
  val opa_is_zero_f64_0 = opa_exp_is_zero_f64_0 & opa_frac_is_zero_f64_0
  val opa_is_zero_f32_1 = opa_exp_is_zero_f32_1 & opa_frac_is_zero_f32_1
  val opa_is_zero_f16_2 = opa_exp_is_zero_f16_2 & opa_frac_is_zero_f16_2
  val opa_is_zero_f16_3 = opa_exp_is_zero_f16_3 & opa_frac_is_zero_f16_3
  val opb_is_zero_f64_0 = opb_exp_is_zero_f64_0 & opb_frac_is_zero_f64_0
  val opb_is_zero_f32_1 = opb_exp_is_zero_f32_1 & opb_frac_is_zero_f32_1
  val opb_is_zero_f16_2 = opb_exp_is_zero_f16_2 & opb_frac_is_zero_f16_2
  val opb_is_zero_f16_3 = opb_exp_is_zero_f16_3 & opb_frac_is_zero_f16_3
  val opa_is_inf_f64_0 = opa_exp_is_max_f64_0 & opa_frac_is_zero_f64_0
  val opa_is_inf_f32_1 = opa_exp_is_max_f32_1 & opa_frac_is_zero_f32_1
  val opa_is_inf_f16_2 = opa_exp_is_max_f16_2 & opa_frac_is_zero_f16_2
  val opa_is_inf_f16_3 = opa_exp_is_max_f16_3 & opa_frac_is_zero_f16_3
  val opb_is_inf_f64_0 = opb_exp_is_max_f64_0 & opb_frac_is_zero_f64_0
  ...
  val opa_is_snan_f64_0 =
    io.fp_aIsFpCanonicalNAN | opa_exp_is_max_f64_0 & !opa_frac_f64_0.head(1).asBool & !opa_frac_is_zero_f64_0
  val opa_is_snan_f32_1 =
    io.fp_aIsFpCanonicalNAN | opa_exp_is_max_f32_1 & !opa_frac_f32_1.head(1).asBool & !opa_frac_is_zero_f32_1
  val opa_is_snan_f16_2 =
    io.fp_aIsFpCanonicalNAN | opa_exp_is_max_f16_2 & !opa_frac_f16_2.head(1).asBool & !opa_frac_is_zero_f16_2
  val opa_is_snan_f16_3 =
    io.fp_aIsFpCanonicalNAN | opa_exp_is_max_f16_3 & !opa_frac_f16_3.head(1).asBool & !opa_frac_is_zero_f16_3
  val opb_is_snan_f64_0 =
    io.fp_bIsFpCanonicalNAN | opb_exp_is_max_f64_0 & !opb_frac_f64_0.head(1).asBool & !opb_frac_is_zero_f64_0
  val opb_is_snan_f32_1 =
    io.fp_bIsFpCanonicalNAN | opb_exp_is_max_f32_1 & !opb_frac_f32_1.head(1).asBool & !opb_frac_is_zero_f32_1
  val opb_is_snan_f16_2 =
    io.fp_bIsFpCanonicalNAN | opb_exp_is_max_f16_2 & !opb_frac_f16_2.head(1).asBool & !opb_frac_is_zero_f16_2
  val opb_is_snan_f16_3 =
    io.fp_bIsFpCanonicalNAN | opb_exp_is_max_f16_3 & !opb_frac_f16_3.head(1).asBool & !opb_frac_is_zero_f16_3
  ...
  val op_invalid_f64_0 =
    (opa_is_inf_f64_0 & opb_is_inf_f64_0) | (opa_is_zero_f64_0 & opb_is_zero_f64_0) | opa_is_snan_f64_0 | opb_is_snan_f64_0
  val op_invalid_f32_1 =
    (opa_is_inf_f32_1 & opb_is_inf_f32_1) | (opa_is_zero_f32_1 & opb_is_zero_f32_1) | opa_is_snan_f32_1 | opb_is_snan_f32_1
  val op_invalid_f16_2 =
    (opa_is_inf_f16_2 & opb_is_inf_f16_2) | (opa_is_zero_f16_2 & opb_is_zero_f16_2) | opa_is_snan_f16_2 | opb_is_snan_f16_2
  val op_invalid_f16_3 =
    (opa_is_inf_f16_3 & opb_is_inf_f16_3) | (opa_is_zero_f16_3 & opb_is_zero_f16_3) | opa_is_snan_f16_3 | opb_is_snan_f16_3
  ...
  val opa_exp_plus_biased_f64_0 = Cat(0.U(1.W), opa_exp_biased_f64_0(10, 0)) + Mux(
    fp_format_is_fp16,
    15.U(12.W),
    Mux(fp_format_is_fp32, 127.U(12.W), 1023.U(12.W))
  )
  val opa_exp_plus_biased_f32_1 =
    Cat(0.U(1.W), opa_exp_biased_f32_1(7, 0)) + Mux(fp_format_is_fp16, 15.U(7.W), 127.U(7.W))
  ...
  val U_Left_Shift_opa_f64_0 = Module(
    new ShiftLeftPriorityWithLZDResult(srcW = FP64_FRAC_W, priorityShiftValueW = FP64_FRAC_W)
  )
  ...
  val opa_frac_l_shifted_f64_0 =
    Cat(1.U(1.W), Mux(opa_exp_is_zero_f64_0, U_Left_Shift_opa_f64_0.io.lshift_result.tail(1), opa_frac_f64_0))
  val U_Left_Shift_opb_f64_0 = Module(
    new ShiftLeftPriorityWithLZDResult(srcW = FP64_FRAC_W, priorityShiftValueW = FP64_FRAC_W)
  )
  ...
  val opb_frac_l_shifted_f64_0 =
    Cat(1.U(1.W), Mux(opb_exp_is_zero_f64_0, U_Left_Shift_opb_f64_0.io.lshift_result.tail(1), opb_frac_f64_0))

  val opa_frac_pre_shifted_f32_1 = Cat(0.U(1.W), opa_frac_f32_1)
  val opb_frac_pre_shifted_f32_1 = Cat(0.U(1.W), opb_frac_f32_1)
  val U_Left_Shift_opa_f32_1 = Module(
    new ShiftLeftPriorityWithLZDResult(srcW = FP32_FRAC_W, priorityShiftValueW = FP32_FRAC_W)
  )
  ...
  val opa_frac_l_shifted_f32_1 =
    Cat(1.U(1.W), Mux(opa_exp_is_zero_f32_1, U_Left_Shift_opa_f32_1.io.lshift_result.tail(1), opa_frac_f32_1))
  val U_Left_Shift_opb_f32_1 = Module(
    new ShiftLeftPriorityWithLZDResult(srcW = FP32_FRAC_W, priorityShiftValueW = FP32_FRAC_W)
  )
  ...
  val opb_frac_l_shifted_f32_1 =
    Cat(1.U(1.W), Mux(opb_exp_is_zero_f32_1, U_Left_Shift_opb_f32_1.io.lshift_result.tail(1), opb_frac_f32_1))

  val opa_frac_pre_shifted_f16_2 = Cat(0.U(1.W), opa_frac_f16_2)
  val opb_frac_pre_shifted_f16_2 = Cat(0.U(1.W), opb_frac_f16_2)
  val U_Left_Shift_opa_f16_2 = Module(
    new ShiftLeftPriorityWithLZDResult(srcW = FP16_FRAC_W, priorityShiftValueW = FP16_FRAC_W)
  )
  ...
  val opa_frac_l_shifted_f16_2 =
    Cat(1.U(1.W), Mux(opa_exp_is_zero_f16_2, U_Left_Shift_opa_f16_2.io.lshift_result.tail(1), opa_frac_f16_2))
  val U_Left_Shift_opb_f16_2 = Module(
    new ShiftLeftPriorityWithLZDResult(srcW = FP16_FRAC_W, priorityShiftValueW = FP16_FRAC_W)
  )
  ...
  val opb_frac_l_shifted_f16_2 =
    Cat(1.U(1.W), Mux(opb_exp_is_zero_f16_2, U_Left_Shift_opb_f16_2.io.lshift_result.tail(1), opb_frac_f16_2))

  val opa_frac_pre_shifted_f16_3 = Cat(0.U(1.W), opa_frac_f16_3)
  val opb_frac_pre_shifted_f16_3 = Cat(0.U(1.W), opb_frac_f16_3)
  val U_Left_Shift_opa_f16_3 = Module(
    new ShiftLeftPriorityWithLZDResult(srcW = FP16_FRAC_W, priorityShiftValueW = FP16_FRAC_W)
  )
  ...
  val opa_frac_l_shifted_f16_3 =
    Cat(1.U(1.W), Mux(opa_exp_is_zero_f16_3, U_Left_Shift_opa_f16_3.io.lshift_result.tail(1), opa_frac_f16_3))
  val U_Left_Shift_opb_f16_3 = Module(
    new ShiftLeftPriorityWithLZDResult(srcW = FP16_FRAC_W, priorityShiftValueW = FP16_FRAC_W)
  )
  ...
  val opb_frac_l_shifted_f16_3 =
    Cat(1.U(1.W), Mux(opb_exp_is_zero_f16_3, U_Left_Shift_opb_f16_3.io.lshift_result.tail(1), opb_frac_f16_3))
  ...
  val frac_divisor_q_f32_1 =
    Mux(fp_format_q_is_fp32 & is_vec_q, frac_divisor_q_60bit.head(28), Cat(frac_divisor_q_60bit(29, 15), 0.U(13.W)))
  ...
  val f_r_s_iter_init_pre_f64_0 = Cat(
    0.U(3.W),
    Mux(a_frac_lt_b_frac_real_f64_0, Cat(scaled_a_frac_f64_0, 0.U(1.W)), Cat(0.U(1.W), scaled_a_frac_f64_0))
  )
  val f_r_s_iter_init_pre_f32_1 = Cat(
    0.U(3.W),
    Mux(a_frac_lt_b_frac_real_f32_1, Cat(scaled_a_frac_f32_1, 0.U(1.W)), Cat(0.U(1.W), scaled_a_frac_f32_1))
  )
  val f_r_s_iter_init_pre_f16_2 = Cat(
    0.U(3.W),
    Mux(a_frac_lt_b_frac_real_f16_2, Cat(scaled_a_frac_f16_2, 0.U(1.W)), Cat(0.U(1.W), scaled_a_frac_f16_2))
  )
  val f_r_s_iter_init_pre_f16_3 = Cat(
    0.U(3.W),
    Mux(a_frac_lt_b_frac_real_f16_3, Cat(scaled_a_frac_f16_3, 0.U(1.W)), Cat(0.U(1.W), scaled_a_frac_f16_3))
  )
  val f_r_s_for_integer_quo_f64_0 =
    f_r_s_iter_init_pre_f64_0((REM_W_f64_0 + 1) - 1 - 2 - 1, (REM_W_f64_0 + 1) - 1 - 2 - 1 - 4)
  val f_r_s_for_integer_quo_f32_1 =
    f_r_s_iter_init_pre_f32_1((REM_W_f32_1 + 1) - 1 - 2 - 1, (REM_W_f32_1 + 1) - 1 - 2 - 1 - 4)
  val f_r_s_for_integer_quo_f16_2 =
    f_r_s_iter_init_pre_f16_2((REM_W_f16_2 + 1) - 1 - 2 - 1, (REM_W_f16_2 + 1) - 1 - 2 - 1 - 4)
  val f_r_s_for_integer_quo_f16_3 =
    f_r_s_iter_init_pre_f16_3((REM_W_f16_3 + 1) - 1 - 2 - 1, (REM_W_f16_3 + 1) - 1 - 2 - 1 - 4)
  ...
  val f_r_c_iter_init_f64_0 =
    Mux(integer_quo_is_pos_2_f64_0, scaled_b_frac_ext_mul_neg_2_f64_0, scaled_b_frac_ext_mul_neg_1_f64_0)
  val f_r_c_iter_init_f32_1 =
    Mux(integer_quo_is_pos_2_f32_1, scaled_b_frac_ext_mul_neg_2_f32_1, scaled_b_frac_ext_mul_neg_1_f32_1)
  val f_r_c_iter_init_f16_2 =
    Mux(integer_quo_is_pos_2_f16_2, scaled_b_frac_ext_mul_neg_2_f16_2, scaled_b_frac_ext_mul_neg_1_f16_2)
  val f_r_c_iter_init_f16_3 =
    Mux(integer_quo_is_pos_2_f16_3, scaled_b_frac_ext_mul_neg_2_f16_3, scaled_b_frac_ext_mul_neg_1_f16_3)
    ...
    Mux1H(
      ...
      Seq(
        ...
        Cat(
          ...
          f_r_s_iter_init_f32_1.head(18),
          f_r_s_iter_init_f64_0.head(18)
        )
      )
    ),
    nxt_f_r_s_70bit(2)
    ...
    Mux1H(
      ...
      Seq(
        ...
        Cat(
          ...
          f_r_c_iter_init_f32_1.head(18),
          f_r_c_iter_init_f64_0.head(18)
        )
      )
    ),
    nxt_f_r_c_70bit(2)
  ...
  val nr_f_r_6b_for_nxt_cycle_s0_qds_d_f64_0 =
    Mux(fsm_q(FSM_PRE_2_BIT), adder_6b_iter_init_f64_0, adder_6b_res_for_nxt_cycle_s0_qds_f64_0)
  val nr_f_r_6b_for_nxt_cycle_s0_qds_d_f32_1 =
    Mux(fsm_q(FSM_PRE_2_BIT), adder_6b_iter_init_f32_1, adder_6b_res_for_nxt_cycle_s0_qds_f32_1)
  val nr_f_r_6b_for_nxt_cycle_s0_qds_d_f16_2 =
    Mux(fsm_q(FSM_PRE_2_BIT), adder_6b_iter_init_f16_2, adder_6b_res_for_nxt_cycle_s0_qds_f16_2)
  val nr_f_r_6b_for_nxt_cycle_s0_qds_d_f16_3 =
    Mux(fsm_q(FSM_PRE_2_BIT), adder_6b_iter_init_f16_3, adder_6b_res_for_nxt_cycle_s0_qds_f16_3)
  val nr_f_r_7b_for_nxt_cycle_s1_qds_en = start_handshaked | fsm_q(FSM_PRE_2_BIT) | fsm_q(FSM_ITER_BIT)

  val nr_f_r_7b_for_nxt_cycle_s1_qds_d_f64_0 =
    Mux(fsm_q(FSM_PRE_2_BIT), adder_7b_iter_init_f64_0, adder_7b_res_for_nxt_cycle_s1_qds_f64_0)
  val nr_f_r_7b_for_nxt_cycle_s1_qds_d_f32_1 =
    Mux(fsm_q(FSM_PRE_2_BIT), adder_7b_iter_init_f32_1, adder_7b_res_for_nxt_cycle_s1_qds_f32_1)
  val nr_f_r_7b_for_nxt_cycle_s1_qds_d_f16_2 =
    Mux(fsm_q(FSM_PRE_2_BIT), adder_7b_iter_init_f16_2, adder_7b_res_for_nxt_cycle_s1_qds_f16_2)
  val nr_f_r_7b_for_nxt_cycle_s1_qds_d_f16_3 =
    Mux(fsm_q(FSM_PRE_2_BIT), adder_7b_iter_init_f16_3, adder_7b_res_for_nxt_cycle_s1_qds_f16_3)
  ...
  when(frac_divisor_en) {
    ...
    val frac_divisor_q_f64_0_temp =
      Mux(fsm_q(FSM_POST_0_BIT) & !res_is_denormal_f64_0, frac_divisor_q_f64_0, frac_divisor_d_f64_0)
    val frac_divisor_q_f32_1_temp =
      Mux(fsm_q(FSM_POST_0_BIT) & !res_is_denormal_f32_1, frac_divisor_q_f32_1, frac_divisor_d_f32_1)
    val frac_divisor_q_f16_2_temp =
      Mux(fsm_q(FSM_POST_0_BIT) & !res_is_denormal_f16_2, frac_divisor_q_f16_2, frac_divisor_d_f16_2)
    val frac_divisor_q_f16_3_temp =
      Mux(fsm_q(FSM_POST_0_BIT) & !res_is_denormal_f16_3, frac_divisor_q_f16_3, frac_divisor_d_f16_3)
    ...
    frac_divisor_q_60bit := Mux(
      ...
      Mux(
        ...
        Cat(
          frac_divisor_q_f16_3_temp(14, 0),
          frac_divisor_q_f16_2_temp(14, 0),
  ...
  val prev_quo_dig_d_f64_0 = Mux(
    fsm_q(FSM_PRE_2_BIT),
    Cat(0.U(3.W), ~integer_quo_is_pos_2_f64_0, integer_quo_is_pos_2_f64_0),
    nxt_quo_dig_f64_0(2)
  )
  val prev_quo_dig_d_f32_1 = Mux(
    fsm_q(FSM_PRE_2_BIT),
    Cat(0.U(3.W), ~integer_quo_is_pos_2_f32_1, integer_quo_is_pos_2_f32_1),
    nxt_quo_dig_f32_1(2)
  )
  val prev_quo_dig_d_f16_2 = Mux(
    fsm_q(FSM_PRE_2_BIT),
    Cat(0.U(3.W), ~integer_quo_is_pos_2_f16_2, integer_quo_is_pos_2_f16_2),
    nxt_quo_dig_f16_2(2)
  )
  val prev_quo_dig_d_f16_3 = Mux(
    fsm_q(FSM_PRE_2_BIT),
    Cat(0.U(3.W), ~integer_quo_is_pos_2_f16_3, integer_quo_is_pos_2_f16_3),
    nxt_quo_dig_f16_3(2)
  )
  ...
  nxt_quo_iter_f64_0(1) :=
    (Fill(56, nxt_quo_dig_f64_0(0)(QUO_DIG_POS_2_BIT)) & Cat(nxt_quo_iter_f64_0(0)((56 - 1) - 2, 0), "b10".U(2.W))) |
      ...
      (Fill(56, nxt_quo_dig_f64_0(0)(QUO_DIG_NEG_1_BIT)) & Cat(
        nxt_quo_m1_iter_f64_0(0)((56 - 1) - 2, 0),
        "b11".U(2.W)
      )) |
  ...
  nxt_quo_iter_f32_1(1) :=
    (Fill(26, nxt_quo_dig_f32_1(0)(QUO_DIG_POS_2_BIT)) & Cat(nxt_quo_iter_f32_1(0)((26 - 1) - 2, 0), "b10".U(2.W))) |
      ...
      (Fill(26, nxt_quo_dig_f32_1(0)(QUO_DIG_NEG_1_BIT)) & Cat(
        nxt_quo_m1_iter_f32_1(0)((26 - 1) - 2, 0),
        "b11".U(2.W)
      )) |
  ...
  nxt_quo_iter_f16_2(1) :=
    (Fill(14, nxt_quo_dig_f16_2(0)(QUO_DIG_POS_2_BIT)) & Cat(nxt_quo_iter_f16_2(0)((14 - 1) - 2, 0), "b10".U(2.W))) |
      ...
      (Fill(14, nxt_quo_dig_f16_2(0)(QUO_DIG_NEG_1_BIT)) & Cat(
        nxt_quo_m1_iter_f16_2(0)((14 - 1) - 2, 0),
        "b11".U(2.W)
      )) |
  ...
  nxt_quo_iter_f16_3(1) :=
    (Fill(14, nxt_quo_dig_f16_3(0)(QUO_DIG_POS_2_BIT)) & Cat(nxt_quo_iter_f16_3(0)((14 - 1) - 2, 0), "b10".U(2.W))) |
      ...
      (Fill(14, nxt_quo_dig_f16_3(0)(QUO_DIG_NEG_1_BIT)) & Cat(
        nxt_quo_m1_iter_f16_3(0)((14 - 1) - 2, 0),
        "b11".U(2.W)
      )) |
  ...
  nxt_quo_m1_iter_f64_0(1) :=
    (Fill(56, nxt_quo_dig_f64_0(0)(QUO_DIG_POS_2_BIT)) & Cat(nxt_quo_iter_f64_0(0)((56 - 1) - 2, 0), "b01".U(2.W))) |
      ...
      (Fill(56, nxt_quo_dig_f64_0(0)(QUO_DIG_NEG_0_BIT)) & Cat(
        nxt_quo_m1_iter_f64_0(0)((56 - 1) - 2, 0),
        "b11".U(2.W)
      )) |
      (Fill(56, nxt_quo_dig_f64_0(0)(QUO_DIG_NEG_1_BIT)) & Cat(
  ...
  nxt_quo_m1_iter_f32_1(1) :=
    (Fill(26, nxt_quo_dig_f32_1(0)(QUO_DIG_POS_2_BIT)) & Cat(nxt_quo_iter_f32_1(0)((26 - 1) - 2, 0), "b01".U(2.W))) |
      ...
      (Fill(26, nxt_quo_dig_f32_1(0)(QUO_DIG_NEG_0_BIT)) & Cat(
        nxt_quo_m1_iter_f32_1(0)((26 - 1) - 2, 0),
        "b11".U(2.W)
      )) |
      (Fill(26, nxt_quo_dig_f32_1(0)(QUO_DIG_NEG_1_BIT)) & Cat(
  ...
  nxt_quo_m1_iter_f16_2(1) :=
    (Fill(14, nxt_quo_dig_f16_2(0)(QUO_DIG_POS_2_BIT)) & Cat(nxt_quo_iter_f16_2(0)((14 - 1) - 2, 0), "b01".U(2.W))) |
      ...
      (Fill(14, nxt_quo_dig_f16_2(0)(QUO_DIG_NEG_0_BIT)) & Cat(
        nxt_quo_m1_iter_f16_2(0)((14 - 1) - 2, 0),
        "b11".U(2.W)
      )) |
      (Fill(14, nxt_quo_dig_f16_2(0)(QUO_DIG_NEG_1_BIT)) & Cat(
  ...
  nxt_quo_m1_iter_f16_3(1) :=
    (Fill(14, nxt_quo_dig_f16_3(0)(QUO_DIG_POS_2_BIT)) & Cat(nxt_quo_iter_f16_3(0)((14 - 1) - 2, 0), "b01".U(2.W))) |
      ...
      (Fill(14, nxt_quo_dig_f16_3(0)(QUO_DIG_NEG_0_BIT)) & Cat(
        nxt_quo_m1_iter_f16_3(0)((14 - 1) - 2, 0),
        "b11".U(2.W)
      )) |
      (Fill(14, nxt_quo_dig_f16_3(0)(QUO_DIG_NEG_1_BIT)) & Cat(
  ...
  nxt_quo_iter_f64_0(2) :=
    (Fill(56, nxt_quo_dig_f64_0(1)(QUO_DIG_POS_2_BIT)) & Cat(nxt_quo_iter_f64_0(1)((56 - 1) - 2, 0), "b10".U(2.W))) |
      ...
      (Fill(56, nxt_quo_dig_f64_0(1)(QUO_DIG_NEG_1_BIT)) & Cat(
        nxt_quo_m1_iter_f64_0(1)((56 - 1) - 2, 0),
        "b11".U(2.W)
      )) |
  ...
  nxt_quo_iter_f32_1(2) :=
    (Fill(26, nxt_quo_dig_f32_1(1)(QUO_DIG_POS_2_BIT)) & Cat(nxt_quo_iter_f32_1(1)((26 - 1) - 2, 0), "b10".U(2.W))) |
      ...
      (Fill(26, nxt_quo_dig_f32_1(1)(QUO_DIG_NEG_1_BIT)) & Cat(
        nxt_quo_m1_iter_f32_1(1)((26 - 1) - 2, 0),
        "b11".U(2.W)
      )) |
  ...
  nxt_quo_iter_f16_2(2) :=
    (Fill(14, nxt_quo_dig_f16_2(1)(QUO_DIG_POS_2_BIT)) & Cat(nxt_quo_iter_f16_2(1)((14 - 1) - 2, 0), "b10".U(2.W))) |
      ...
      (Fill(14, nxt_quo_dig_f16_2(1)(QUO_DIG_NEG_1_BIT)) & Cat(
        nxt_quo_m1_iter_f16_2(1)((14 - 1) - 2, 0),
        "b11".U(2.W)
      )) |
  ...
  nxt_quo_iter_f16_3(2) :=
    (Fill(14, nxt_quo_dig_f16_3(1)(QUO_DIG_POS_2_BIT)) & Cat(nxt_quo_iter_f16_3(1)((14 - 1) - 2, 0), "b10".U(2.W))) |
      ...
      (Fill(14, nxt_quo_dig_f16_3(1)(QUO_DIG_NEG_1_BIT)) & Cat(
        nxt_quo_m1_iter_f16_3(1)((14 - 1) - 2, 0),
        "b11".U(2.W)
      )) |
  ...
  nxt_quo_m1_iter_f64_0(2) :=
    (Fill(56, nxt_quo_dig_f64_0(1)(QUO_DIG_POS_2_BIT)) & Cat(nxt_quo_iter_f64_0(1)((56 - 1) - 2, 0), "b01".U(2.W))) |
      ...
      (Fill(56, nxt_quo_dig_f64_0(1)(QUO_DIG_NEG_0_BIT)) & Cat(
        nxt_quo_m1_iter_f64_0(1)((56 - 1) - 2, 0),
        "b11".U(2.W)
      )) |
      (Fill(56, nxt_quo_dig_f64_0(1)(QUO_DIG_NEG_1_BIT)) & Cat(
  ...
  nxt_quo_m1_iter_f32_1(2) :=
    (Fill(26, nxt_quo_dig_f32_1(1)(QUO_DIG_POS_2_BIT)) & Cat(nxt_quo_iter_f32_1(1)((26 - 1) - 2, 0), "b01".U(2.W))) |
      ...
      (Fill(26, nxt_quo_dig_f32_1(1)(QUO_DIG_NEG_0_BIT)) & Cat(
        nxt_quo_m1_iter_f32_1(1)((26 - 1) - 2, 0),
        "b11".U(2.W)
      )) |
      (Fill(26, nxt_quo_dig_f32_1(1)(QUO_DIG_NEG_1_BIT)) & Cat(
  ...
  nxt_quo_m1_iter_f16_2(2) :=
    (Fill(14, nxt_quo_dig_f16_2(1)(QUO_DIG_POS_2_BIT)) & Cat(nxt_quo_iter_f16_2(1)((14 - 1) - 2, 0), "b01".U(2.W))) |
      ...
      (Fill(14, nxt_quo_dig_f16_2(1)(QUO_DIG_NEG_0_BIT)) & Cat(
        nxt_quo_m1_iter_f16_2(1)((14 - 1) - 2, 0),
        "b11".U(2.W)
      )) |
      (Fill(14, nxt_quo_dig_f16_2(1)(QUO_DIG_NEG_1_BIT)) & Cat(
  ...
  nxt_quo_m1_iter_f16_3(2) :=
    (Fill(14, nxt_quo_dig_f16_3(1)(QUO_DIG_POS_2_BIT)) & Cat(nxt_quo_iter_f16_3(1)((14 - 1) - 2, 0), "b01".U(2.W))) |
      ...
      (Fill(14, nxt_quo_dig_f16_3(1)(QUO_DIG_NEG_0_BIT)) & Cat(
        nxt_quo_m1_iter_f16_3(1)((14 - 1) - 2, 0),
        "b11".U(2.W)
      )) |
      (Fill(14, nxt_quo_dig_f16_3(1)(QUO_DIG_NEG_1_BIT)) & Cat(
  ...
  nxt_quo_iter_pre_0_f16_2 := Mux(
    opb_is_power_of_2_f16_2 & !(opa_exp_is_zero_f16_2 | opb_exp_is_zero_f16_2),
    Cat(1.U(2.W), opa(41, 32)),
    Cat(0.U(1.W), opa_frac_l_shifted_f16_2)
  )
  nxt_quo_iter_pre_0_f16_3 := Mux(
    opb_is_power_of_2_f16_3 & !(opa_exp_is_zero_f16_3 | opb_exp_is_zero_f16_3),
    Cat(1.U(2.W), opa(57, 48)),
    Cat(0.U(1.W), opa_frac_l_shifted_f16_3)
  )
  ...
  when(quo_iter_en) {
    quo_iter_q_f64_0 := Mux(
      start_handshaked,
      quo_iter_d_f64_0,
      Mux(!opb_is_power_of_2_q(0), quo_iter_d_f64_0, quo_iter_q_f64_0)
    )
    quo_iter_q_f32_1 := Mux(
      start_handshaked,
      quo_iter_d_f32_1,
      Mux(!opb_is_power_of_2_q(1), quo_iter_d_f32_1, quo_iter_q_f32_1)
    )
    quo_iter_q_f16_2 := Mux(
      start_handshaked,
      quo_iter_d_f16_2,
      Mux(!opb_is_power_of_2_q(2), quo_iter_d_f16_2, quo_iter_q_f16_2)
    )
    quo_iter_q_f16_3 := Mux(
      start_handshaked,
      quo_iter_d_f16_3,
      Mux(!opb_is_power_of_2_q(3), quo_iter_d_f16_3, quo_iter_q_f16_3)
    )
  }
  when(quo_m1_iter_en) {
  ...
  val iter_num_d =
    Mux(
      !is_vec_d & fsm_q(FSM_PRE_0_BIT),
      Cat(0.U(3.W), a_frac_lt_b_frac_f64_0),
      Mux(
        fsm_q(FSM_PRE_1_BIT),
        Cat(
        ...
        Mux(fsm_q(FSM_PRE_2_BIT), iter_num_needed, iter_num_q - 1.U(4.W))
      )
    )
  when(iter_num_en) {
  ...
  nxt_f_r_s_f64_0 := Mux(
    ...
    Mux(
      fp_format_q_is_fp32 & is_vec_q,
      Cat(
        u_r64_block_vector.io.nxt_f_r_s_o(2).tail(2 * REM_W_f16_2).head(REM_W_f32_1),
        0.U((REM_W_f64_0 - REM_W_f32_1).W),
        u_r64_block_vector.io.nxt_f_r_s_o(1).tail(2 * REM_W_f16_2).head(REM_W_f32_1),
        0.U((REM_W_f64_0 - REM_W_f32_1).W),
        u_r64_block_vector.io.nxt_f_r_s_o(0).tail(2 * REM_W_f16_2).head(REM_W_f32_1),
        0.U((REM_W_f64_0 - REM_W_f32_1).W)
      ),
      Cat(
        u_r64_block_vector.io.nxt_f_r_s_o(2).tail(3 * REM_W_f16_2).head(REM_W_f16_2),
        0.U((REM_W_f64_0 - REM_W_f16_2).W),
        u_r64_block_vector.io.nxt_f_r_s_o(1).tail(3 * REM_W_f16_2).head(REM_W_f16_2),
        0.U((REM_W_f64_0 - REM_W_f16_2).W),
        u_r64_block_vector.io.nxt_f_r_s_o(0).tail(3 * REM_W_f16_2).head(REM_W_f16_2),
        0.U((REM_W_f64_0 - REM_W_f16_2).W)
      )
    )
  ...
  nxt_f_r_s_f32_1 := Mux(
    ...
    Cat(
      u_r64_block_vector.io.nxt_f_r_s_o(2).tail(2 * REM_W_f16_2).head(REM_W_f16_2),
      0.U((REM_W_f32_1 - REM_W_f16_2).W),
      u_r64_block_vector.io.nxt_f_r_s_o(1).tail(2 * REM_W_f16_2).head(REM_W_f16_2),
      0.U((REM_W_f32_1 - REM_W_f16_2).W),
      u_r64_block_vector.io.nxt_f_r_s_o(0).tail(2 * REM_W_f16_2).head(REM_W_f16_2),
      0.U((REM_W_f32_1 - REM_W_f16_2).W)
    )
  ...
  nxt_f_r_c_f64_0 := Mux(
    ...
    Mux(
      fp_format_q_is_fp32 & is_vec_q,
      Cat(
        u_r64_block_vector.io.nxt_f_r_c_o(2).tail(2 * REM_W_f16_2).head(REM_W_f32_1),
        0.U((REM_W_f64_0 - REM_W_f32_1).W),
        u_r64_block_vector.io.nxt_f_r_c_o(1).tail(2 * REM_W_f16_2).head(REM_W_f32_1),
        0.U((REM_W_f64_0 - REM_W_f32_1).W),
        u_r64_block_vector.io.nxt_f_r_c_o(0).tail(2 * REM_W_f16_2).head(REM_W_f32_1),
        0.U((REM_W_f64_0 - REM_W_f32_1).W)
      ),
      Cat(
        u_r64_block_vector.io.nxt_f_r_c_o(2).tail(3 * REM_W_f16_2).head(REM_W_f16_2),
        0.U((REM_W_f64_0 - REM_W_f16_2).W),
        u_r64_block_vector.io.nxt_f_r_c_o(1).tail(3 * REM_W_f16_2).head(REM_W_f16_2),
        0.U((REM_W_f64_0 - REM_W_f16_2).W),
        u_r64_block_vector.io.nxt_f_r_c_o(0).tail(3 * REM_W_f16_2).head(REM_W_f16_2),
        0.U((REM_W_f64_0 - REM_W_f16_2).W)
      )
    )
  ...
  nxt_f_r_c_f32_1 := Mux(
    ...
    Cat(
      u_r64_block_vector.io.nxt_f_r_c_o(2).tail(2 * REM_W_f16_2).head(REM_W_f16_2),
      0.U((REM_W_f32_1 - REM_W_f16_2).W),
      u_r64_block_vector.io.nxt_f_r_c_o(1).tail(2 * REM_W_f16_2).head(REM_W_f16_2),
      0.U((REM_W_f32_1 - REM_W_f16_2).W),
      u_r64_block_vector.io.nxt_f_r_c_o(0).tail(2 * REM_W_f16_2).head(REM_W_f16_2),
      0.U((REM_W_f32_1 - REM_W_f16_2).W)
    )
  ...
  val quo_pre_shift_f64_0 =
    Mux(
      ...
      Cat(quo_iter_q_f64_0(52, 0), 0.U(1.W)),
      Cat(
        nxt_quo_iter_f64_0(0)(54, 26),
        Mux(fp_format_q_is_fp32, nxt_quo_iter_f64_0(0)(24, 0), nxt_quo_iter_f64_0(0)(25, 1))
      )
    )
  ...
  val quo_pre_shift_f16_2 =
    Mux(opb_is_power_of_2_q(2), Cat(0.U(1.W), quo_iter_q_f16_2(10, 0), 0.U(1.W)), nxt_quo_iter_f16_2(0)(13, 1))
  val quo_pre_shift_f16_3 =
    Mux(opb_is_power_of_2_q(3), Cat(0.U(1.W), quo_iter_q_f16_3(10, 0), 0.U(1.W)), nxt_quo_iter_f16_3(0)(13, 1))
  val quo_m1_pre_shift_f64_0 = Cat(
    nxt_quo_m1_iter_f64_0(0)(54, 26),
    Mux(fp_format_q_is_fp32, nxt_quo_m1_iter_f64_0(0)(24, 0), nxt_quo_m1_iter_f64_0(0)(25, 1))
  )
  val quo_m1_pre_shift_f32_1 =
    Mux(fp_format_q_is_fp32 & is_vec_q, nxt_quo_m1_iter_f32_1(0)(24, 0), nxt_quo_m1_iter_f32_1(0)(25, 1))
  ...
  val r_shift_num_f64_0 = Mux(
    r_shift_num_pre_f64_0(12),
    0.U(6.W),
    Mux(
  ...
  val r_shift_num_f32_1 = Mux(
    r_shift_num_pre_f32_1(9),
    0.U(5.W),
    Mux(
  ...
  val r_shift_num_f16_2 = Mux(
    r_shift_num_pre_f16_2(6),
    0.U(4.W),
    Mux(!r_shift_num_pre_minus_limit_f16_2(6), R_SHIFT_NUM_LIMIT_f16_2, r_shift_num_pre_f16_2(3, 0))
  )
  val r_shift_num_f16_3 = Mux(
    r_shift_num_pre_f16_3(6),
    0.U(4.W),
    Mux(!r_shift_num_pre_minus_limit_f16_3(6), R_SHIFT_NUM_LIMIT_f16_3, r_shift_num_pre_f16_3(3, 0))
  )
  ...
  val quo_m1_inc_res_f64_0 =
    Mux(quo_pre_inc_f64_0(0) === quo_m1_pre_inc_f64_0(0), quo_inc_res_f64_0(51, 0), quo_pre_inc_f64_0(51, 0))
  val quo_m1_inc_res_f32_1 =
    Mux(quo_pre_inc_f32_1(0) === quo_m1_pre_inc_f32_1(0), quo_inc_res_f32_1(22, 0), quo_pre_inc_f32_1(22, 0))
  val quo_m1_inc_res_f16_2 =
    Mux(quo_pre_inc_f16_2(0) === quo_m1_pre_inc_f16_2(0), quo_inc_res_f16_2(9, 0), quo_pre_inc_f16_2(9, 0))
  val quo_m1_inc_res_f16_3 =
    Mux(quo_pre_inc_f16_3(0) === quo_m1_pre_inc_f16_3(0), quo_inc_res_f16_3(9, 0), quo_pre_inc_f16_3(9, 0))

  val guard_bit_quo_f64_0 =
    Mux(fsm_q(FSM_POST_0_BIT) | !res_is_denormal_f64_0, quo_pre_shift_f64_0(1), quo_m1_iter_q_f64_0(1))
  val guard_bit_quo_f32_1 =
    Mux(fsm_q(FSM_POST_0_BIT) | !res_is_denormal_f32_1, quo_pre_shift_f32_1(1), quo_m1_iter_q_f32_1(1))
  val guard_bit_quo_f16_2 =
    Mux(fsm_q(FSM_POST_0_BIT) | !res_is_denormal_f16_2, quo_pre_shift_f16_2(1), quo_m1_iter_q_f16_2(1))
  val guard_bit_quo_f16_3 =
    Mux(fsm_q(FSM_POST_0_BIT) | !res_is_denormal_f16_3, quo_pre_shift_f16_3(1), quo_m1_iter_q_f16_3(1))
  val round_bit_quo_f64_0 =
    Mux(fsm_q(FSM_POST_0_BIT) | !res_is_denormal_f64_0, quo_pre_shift_f64_0(0), quo_m1_iter_q_f64_0(0))
  val round_bit_quo_f32_1 =
    Mux(fsm_q(FSM_POST_0_BIT) | !res_is_denormal_f32_1, quo_pre_shift_f32_1(0), quo_m1_iter_q_f32_1(0))
  val round_bit_quo_f16_2 =
    Mux(fsm_q(FSM_POST_0_BIT) | !res_is_denormal_f16_2, quo_pre_shift_f16_2(0), quo_m1_iter_q_f16_2(0))
  val round_bit_quo_f16_3 =
    Mux(fsm_q(FSM_POST_0_BIT) | !res_is_denormal_f16_3, quo_pre_shift_f16_3(0), quo_m1_iter_q_f16_3(0))
  val sticky_bit_quo_f64_0 = Mux(
    fsm_q(FSM_POST_0_BIT) | !res_is_denormal_f64_0,
    rem_is_not_zero_f64_0,
    quo_m1_iter_q_f64_0(53) | (frac_divisor_q_f64_0(56, 0) =/= 0.U(57.W))
  )
  val sticky_bit_quo_f32_1 = Mux(
    fsm_q(FSM_POST_0_BIT) | !res_is_denormal_f32_1,
    rem_is_not_zero_f32_1,
    quo_m1_iter_q_f32_1(24) | (frac_divisor_q_f32_1(24, 0) =/= 0.U(25.W))
  )

  val sticky_bit_quo_f16_2 = Mux(
    fsm_q(FSM_POST_0_BIT) | !res_is_denormal_f16_2,
    rem_is_not_zero_f16_2,
    quo_m1_iter_q_f16_2(11) | (frac_divisor_q_f16_2(14, 0) =/= 0.U(15.W))
  )
  val sticky_bit_quo_f16_3 = Mux(
    fsm_q(FSM_POST_0_BIT) | !res_is_denormal_f16_3,
    rem_is_not_zero_f16_3,
    quo_m1_iter_q_f16_3(11) | (frac_divisor_q_f16_3(14, 0) =/= 0.U(15.W))
  )
  ...
  val sticky_correct_f64_0 =
    Mux(select_quo_m1_f64_0, true.B, (sticky_without_rem_f64_0.tail(1) =/= 0.U) | rem_is_not_zero_f64_0)
  val sticky_correct_f32_1 =
    Mux(select_quo_m1_f32_1, true.B, (sticky_without_rem_f32_1.tail(1) =/= 0.U) | rem_is_not_zero_f32_1)
  val sticky_correct_f16_2 =
    Mux(select_quo_m1_f16_2, true.B, (sticky_without_rem_f16_2.tail(1) =/= 0.U) | rem_is_not_zero_f16_2)
  val sticky_correct_f16_3 =
    Mux(select_quo_m1_f16_3, true.B, (sticky_without_rem_f16_3.tail(1) =/= 0.U) | rem_is_not_zero_f16_3)
  ...
  val inexact_f64_0 =
    Mux(fsm_q(FSM_POST_0_BIT) | !res_is_denormal_f64_0, select_quo_m1_f64_0 | inexact_quo_f64_0, inexact_quo_f64_0)
  val inexact_f32_1 =
    Mux(fsm_q(FSM_POST_0_BIT) | !res_is_denormal_f32_1, select_quo_m1_f32_1 | inexact_quo_f32_1, inexact_quo_f32_1)
  val inexact_f16_2 =
    Mux(fsm_q(FSM_POST_0_BIT) | !res_is_denormal_f16_2, select_quo_m1_f16_2 | inexact_quo_f16_2, inexact_quo_f16_2)
  val inexact_f16_3 =
    Mux(fsm_q(FSM_POST_0_BIT) | !res_is_denormal_f16_3, select_quo_m1_f16_3 | inexact_quo_f16_3, inexact_quo_f16_3)
  ...
  val carry_after_round_f64_0 = Mux(
    fp_format_q_is_fp16,
    quo_rounded_f64_0(10),
    Mux(fp_format_q_is_fp32, quo_rounded_f64_0(23), quo_rounded_f64_0(52))
  )
  ...
  val overflow_f64_0 = out_exp_diff_q_f64_0(11, 0) >= Mux(
    fp_format_q_is_fp16,
    31.U(12.W),
    Mux(fp_format_q_is_fp32, 255.U(12.W), 2047.U(12.W))
  )
  ...
  val out_exp_post_0_f16_0 =
    Mux(
      ...
      Fill(5, 1.U(1.W)),
      Mux(overflow_f64_0 & ~overflow_to_inf_f64_0, Cat(Fill(4, 1.U(1.W)), 0.U(1.W)), out_exp_diff_q_f64_0(4, 0))
    )
  val out_exp_post_0_f16_1 =
    Mux(
      overflow_f32_1 & overflow_to_inf_f32_1,
      Fill(5, 1.U(1.W)),
      Mux(overflow_f32_1 & ~overflow_to_inf_f32_1, Cat(Fill(4, 1.U(1.W)), 0.U(1.W)), out_exp_diff_q_f32_1(4, 0))
    )
  val out_exp_post_0_f16_2 =
    Mux(
      overflow_f16_2 & overflow_to_inf_f16_2,
      Fill(5, 1.U(1.W)),
      Mux(overflow_f16_2 & ~overflow_to_inf_f16_2, Cat(Fill(4, 1.U(1.W)), 0.U(1.W)), out_exp_diff_q_f16_2(4, 0))
    )
  val out_exp_post_0_f16_3 =
    Mux(
      overflow_f16_3 & overflow_to_inf_f16_3,
      Fill(5, 1.U(1.W)),
      Mux(overflow_f16_3 & ~overflow_to_inf_f16_3, Cat(Fill(4, 1.U(1.W)), 0.U(1.W)), out_exp_diff_q_f16_3(4, 0))
    )
  val out_exp_post_0_f32_0 =
    Mux(
      overflow_f64_0 & overflow_to_inf_f64_0,
      Fill(8, 1.U(1.W)),
      Mux(overflow_f64_0 & ~overflow_to_inf_f64_0, Cat(Fill(7, 1.U(1.W)), 0.U(1.W)), out_exp_diff_q_f64_0(7, 0))
    )
  val out_exp_post_0_f32_1 =
    Mux(
      overflow_f32_1 & overflow_to_inf_f32_1,
      Fill(8, 1.U(1.W)),
      Mux(overflow_f32_1 & ~overflow_to_inf_f32_1, Cat(Fill(7, 1.U(1.W)), 0.U(1.W)), out_exp_diff_q_f32_1(7, 0))
    )
  val out_exp_post_0_f64_0 =
    Mux(
      overflow_f64_0 & overflow_to_inf_f64_0,
      Fill(11, 1.U(1.W)),
      Mux(overflow_f64_0 & ~overflow_to_inf_f64_0, Cat(Fill(10, 1.U(1.W)), 0.U(1.W)), out_exp_diff_q_f64_0(10, 0))
    )
  out_frac_post_0_f16_0 :=
    Mux(
      overflow_f64_0 & overflow_to_inf_f64_0,
      0.U(10.W),
      Mux(overflow_f64_0 & ~overflow_to_inf_f64_0, Fill(10, 1.U(1.W)), frac_rounded_post_0_f64_0(9, 0))
    )
  out_frac_post_0_f16_1 :=
    Mux(
      overflow_f32_1 & overflow_to_inf_f32_1,
      0.U(10.W),
      Mux(overflow_f32_1 & ~overflow_to_inf_f32_1, Fill(10, 1.U(1.W)), frac_rounded_post_0_f32_1(9, 0))
    )
  out_frac_post_0_f16_2 :=
    Mux(
      overflow_f16_2 & overflow_to_inf_f16_2,
      0.U(10.W),
      Mux(overflow_f16_2 & ~overflow_to_inf_f16_2, Fill(10, 1.U(1.W)), frac_rounded_post_0_f16_2(9, 0))
    )
  out_frac_post_0_f16_3 :=
    Mux(
      overflow_f16_3 & overflow_to_inf_f16_3,
      0.U(10.W),
      Mux(overflow_f16_3 & ~overflow_to_inf_f16_3, Fill(10, 1.U(1.W)), frac_rounded_post_0_f16_3(9, 0))
    )
  out_frac_post_0_f32_0 :=
    Mux(
      overflow_f64_0 & overflow_to_inf_f64_0,
      0.U(23.W),
      Mux(overflow_f64_0 & ~overflow_to_inf_f64_0, Fill(23, 1.U(1.W)), frac_rounded_post_0_f64_0(22, 0))
    )
  out_frac_post_0_f32_1 :=
    Mux(
      overflow_f32_1 & overflow_to_inf_f32_1,
      0.U(23.W),
      Mux(overflow_f32_1 & ~overflow_to_inf_f32_1, Fill(23, 1.U(1.W)), frac_rounded_post_0_f32_1(22, 0))
    )
  out_frac_post_0_f64_0 :=
    Mux(
      overflow_f64_0 & overflow_to_inf_f64_0,
      0.U(52.W),
      Mux(overflow_f64_0 & ~overflow_to_inf_f64_0, Fill(52, 1.U(1.W)), frac_rounded_post_0_f64_0(51, 0))
    )
  ...
  val fpdiv_res_post_0 = Cat(
    ...
    Mux(
      fp_format_q_is_fp16,
      res_post_0_f16_0(15, 0),
      Mux(fp_format_q_is_fp32, res_post_0_f32_0(15, 0), res_post_0_f64_0(15, 0))
    )
  )
  val out_exp_post_1_f16_0 =
    Mux(
      ...
      Mux(
        ...
        Fill(5, 1.U(1.W)),
        Mux(res_is_exact_zero_q(0), 0.U(5.W), Cat(0.U(4.W), carry_after_round_f64_0))
      ),
  ...
  val out_exp_post_1_f16_1 =
    Mux(
      ...
      Mux(
        ...
        Fill(5, 1.U(1.W)),
        Mux(res_is_exact_zero_q(1), 0.U(5.W), Cat(0.U(4.W), carry_after_round_f32_1))
      ),
  ...
  val out_exp_post_1_f16_2 =
    Mux(
      ...
      Mux(
        ...
        Fill(5, 1.U(1.W)),
        Mux(res_is_exact_zero_q(2), 0.U(5.W), Cat(0.U(4.W), carry_after_round_f16_2))
      ),
  ...
  val out_exp_post_1_f16_3 =
    Mux(
      ...
      Mux(
        ...
        Fill(5, 1.U(1.W)),
        Mux(res_is_exact_zero_q(3), 0.U(5.W), Cat(0.U(4.W), carry_after_round_f16_3))
      ),
  ...
  val out_exp_post_1_f32_0 =
    Mux(
      ...
      Mux(
        res_is_nan_q(0) | res_is_inf_q(0),
        Fill(8, 1.U(1.W)),
        Mux(res_is_exact_zero_q(0), 0.U(8.W), Cat(0.U(7.W), carry_after_round_f64_0))
      ),
  ...
  val out_exp_post_1_f32_1 =
    Mux(
      ...
      Mux(
        res_is_nan_q(1) | res_is_inf_q(1),
        Fill(8, 1.U(1.W)),
        Mux(res_is_exact_zero_q(1), 0.U(8.W), Cat(0.U(7.W), carry_after_round_f32_1))
      ),
  ...
  val out_exp_post_1_f64_0 =
    Mux(
      ...
      Mux(
        res_is_nan_q(0) | res_is_inf_q(0),
        Fill(11, 1.U(1.W)),
        Mux(res_is_exact_zero_q(0), 0.U(11.W), Cat(0.U(10.W), carry_after_round_f64_0))
      ),
  ...
  val out_frac_post_1_f16_0 = Mux(
    ...
    Mux(
      res_is_nan_q(0),
      Cat(1.U(1.W), 0.U(9.W)),
      Mux(res_is_inf_q(0) | res_is_exact_zero_q(0), 0.U(10.W), quo_rounded_f64_0(9, 0))
    ),
  ...
  val out_frac_post_1_f16_1 = Mux(
    ...
    Mux(
      res_is_nan_q(1),
      Cat(1.U(1.W), 0.U(9.W)),
      Mux(res_is_inf_q(1) | res_is_exact_zero_q(1), 0.U(10.W), quo_rounded_f32_1(9, 0))
    ),
  ...
  val out_frac_post_1_f16_2 = Mux(
    ...
    Mux(
      res_is_nan_q(2),
      Cat(1.U(1.W), 0.U(9.W)),
      Mux(res_is_inf_q(2) | res_is_exact_zero_q(2), 0.U(10.W), quo_rounded_f16_2(9, 0))
    ),
  ...
  val out_frac_post_1_f16_3 = Mux(
    ...
    Mux(
      res_is_nan_q(3),
      Cat(1.U(1.W), 0.U(9.W)),
      Mux(res_is_inf_q(3) | res_is_exact_zero_q(3), 0.U(10.W), quo_rounded_f16_3(9, 0))
    ),
  ...
  val out_frac_post_1_f32_0 = Mux(
    ...
    Mux(
      res_is_nan_q(0),
      Cat(1.U(1.W), 0.U(22.W)),
      Mux(res_is_inf_q(0) | res_is_exact_zero_q(0), 0.U(23.W), quo_rounded_f64_0(22, 0))
    ),
  ...
  val out_frac_post_1_f32_1 = Mux(
    ...
    Mux(
      res_is_nan_q(1),
      Cat(1.U(1.W), 0.U(22.W)),
      Mux(res_is_inf_q(1) | res_is_exact_zero_q(1), 0.U(23.W), quo_rounded_f32_1(22, 0))
    ),
  ...
  val out_frac_post_1_f64_0 = Mux(
    ...
    Mux(
      res_is_nan_q(0),
      Cat(1.U(1.W), 0.U(51.W)),
      Mux(res_is_inf_q(0) | res_is_exact_zero_q(0), 0.U(52.W), quo_rounded_f64_0(51, 0))
    ),
  ...
  val fpdiv_res_post_1 = Cat(
    ...
    Mux(
      fp_format_q_is_fp16,
      res_post_1_f16_0(15, 0),
      Mux(fp_format_q_is_fp32, res_post_1_f32_0(15, 0), res_post_1_f64_0(15, 0))
    )
  )
  ...
  val fflags_overflow = (fsm_q(FSM_POST_0_BIT) & overflow_f64_0) |
    (fsm_q(FSM_POST_1_BIT) & !res_is_denormal_f64_0 & overflow_f64_0 & !res_is_exact_zero_q(0) & !res_is_inf_q(
      0
    ) & !res_is_nan_q(0))
  ...
  val fflags_overflow_1 = (fsm_q(FSM_POST_0_BIT) & overflow_f32_1) |
    (fsm_q(FSM_POST_1_BIT) & !res_is_denormal_f32_1 & overflow_f32_1 & !res_is_exact_zero_q(1) & !res_is_inf_q(
      1
    ) & !res_is_nan_q(1))
  val fflags_overflow_2 = (fsm_q(FSM_POST_0_BIT) & overflow_f16_2) |
    (fsm_q(FSM_POST_1_BIT) & !res_is_denormal_f16_2 & overflow_f16_2 & !res_is_exact_zero_q(2) & !res_is_inf_q(
      2
    ) & !res_is_nan_q(2))
  val fflags_overflow_3 = (fsm_q(FSM_POST_0_BIT) & overflow_f16_3) |
    (fsm_q(FSM_POST_1_BIT) & !res_is_denormal_f16_3 & overflow_f16_3 & !res_is_exact_zero_q(3) & !res_is_inf_q(
      3
    ) & !res_is_nan_q(3))
  fflags_OF_vec := Mux1H(
    Seq(
  ...
  val fflags_scalar =
    Cat(fflags_invalid_operation, fflags_div_by_zero, fflags_overflow, fflags_underflow, fflags_inexact)
  val fflags_vec_1 =
    Cat(op_invalid_div_q(1), divided_by_zero_q(1), fflags_overflow_1, fflags_underflow_1, fflags_inexact_1)
  val fflags_vec_2 =
    Cat(op_invalid_div_q(2), divided_by_zero_q(2), fflags_overflow_2, fflags_underflow_2, fflags_inexact_2)
  val fflags_vec_3 =
    Cat(op_invalid_div_q(3), divided_by_zero_q(3), fflags_overflow_3, fflags_underflow_3, fflags_inexact_3)
  io.fflags_o := Cat(
...
private[vector] class fpdiv_r64_block_vector(
  val S1_SPECULATIVE_QDS: Int = 1,
  ...
  val U_CSA_0_in_a = Cat(
    io.f_r_s_i.head(60).tail(2),
    0.U(3.W),
    io.f_r_s_i.head(31).tail(2),
    0.U(3.W),
    io.f_r_s_i(35, 5).tail(2),
    0.U(3.W),
    io.f_r_s_i.head(18).tail(2),
    0.U(3.W),
    io.f_r_s_i(53, 36).tail(2),
    0.U(3.W),
    io.f_r_s_i(35, 18).tail(2),
    0.U(3.W),
    io.f_r_s_i(17, 0).tail(2),
    0.U(2.W)
  )
  val U_CSA_0_in_b = Cat(
    io.f_r_c_i.head(60).tail(2),
    0.U(3.W),
    io.f_r_c_i.head(31).tail(2),
    0.U(3.W),
    io.f_r_c_i(35, 5).tail(2),
    0.U(3.W),
    io.f_r_c_i.head(18).tail(2),
    0.U(3.W),
    io.f_r_c_i(53, 36).tail(2),
    0.U(3.W),
    io.f_r_c_i(35, 18).tail(2),
    0.U(3.W),
    io.f_r_c_i(17, 0).tail(2),
    0.U(2.W)
  )
  ...
  U_CSA_0_3.io.in_c := Cat(
    divisor_mul_pos_1_f64_0,
    0.U(1.W),
    divisor_mul_pos_1_f32_1,
    0.U(1.W),
    divisor_mul_pos_1_f32_0,
    0.U(1.W),
    divisor_mul_pos_1_f16_3,
    0.U(1.W),
    divisor_mul_pos_1_f16_2,
    0.U(1.W),
    divisor_mul_pos_1_f16_1,
    0.U(1.W),
    divisor_mul_pos_1_f16_0
  )
  ...
  nxt_f_r_s_spec_s0(4) := Mux1H(
    ...
    Seq(
      ...
      Cat(
        U_CSA_0_4.io.out_sum.tail(125).head(18),
        U_CSA_0_4.io.out_sum.tail(144).head(18),
        U_CSA_0_4.io.out_sum.tail(163).head(18),
        U_CSA_0_4.io.out_sum.tail(182).head(18)
      )
    )
  )
  nxt_f_r_s_spec_s0(3) := Mux1H(
    ...
    Seq(
      ...
      Cat(
        U_CSA_0_3.io.out_sum.tail(125).head(18),
        U_CSA_0_3.io.out_sum.tail(144).head(18),
        U_CSA_0_3.io.out_sum.tail(163).head(18),
        U_CSA_0_3.io.out_sum.tail(182).head(18)
      )
    )
  )
  nxt_f_r_s_spec_s0(2) := Mux1H(
    ...
    Seq(
      ...
      Cat(
        ...
        Cat(
          io.f_r_s_i.tail(2 * remainderWidthF16).head(remainderWidthF32)((remainderWidthF32 - 1) - 2, 0),
          0.U(2.W),
          0.U(5.W)
        )
      ),
  ...
  nxt_f_r_s_spec_s0(1) := Mux1H(
    ...
    Seq(
      ...
      Cat(
        U_CSA_0_1.io.out_sum.tail(125).head(18),
        U_CSA_0_1.io.out_sum.tail(144).head(18),
        U_CSA_0_1.io.out_sum.tail(163).head(18),
        U_CSA_0_1.io.out_sum.tail(182).head(18)
      )
    )
  )
  nxt_f_r_s_spec_s0(0) := Mux1H(
    ...
    Seq(
      ...
      Cat(
        U_CSA_0_0.io.out_sum.tail(125).head(18),
        U_CSA_0_0.io.out_sum.tail(144).head(18),
        U_CSA_0_0.io.out_sum.tail(163).head(18),
        U_CSA_0_0.io.out_sum.tail(182).head(18)
      )
    )
  )
  nxt_f_r_c_spec_s0(4) := Mux1H(
    ...
    Seq(
      ...
      Cat(
        U_CSA_0_4.io.out_car.tail(125).head(18),
        U_CSA_0_4.io.out_car.tail(144).head(18),
        U_CSA_0_4.io.out_car.tail(163).head(18),
        U_CSA_0_4.io.out_car.tail(182).head(18)
      )
    )
  )
  nxt_f_r_c_spec_s0(3) := Mux1H(
    ...
    Seq(
      ...
      Cat(
        U_CSA_0_3.io.out_car.tail(125).head(18),
        U_CSA_0_3.io.out_car.tail(144).head(18),
        U_CSA_0_3.io.out_car.tail(163).head(18),
        U_CSA_0_3.io.out_car.tail(182).head(18)
      )
    )
  )
  nxt_f_r_c_spec_s0(2) := Mux1H(
    ...
    Seq(
      ...
      Cat(
        ...
        Cat(
          io.f_r_c_i.tail(2 * remainderWidthF16).head(remainderWidthF32)((remainderWidthF32 - 1) - 2, 0),
          0.U(2.W),
          0.U(5.W)
        )
      ),
  ...
  nxt_f_r_c_spec_s0(1) := Mux1H(
    ...
    Seq(
      ...
      Cat(
        U_CSA_0_1.io.out_car.tail(125).head(18),
        U_CSA_0_1.io.out_car.tail(144).head(18),
        U_CSA_0_1.io.out_car.tail(163).head(18),
        U_CSA_0_1.io.out_car.tail(182).head(18)
      )
    )
  ) | mask_one
  nxt_f_r_c_spec_s0(0) := Mux1H(
    ...
    Seq(
      ...
      Cat(
        U_CSA_0_0.io.out_car.tail(125).head(18),
        U_CSA_0_0.io.out_car.tail(144).head(18),
        U_CSA_0_0.io.out_car.tail(163).head(18),
        U_CSA_0_0.io.out_car.tail(182).head(18)
      )
    )
  ) | mask_one
  ...
  val adder_7b_for_s2_qds_in_s0_spec_2_4 = nxt_f_r_s_spec_s0(4)
    .tail(remainderWidthF16)
    .tail(4)
    .head(7) + nxt_f_r_c_spec_s0(4).tail(remainderWidthF16).tail(4).head(7)
  val adder_7b_for_s2_qds_in_s0_spec_2_3 = nxt_f_r_s_spec_s0(3)
    .tail(remainderWidthF16)
    .tail(4)
    .head(7) + nxt_f_r_c_spec_s0(3).tail(remainderWidthF16).tail(4).head(7)
  val adder_7b_for_s2_qds_in_s0_spec_2_2 = nxt_f_r_s_spec_s0(2)
    .tail(remainderWidthF16)
    .tail(4)
    .head(7) + nxt_f_r_c_spec_s0(2).tail(remainderWidthF16).tail(4).head(7)
  val adder_7b_for_s2_qds_in_s0_spec_2_1 = nxt_f_r_s_spec_s0(1)
    .tail(remainderWidthF16)
    .tail(4)
    .head(7) + nxt_f_r_c_spec_s0(1).tail(remainderWidthF16).tail(4).head(7)
  val adder_7b_for_s2_qds_in_s0_spec_2_0 = nxt_f_r_s_spec_s0(0)
    .tail(remainderWidthF16)
    .tail(4)
    .head(7) + nxt_f_r_c_spec_s0(0).tail(remainderWidthF16).tail(4).head(7)
  val adder_7b_for_s2_qds_in_s0_spec_1_4 = nxt_f_r_s_spec_s0(4)
    .tail(2 * remainderWidthF16)
    .tail(4)
    .head(7) + nxt_f_r_c_spec_s0(4).tail(2 * remainderWidthF16).tail(4).head(7)
  val adder_7b_for_s2_qds_in_s0_spec_1_3 = nxt_f_r_s_spec_s0(3)
    .tail(2 * remainderWidthF16)
    .tail(4)
    .head(7) + nxt_f_r_c_spec_s0(3).tail(2 * remainderWidthF16).tail(4).head(7)
  val adder_7b_for_s2_qds_in_s0_spec_1_2 = nxt_f_r_s_spec_s0(2)
    .tail(2 * remainderWidthF16)
    .tail(4)
    .head(7) + nxt_f_r_c_spec_s0(2).tail(2 * remainderWidthF16).tail(4).head(7)
  val adder_7b_for_s2_qds_in_s0_spec_1_1 = nxt_f_r_s_spec_s0(1)
    .tail(2 * remainderWidthF16)
    .tail(4)
    .head(7) + nxt_f_r_c_spec_s0(1).tail(2 * remainderWidthF16).tail(4).head(7)
  val adder_7b_for_s2_qds_in_s0_spec_1_0 = nxt_f_r_s_spec_s0(0)
    .tail(2 * remainderWidthF16)
    .tail(4)
    .head(7) + nxt_f_r_c_spec_s0(0).tail(2 * remainderWidthF16).tail(4).head(7)
  val adder_7b_for_s2_qds_in_s0_spec_0_4 = nxt_f_r_s_spec_s0(4)
    .tail(3 * remainderWidthF16)
    .tail(4)
    .head(7) + nxt_f_r_c_spec_s0(4).tail(3 * remainderWidthF16).tail(4).head(7)
  val adder_7b_for_s2_qds_in_s0_spec_0_3 = nxt_f_r_s_spec_s0(3)
    .tail(3 * remainderWidthF16)
    .tail(4)
    .head(7) + nxt_f_r_c_spec_s0(3).tail(3 * remainderWidthF16).tail(4).head(7)
  val adder_7b_for_s2_qds_in_s0_spec_0_2 = nxt_f_r_s_spec_s0(2)
    .tail(3 * remainderWidthF16)
    .tail(4)
    .head(7) + nxt_f_r_c_spec_s0(2).tail(3 * remainderWidthF16).tail(4).head(7)
  val adder_7b_for_s2_qds_in_s0_spec_0_1 = nxt_f_r_s_spec_s0(1)
    .tail(3 * remainderWidthF16)
    .tail(4)
    .head(7) + nxt_f_r_c_spec_s0(1).tail(3 * remainderWidthF16).tail(4).head(7)
  val adder_7b_for_s2_qds_in_s0_spec_0_0 = nxt_f_r_s_spec_s0(0)
    .tail(3 * remainderWidthF16)
    .tail(4)
    .head(7) + nxt_f_r_c_spec_s0(0).tail(3 * remainderWidthF16).tail(4).head(7)

  val adder_7b_for_s2_qds_in_s0_spec_f64_0_4 =
    U_CSA_0_4.io.out_sum.tail(4).head(7) + U_CSA_0_4.io.out_car.tail(4).head(7)
  val adder_7b_for_s2_qds_in_s0_spec_f64_0_3 =
    U_CSA_0_3.io.out_sum.tail(4).head(7) + U_CSA_0_3.io.out_car.tail(4).head(7)
  val adder_7b_for_s2_qds_in_s0_spec_f64_0_2 =
    nxt_f_r_s_spec_s0(2).tail(4).head(7) + nxt_f_r_c_spec_s0(2).tail(4).head(7)
  val adder_7b_for_s2_qds_in_s0_spec_f64_0_1 =
    U_CSA_0_1.io.out_sum.tail(4).head(7) + U_CSA_0_1.io.out_car.tail(4).head(7)
  val adder_7b_for_s2_qds_in_s0_spec_f64_0_0 =
    U_CSA_0_0.io.out_sum.tail(4).head(7) + U_CSA_0_0.io.out_car.tail(4).head(7)
  val adder_7b_for_s2_qds_in_s0_spec_f32_0_4 =
    U_CSA_0_4.io.out_sum.tail(93).tail(4).head(7) + U_CSA_0_4.io.out_car.tail(93).tail(4).head(7)
  val adder_7b_for_s2_qds_in_s0_spec_f32_0_3 =
    U_CSA_0_3.io.out_sum.tail(93).tail(4).head(7) + U_CSA_0_3.io.out_car.tail(93).tail(4).head(7)
  val adder_7b_for_s2_qds_in_s0_spec_f32_0_2 = nxt_f_r_s_spec_s0(2)
    .tail(2 * remainderWidthF16)
    .tail(4)
    .head(7) + nxt_f_r_c_spec_s0(2).tail(2 * remainderWidthF16).tail(4).head(7)
  val adder_7b_for_s2_qds_in_s0_spec_f32_0_1 =
    U_CSA_0_1.io.out_sum.tail(93).tail(4).head(7) + U_CSA_0_1.io.out_car.tail(93).tail(4).head(7)
  val adder_7b_for_s2_qds_in_s0_spec_f32_0_0 =
    U_CSA_0_0.io.out_sum.tail(93).tail(4).head(7) + U_CSA_0_0.io.out_car.tail(93).tail(4).head(7)
  val adder_7b_for_s2_qds_in_s0_spec_f32_1_4 =
    U_CSA_0_4.io.out_sum.tail(61).tail(4).head(7) + U_CSA_0_4.io.out_car.tail(61).tail(4).head(7)
  val adder_7b_for_s2_qds_in_s0_spec_f32_1_3 =
    U_CSA_0_3.io.out_sum.tail(61).tail(4).head(7) + U_CSA_0_3.io.out_car.tail(61).tail(4).head(7)
  val adder_7b_for_s2_qds_in_s0_spec_f32_1_2 =
    nxt_f_r_s_spec_s0(2).tail(4).head(7) + nxt_f_r_c_spec_s0(2).tail(4).head(7)
  val adder_7b_for_s2_qds_in_s0_spec_f32_1_1 =
    U_CSA_0_1.io.out_sum.tail(61).tail(4).head(7) + U_CSA_0_1.io.out_car.tail(61).tail(4).head(7)
  val adder_7b_for_s2_qds_in_s0_spec_f32_1_0 =
    U_CSA_0_0.io.out_sum.tail(61).tail(4).head(7) + U_CSA_0_0.io.out_car.tail(61).tail(4).head(7)
  val adder_7b_for_s2_qds_in_s0_spec_f16_0_4 =
    U_CSA_0_4.io.out_sum.tail(182).tail(4).head(7) + U_CSA_0_4.io.out_car.tail(182).tail(4).head(7)
  val adder_7b_for_s2_qds_in_s0_spec_f16_0_3 =
    U_CSA_0_3.io.out_sum.tail(182).tail(4).head(7) + U_CSA_0_3.io.out_car.tail(182).tail(4).head(7)
  val adder_7b_for_s2_qds_in_s0_spec_f16_0_2 = nxt_f_r_s_spec_s0(2)
    .tail(3 * remainderWidthF16)
    .tail(4)
    .head(7) + nxt_f_r_c_spec_s0(2).tail(3 * remainderWidthF16).tail(4).head(7)
  val adder_7b_for_s2_qds_in_s0_spec_f16_0_1 =
    U_CSA_0_1.io.out_sum.tail(182).tail(4).head(7) + U_CSA_0_1.io.out_car.tail(182).tail(4).head(7)
  val adder_7b_for_s2_qds_in_s0_spec_f16_0_0 =
    U_CSA_0_0.io.out_sum.tail(182).tail(4).head(7) + U_CSA_0_0.io.out_car.tail(182).tail(4).head(7)
  val adder_7b_for_s2_qds_in_s0_spec_f16_1_4 =
    U_CSA_0_4.io.out_sum.tail(163).tail(4).head(7) + U_CSA_0_4.io.out_car.tail(163).tail(4).head(7)
  val adder_7b_for_s2_qds_in_s0_spec_f16_1_3 =
    U_CSA_0_3.io.out_sum.tail(163).tail(4).head(7) + U_CSA_0_3.io.out_car.tail(163).tail(4).head(7)
  val adder_7b_for_s2_qds_in_s0_spec_f16_1_2 = nxt_f_r_s_spec_s0(2)
    .tail(2 * remainderWidthF16)
    .tail(4)
    .head(7) + nxt_f_r_c_spec_s0(2).tail(2 * remainderWidthF16).tail(4).head(7)
  val adder_7b_for_s2_qds_in_s0_spec_f16_1_1 =
    U_CSA_0_1.io.out_sum.tail(163).tail(4).head(7) + U_CSA_0_1.io.out_car.tail(163).tail(4).head(7)
  val adder_7b_for_s2_qds_in_s0_spec_f16_1_0 =
    U_CSA_0_0.io.out_sum.tail(163).tail(4).head(7) + U_CSA_0_0.io.out_car.tail(163).tail(4).head(7)
  val adder_7b_for_s2_qds_in_s0_spec_f16_2_4 =
    U_CSA_0_4.io.out_sum.tail(144).tail(4).head(7) + U_CSA_0_4.io.out_car.tail(144).tail(4).head(7)
  val adder_7b_for_s2_qds_in_s0_spec_f16_2_3 =
    U_CSA_0_3.io.out_sum.tail(144).tail(4).head(7) + U_CSA_0_3.io.out_car.tail(144).tail(4).head(7)
  val adder_7b_for_s2_qds_in_s0_spec_f16_2_2 = nxt_f_r_s_spec_s0(2)
    .tail(remainderWidthF16)
    .tail(4)
    .head(7) + nxt_f_r_c_spec_s0(2).tail(remainderWidthF16).tail(4).head(7)
  val adder_7b_for_s2_qds_in_s0_spec_f16_2_1 =
    U_CSA_0_1.io.out_sum.tail(144).tail(4).head(7) + U_CSA_0_1.io.out_car.tail(144).tail(4).head(7)
  val adder_7b_for_s2_qds_in_s0_spec_f16_2_0 =
    U_CSA_0_0.io.out_sum.tail(144).tail(4).head(7) + U_CSA_0_0.io.out_car.tail(144).tail(4).head(7)
  val adder_7b_for_s2_qds_in_s0_spec_f16_3_4 =
    U_CSA_0_4.io.out_sum.tail(125).tail(4).head(7) + U_CSA_0_4.io.out_car.tail(125).tail(4).head(7)
  val adder_7b_for_s2_qds_in_s0_spec_f16_3_3 =
    U_CSA_0_3.io.out_sum.tail(125).tail(4).head(7) + U_CSA_0_3.io.out_car.tail(125).tail(4).head(7)
  val adder_7b_for_s2_qds_in_s0_spec_f16_3_2 =
    nxt_f_r_s_spec_s0(2).tail(4).head(7) + nxt_f_r_c_spec_s0(2).tail(4).head(7)
  val adder_7b_for_s2_qds_in_s0_spec_f16_3_1 =
    U_CSA_0_1.io.out_sum.tail(125).tail(4).head(7) + U_CSA_0_1.io.out_car.tail(125).tail(4).head(7)
  val adder_7b_for_s2_qds_in_s0_spec_f16_3_0 =
    U_CSA_0_0.io.out_sum.tail(125).tail(4).head(7) + U_CSA_0_0.io.out_car.tail(125).tail(4).head(7)
  ...
  val divisor_mul_pos_2_qds_1 =
    Mux(is_fp32 & io.is_vec, divisor_mul_pos_2_f32_1.tail(2).head(7), divisor_mul_pos_2_f16_1.tail(2).head(7))
  val divisor_mul_pos_1_qds_1 =
    Mux(is_fp32 & io.is_vec, divisor_mul_pos_1_f32_1.tail(2).head(7), divisor_mul_pos_1_f16_1.tail(2).head(7))
  val divisor_mul_neg_1_qds_1 =
    Mux(is_fp32 & io.is_vec, divisor_mul_neg_1_f32_1.tail(2).head(7), divisor_mul_neg_1_f16_1.tail(2).head(7))
  val divisor_mul_neg_2_qds_1 =
    Mux(is_fp32 & io.is_vec, divisor_mul_neg_2_f32_1.tail(2).head(7), divisor_mul_neg_2_f16_1.tail(2).head(7))
  ...
  adder_7b_for_nxt_cycle_s0_qds_spec_f64_0(
    4
  ) := adder_7b_nxt_f_r_s_f64_0 + adder_7b_nxt_f_r_c_f64_0 + adder_7b_divisor_mul_pos_2_f64_0
  adder_7b_for_nxt_cycle_s0_qds_spec_f64_0(
    3
  ) := adder_7b_nxt_f_r_s_f64_0 + adder_7b_nxt_f_r_c_f64_0 + adder_7b_divisor_mul_pos_1_f64_0
  adder_7b_for_nxt_cycle_s0_qds_spec_f64_0(2) := adder_7b_nxt_f_r_s_f64_0 + adder_7b_nxt_f_r_c_f64_0
  adder_7b_for_nxt_cycle_s0_qds_spec_f64_0(
    1
  ) := adder_7b_nxt_f_r_s_f64_0 + adder_7b_nxt_f_r_c_f64_0 + adder_7b_divisor_mul_neg_1_f64_0
  adder_7b_for_nxt_cycle_s0_qds_spec_f64_0(
    0
  ) := adder_7b_nxt_f_r_s_f64_0 + adder_7b_nxt_f_r_c_f64_0 + adder_7b_divisor_mul_neg_2_f64_0
  adder_8b_for_nxt_cycle_s1_qds_spec_f64_0(
    4
  ) := adder_8b_nxt_f_r_s_f64_0 + adder_8b_nxt_f_r_c_f64_0 + adder_8b_divisor_mul_pos_2_f64_0
  adder_8b_for_nxt_cycle_s1_qds_spec_f64_0(
    3
  ) := adder_8b_nxt_f_r_s_f64_0 + adder_8b_nxt_f_r_c_f64_0 + adder_8b_divisor_mul_pos_1_f64_0
  adder_8b_for_nxt_cycle_s1_qds_spec_f64_0(2) := adder_8b_nxt_f_r_s_f64_0 + adder_8b_nxt_f_r_c_f64_0
  adder_8b_for_nxt_cycle_s1_qds_spec_f64_0(
    1
  ) := adder_8b_nxt_f_r_s_f64_0 + adder_8b_nxt_f_r_c_f64_0 + adder_8b_divisor_mul_neg_1_f64_0
  adder_8b_for_nxt_cycle_s1_qds_spec_f64_0(
    0
  ) := adder_8b_nxt_f_r_s_f64_0 + adder_8b_nxt_f_r_c_f64_0 + adder_8b_divisor_mul_neg_2_f64_0

  val adder_7b_divisor_mul_pos_2_f32_1 =
    Mux(is_fp32 & is_vec, divisor_mul_pos_2_f32_1.tail(2).head(7), divisor_mul_pos_2_f16_1.tail(2).head(7))
  val adder_7b_divisor_mul_pos_1_f32_1 =
    Mux(is_fp32 & is_vec, divisor_mul_pos_1_f32_1.tail(2).head(7), divisor_mul_pos_1_f16_1.tail(2).head(7))
  val adder_7b_divisor_mul_neg_1_f32_1 =
    Mux(is_fp32 & is_vec, divisor_mul_neg_1_f32_1.tail(2).head(7), divisor_mul_neg_1_f16_1.tail(2).head(7))
  val adder_7b_divisor_mul_neg_2_f32_1 =
    Mux(is_fp32 & is_vec, divisor_mul_neg_2_f32_1.tail(2).head(7), divisor_mul_neg_2_f16_1.tail(2).head(7))
  val adder_8b_divisor_mul_pos_2_f32_1 =
    Mux(is_fp32 & is_vec, divisor_mul_pos_2_f32_1.tail(4).head(8), divisor_mul_pos_2_f16_1.tail(4).head(8))
  val adder_8b_divisor_mul_pos_1_f32_1 =
    Mux(is_fp32 & is_vec, divisor_mul_pos_1_f32_1.tail(4).head(8), divisor_mul_pos_1_f16_1.tail(4).head(8))
  val adder_8b_divisor_mul_neg_1_f32_1 =
    Mux(is_fp32 & is_vec, divisor_mul_neg_1_f32_1.tail(4).head(8), divisor_mul_neg_1_f16_1.tail(4).head(8))
  val adder_8b_divisor_mul_neg_2_f32_1 =
    Mux(is_fp32 & is_vec, divisor_mul_neg_2_f32_1.tail(4).head(8), divisor_mul_neg_2_f16_1.tail(4).head(8))
  val adder_7b_nxt_f_r_s_f32_1 =
    Mux(is_fp32 & is_vec, nxt_f_r_s_f32_1(1).tail(4).head(7), nxt_f_r_s_f16_1(1).tail(4).head(7))
  val adder_7b_nxt_f_r_c_f32_1 =
    Mux(is_fp32 & is_vec, nxt_f_r_c_f32_1(1).tail(4).head(7), nxt_f_r_c_f16_1(1).tail(4).head(7))
  val adder_8b_nxt_f_r_s_f32_1 =
    Mux(is_fp32 & is_vec, nxt_f_r_s_f32_1(1).tail(6).head(8), nxt_f_r_s_f16_1(1).tail(6).head(8))
  val adder_8b_nxt_f_r_c_f32_1 =
    Mux(is_fp32 & is_vec, nxt_f_r_c_f32_1(1).tail(6).head(8), nxt_f_r_c_f16_1(1).tail(6).head(8))
  adder_7b_for_nxt_cycle_s0_qds_spec_f32_1(
    4
  ) := adder_7b_nxt_f_r_s_f32_1 + adder_7b_nxt_f_r_c_f32_1 + adder_7b_divisor_mul_pos_2_f32_1
  adder_7b_for_nxt_cycle_s0_qds_spec_f32_1(
    3
  ) := adder_7b_nxt_f_r_s_f32_1 + adder_7b_nxt_f_r_c_f32_1 + adder_7b_divisor_mul_pos_1_f32_1
  adder_7b_for_nxt_cycle_s0_qds_spec_f32_1(2) := adder_7b_nxt_f_r_s_f32_1 + adder_7b_nxt_f_r_c_f32_1
  adder_7b_for_nxt_cycle_s0_qds_spec_f32_1(
    1
  ) := adder_7b_nxt_f_r_s_f32_1 + adder_7b_nxt_f_r_c_f32_1 + adder_7b_divisor_mul_neg_1_f32_1
  adder_7b_for_nxt_cycle_s0_qds_spec_f32_1(
    0
  ) := adder_7b_nxt_f_r_s_f32_1 + adder_7b_nxt_f_r_c_f32_1 + adder_7b_divisor_mul_neg_2_f32_1
  adder_8b_for_nxt_cycle_s1_qds_spec_f32_1(
    4
  ) := adder_8b_nxt_f_r_s_f32_1 + adder_8b_nxt_f_r_c_f32_1 + adder_8b_divisor_mul_pos_2_f32_1
  adder_8b_for_nxt_cycle_s1_qds_spec_f32_1(
    3
  ) := adder_8b_nxt_f_r_s_f32_1 + adder_8b_nxt_f_r_c_f32_1 + adder_8b_divisor_mul_pos_1_f32_1
  adder_8b_for_nxt_cycle_s1_qds_spec_f32_1(2) := adder_8b_nxt_f_r_s_f32_1 + adder_8b_nxt_f_r_c_f32_1
  adder_8b_for_nxt_cycle_s1_qds_spec_f32_1(
    1
  ) := adder_8b_nxt_f_r_s_f32_1 + adder_8b_nxt_f_r_c_f32_1 + adder_8b_divisor_mul_neg_1_f32_1
  adder_8b_for_nxt_cycle_s1_qds_spec_f32_1(
    0
  ) := adder_8b_nxt_f_r_s_f32_1 + adder_8b_nxt_f_r_c_f32_1 + adder_8b_divisor_mul_neg_2_f32_1

  adder_7b_for_nxt_cycle_s0_qds_spec_f16_2(4) := nxt_f_r_s_f16_2(1).tail(4).head(7) + nxt_f_r_c_f16_2(1)
    .tail(4)
    .head(7) + divisor_mul_pos_2_f16_2.tail(2).head(7)
  adder_7b_for_nxt_cycle_s0_qds_spec_f16_2(3) := nxt_f_r_s_f16_2(1).tail(4).head(7) + nxt_f_r_c_f16_2(1)
    .tail(4)
    .head(7) + divisor_mul_pos_1_f16_2.tail(2).head(7)
  adder_7b_for_nxt_cycle_s0_qds_spec_f16_2(2) := nxt_f_r_s_f16_2(1).tail(4).head(7) + nxt_f_r_c_f16_2(1).tail(4).head(7)
  adder_7b_for_nxt_cycle_s0_qds_spec_f16_2(1) := nxt_f_r_s_f16_2(1).tail(4).head(7) + nxt_f_r_c_f16_2(1)
    .tail(4)
    .head(7) + divisor_mul_neg_1_f16_2.tail(2).head(7)
  adder_7b_for_nxt_cycle_s0_qds_spec_f16_2(0) := nxt_f_r_s_f16_2(1).tail(4).head(7) + nxt_f_r_c_f16_2(1)
    .tail(4)
    .head(7) + divisor_mul_neg_2_f16_2.tail(2).head(7)
  adder_8b_for_nxt_cycle_s1_qds_spec_f16_2(4) := nxt_f_r_s_f16_2(1).tail(6).head(8) + nxt_f_r_c_f16_2(1)
    .tail(6)
    .head(8) + divisor_mul_pos_2_f16_2.tail(4).head(8)
  adder_8b_for_nxt_cycle_s1_qds_spec_f16_2(3) := nxt_f_r_s_f16_2(1).tail(6).head(8) + nxt_f_r_c_f16_2(1)
    .tail(6)
    .head(8) + divisor_mul_pos_1_f16_2.tail(4).head(8)
  adder_8b_for_nxt_cycle_s1_qds_spec_f16_2(2) := nxt_f_r_s_f16_2(1).tail(6).head(8) + nxt_f_r_c_f16_2(1).tail(6).head(8)
  adder_8b_for_nxt_cycle_s1_qds_spec_f16_2(1) := nxt_f_r_s_f16_2(1).tail(6).head(8) + nxt_f_r_c_f16_2(1)
    .tail(6)
    .head(8) + divisor_mul_neg_1_f16_2.tail(4).head(8)
  adder_8b_for_nxt_cycle_s1_qds_spec_f16_2(0) := nxt_f_r_s_f16_2(1).tail(6).head(8) + nxt_f_r_c_f16_2(1)
    .tail(6)
    .head(8) + divisor_mul_neg_2_f16_2.tail(4).head(8)

  adder_7b_for_nxt_cycle_s0_qds_spec_f16_3(4) := nxt_f_r_s_f16_3(1).tail(4).head(7) + nxt_f_r_c_f16_3(1)
    .tail(4)
    .head(7) + divisor_mul_pos_2_f16_3.tail(2).head(7)
  adder_7b_for_nxt_cycle_s0_qds_spec_f16_3(3) := nxt_f_r_s_f16_3(1).tail(4).head(7) + nxt_f_r_c_f16_3(1)
    .tail(4)
    .head(7) + divisor_mul_pos_1_f16_3.tail(2).head(7)
  adder_7b_for_nxt_cycle_s0_qds_spec_f16_3(2) := nxt_f_r_s_f16_3(1).tail(4).head(7) + nxt_f_r_c_f16_3(1).tail(4).head(7)
  adder_7b_for_nxt_cycle_s0_qds_spec_f16_3(1) := nxt_f_r_s_f16_3(1).tail(4).head(7) + nxt_f_r_c_f16_3(1)
    .tail(4)
    .head(7) + divisor_mul_neg_1_f16_3.tail(2).head(7)
  adder_7b_for_nxt_cycle_s0_qds_spec_f16_3(0) := nxt_f_r_s_f16_3(1).tail(4).head(7) + nxt_f_r_c_f16_3(1)
    .tail(4)
    .head(7) + divisor_mul_neg_2_f16_3.tail(2).head(7)
  adder_8b_for_nxt_cycle_s1_qds_spec_f16_3(4) := nxt_f_r_s_f16_3(1).tail(6).head(8) + nxt_f_r_c_f16_3(1)
    .tail(6)
    .head(8) + divisor_mul_pos_2_f16_3.tail(4).head(8)
  adder_8b_for_nxt_cycle_s1_qds_spec_f16_3(3) := nxt_f_r_s_f16_3(1).tail(6).head(8) + nxt_f_r_c_f16_3(1)
    .tail(6)
    .head(8) + divisor_mul_pos_1_f16_3.tail(4).head(8)
  adder_8b_for_nxt_cycle_s1_qds_spec_f16_3(2) := nxt_f_r_s_f16_3(1).tail(6).head(8) + nxt_f_r_c_f16_3(1).tail(6).head(8)
  adder_8b_for_nxt_cycle_s1_qds_spec_f16_3(1) := nxt_f_r_s_f16_3(1).tail(6).head(8) + nxt_f_r_c_f16_3(1)
    .tail(6)
    .head(8) + divisor_mul_neg_1_f16_3.tail(4).head(8)
  adder_8b_for_nxt_cycle_s1_qds_spec_f16_3(0) := nxt_f_r_s_f16_3(1).tail(6).head(8) + nxt_f_r_c_f16_3(1)
    .tail(6)
    .head(8) + divisor_mul_neg_2_f16_3.tail(4).head(8)
