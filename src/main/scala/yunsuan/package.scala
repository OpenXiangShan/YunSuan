...
package object yunsuan {
  ...
  object VfmaType{
    ...
    def vfwmaccbf16 = LiteralCat(1.U(3.W), 1.U(1.W), VfmaOpCode.vfmacc )
  ...
  object VfcvtType {
    ...
    def vfncvtbf16_sat_ffw= "b11_011111".U(8.W)
    def vfncvt_ffq        = "b11_011001".U(8.W)
    def vfncvt_sat_ffq    = "b11_011011".U(8.W)
    def vfext_vf2         = "b11_110110".U(8.W)
