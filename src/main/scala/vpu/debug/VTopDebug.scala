...
class VTopDebug extends Module {
  ...
  val dpicLoadL2 = Module(new DpicLoadL2)
  vTop.io.l2.loadReq.ready := true.B
  dpicLoadL2.io.enable := vTop.io.l2.loadReq.valid
  dpicLoadL2.io.paddr := vTop.io.l2.loadReq.bits.addr(0)
  vTop.io.l2.loadRsp.valid := dpicLoadL2.io.load_data.valid
  vTop.io.l2.loadRsp.bits.data := dpicLoadL2.io.load_data.bits.data
